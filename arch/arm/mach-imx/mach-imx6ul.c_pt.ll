; ModuleID = '/llk/IR/arch/arm/mach-imx/mach-imx6ul.c_pt.bc'
...
@.str = private unnamed_addr constant [40 x i8] c"Freescale i.MX6 Ultralite (Device Tree)\00", align 1
...
@.str.1 = private unnamed_addr constant [11 x i8] c"fsl,imx6ul\00", align 1
@.str.2 = private unnamed_addr constant [12 x i8] c"fsl,imx6ull\00", align 1
@.str.3 = private unnamed_addr constant [15 x i8] c"fsl,imx6ul-ccm\00", align 1
@.str.4 = private unnamed_addr constant [9 x i8] c"i.MX6ULL\00", align 1
@.str.5 = private unnamed_addr constant [8 x i8] c"i.MX6UL\00", align 1
@__mxc_cpu_type = external dso_local local_unnamed_addr global i32, align 4
@.str.6 = private unnamed_addr constant [22 x i8] c"fsl,imx6ul-iomuxc-gpr\00", align 1
@.str.7 = private unnamed_addr constant [46 x i8] c"\013failed to find fsl,imx6ul-iomux-gpr regmap\0A\00", align 1
@.str.8 = private unnamed_addr constant [14 x i8] c"imx6q-cpufreq\00", align 1
@llvm.compiler.used = appending global [1 x ptr] [ptr @__mach_desc_IMX6UL], section "llvm.metadata"

; Function Attrs: cold nounwind null_pointer_is_valid optsize sspstrong uwtable(sync)
define internal void @imx6ul_init_irq() #0 section ".init.text" {
  tail call void @imx_init_revision_from_anatop() #5
  tail call void @imx_src_init() #5
  tail call void @irqchip_init() #5
  tail call void @imx6_pm_ccm_init(ptr noundef nonnull @.str.3) #5
  ret void
}

; Function Attrs: cold nounwind null_pointer_is_valid optsize sspstrong uwtable(sync)
define internal void @imx6ul_init_machine() #0 section ".init.text" {
  %1 = load i32, ptr @__mxc_cpu_type, align 4
  %2 = icmp eq i32 %1, 101
  %3 = select i1 %2, ptr @.str.4, ptr @.str.5
  %4 = tail call i32 @imx_get_soc_revision() #5
  tail call void @imx_print_silicon_rev(ptr noundef nonnull %3, i32 noundef %4) #5
  %5 = tail call i32 @of_platform_default_populate(ptr noundef null, ptr noundef null, ptr noundef null) #5
  tail call fastcc void @imx6ul_enet_clk_init() #6
  tail call void @imx_anatop_init() #5
  tail call void @imx6ul_pm_init() #5
  ret void
}

; Function Attrs: cold nounwind null_pointer_is_valid optsize sspstrong uwtable(sync)
define internal void @imx6ul_init_late() #0 section ".init.text" {
...
; Function Attrs: cold nounwind null_pointer_is_valid optsize sspstrong uwtable(sync)
define internal fastcc void @imx6ul_enet_clk_init() unnamed_addr #0 section ".init.text" {
  %1 = tail call ptr @syscon_regmap_lookup_by_compatible(ptr noundef nonnull @.str.6) #5
  %2 = icmp ugt ptr %1, inttoptr (i32 -4096 to ptr)
  br i1 %2, label %5, label %3

3:                                                ; preds = %0
  %4 = tail call i32 @regmap_update_bits_base(ptr noundef %1, i32 noundef 4, i32 noundef 393216, i32 noundef 393216, ptr noundef null, i1 noundef zeroext false, i1 noundef zeroext false) #5
  br label %7

5:                                                ; preds = %0
  %6 = tail call i32 (ptr, ...) @_printk(ptr noundef nonnull @.str.7) #6
  br label %7
