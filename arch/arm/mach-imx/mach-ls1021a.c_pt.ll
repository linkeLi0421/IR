; ModuleID = '/llk/IR/arch/arm/mach-imx/mach-ls1021a.c_pt.bc'
...
@.str = private unnamed_addr constant [18 x i8] c"Freescale LS1021A\00", align 1
...
@.str.1 = private unnamed_addr constant [12 x i8] c"fsl,ls1021a\00", align 1
@llvm.compiler.used = appending global [1 x ptr] [ptr @__mach_desc_LS1021A], section "llvm.metadata"
