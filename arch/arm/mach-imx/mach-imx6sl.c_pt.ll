; ModuleID = '/llk/IR/arch/arm/mach-imx/mach-imx6sl.c_pt.bc'
...
@.str = private unnamed_addr constant [39 x i8] c"Freescale i.MX6 SoloLite (Device Tree)\00", align 1
...
@.str.1 = private unnamed_addr constant [11 x i8] c"fsl,imx6sl\00", align 1
@.str.2 = private unnamed_addr constant [12 x i8] c"fsl,imx6sll\00", align 1
@.str.3 = private unnamed_addr constant [15 x i8] c"fsl,imx6sl-ccm\00", align 1
@.str.4 = private unnamed_addr constant [16 x i8] c"fsl,imx6sll-ccm\00", align 1
@__mxc_cpu_type = external dso_local local_unnamed_addr global i32, align 4
@.str.5 = private unnamed_addr constant [22 x i8] c"fsl,imx6sl-iomuxc-gpr\00", align 1
@.str.6 = private unnamed_addr constant [46 x i8] c"\013failed to find fsl,imx6sl-iomux-gpr regmap\0A\00", align 1
@.str.7 = private unnamed_addr constant [14 x i8] c"imx6q-cpufreq\00", align 1
@llvm.compiler.used = appending global [1 x ptr] [ptr @__mach_desc_IMX6SL], section "llvm.metadata"

; Function Attrs: cold nounwind null_pointer_is_valid optsize sspstrong uwtable(sync)
define internal void @imx6sl_init_irq() #0 section ".init.text" {
  ...
  %2 = icmp eq i32 %1, 96
  %3 = select i1 %2, ptr @.str.3, ptr @.str.4
  tail call void @imx6_pm_ccm_init(ptr noundef nonnull %3) #5
  ret void
}

; Function Attrs: cold nounwind null_pointer_is_valid optsize sspstrong uwtable(sync)
define internal void @imx6sl_init_machine() #0 section ".init.text" {
...
4:                                                ; preds = %0
  tail call fastcc void @imx6sl_fec_init() #6
  br label %5

5:                                                ; preds = %4, %0
  tail call void @imx_anatop_init() #5
  tail call void @imx6sl_pm_init() #5
  ret void
}

; Function Attrs: cold nounwind null_pointer_is_valid optsize sspstrong uwtable(sync)
define internal void @imx6sl_init_late() #0 section ".init.text" {
...
8:                                                ; preds = %0
  %9 = call i32 @imx6sl_cpuidle_init() #5
  br label %12

10:                                               ; preds = %0
  %11 = call i32 @imx6sx_cpuidle_init() #5
  br label %12
...
; Function Attrs: cold nounwind null_pointer_is_valid optsize sspstrong uwtable(sync)
define internal fastcc void @imx6sl_fec_init() unnamed_addr #0 section ".init.text" {
  %1 = tail call ptr @syscon_regmap_lookup_by_compatible(ptr noundef nonnull @.str.5) #5
  %2 = icmp ugt ptr %1, inttoptr (i32 -4096 to ptr)
  br i1 %2, label %6, label %3

3:                                                ; preds = %0
  %4 = tail call i32 @regmap_update_bits_base(ptr noundef %1, i32 noundef 4, i32 noundef 16384, i32 noundef 0, ptr noundef null, i1 noundef zeroext false, i1 noundef zeroext false) #5
...
6:                                                ; preds = %0
  %7 = tail call i32 (ptr, ...) @_printk(ptr noundef nonnull @.str.6) #7
  br label %8
