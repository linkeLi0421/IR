; ModuleID = '/llk/IR/arch/arm/mach-hisi/hisilicon.c_pt.bc'
...
@.str = private unnamed_addr constant [41 x i8] c"Hisilicon Hi3620 (Flattened Device Tree)\00", align 1
...
@.str.1 = private unnamed_addr constant [24 x i8] c"hisilicon,hi3620-hi4511\00", align 1
...
@llvm.compiler.used = appending global [1 x ptr] [ptr @__mach_desc_HI3620], section "llvm.metadata"

; Function Attrs: cold nounwind null_pointer_is_valid optsize sspstrong uwtable(sync)
define internal void @hi3620_map_io() #0 section ".init.text" {
