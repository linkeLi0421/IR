; ModuleID = '/llk/IR/arch/arm/mach-spear/spear1310.c_pt.bc'
...
@.str = private unnamed_addr constant [44 x i8] c"ST SPEAr1310 SoC with Flattened Device Tree\00", align 1
@spear1310_dt_board_compat = internal constant [3 x ptr] [ptr @.str.1, ptr @.str.2, ptr null], align 4
...
@.str.1 = private unnamed_addr constant [13 x i8] c"st,spear1310\00", align 1
@.str.2 = private unnamed_addr constant [17 x i8] c"st,spear1310-evb\00", align 1
...
@llvm.compiler.used = appending global [1 x ptr] [ptr @__mach_desc_SPEAR1310_DT], section "llvm.metadata"

; Function Attrs: cold nounwind null_pointer_is_valid optsize sspstrong uwtable(sync)
define internal void @spear1310_map_io() #0 section ".init.text" {
  tail call void @iotable_init(ptr noundef nonnull @spear1310_io_desc, i32 noundef 1) #5
  tail call void @spear13xx_map_io() #6
  ret void
}
...
; Function Attrs: cold nounwind null_pointer_is_valid optsize sspstrong uwtable(sync)
define internal void @spear1310_dt_init() #0 section ".init.text" {
