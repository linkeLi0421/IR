; ModuleID = '/llk/IR/arch/arm/crypto/sha1_neon_glue.c_pt.bc'
...
@__UNIQUE_ID_description221 = internal constant [57 x i8] c"description=SHA1 Secure Hash Algorithm, NEON accelerated\00", section ".modinfo", align 1
...
define internal i32 @sha1_neon_update(ptr noundef %0, ptr noundef %1, i32 noundef %2) #3 {
...
34:                                               ; preds = %32
  ...
  %39 = sub i32 %2, %35
  tail call void @sha1_transform_neon(ptr noundef %4, ptr noundef %36, i32 noundef 1) #8
  br label %40
...
45:                                               ; preds = %40
  %46 = lshr i32 %41, 6
  tail call void @sha1_transform_neon(ptr noundef %4, ptr noundef %42, i32 noundef %46) #8
  %47 = and i32 %41, -64
...
; Function Attrs: nounwind null_pointer_is_valid sspstrong uwtable(sync)
define internal i32 @sha1_neon_final(ptr noundef %0, ptr noundef %1) #3 {
  %3 = tail call i32 @sha1_neon_finup(ptr noundef %0, ptr noundef null, i32 noundef 0, ptr noundef %1)
  ret i32 %3
}

; Function Attrs: nounwind null_pointer_is_valid sspstrong uwtable(sync)
define internal i32 @sha1_neon_finup(ptr noundef %0, ptr noundef %1, i32 noundef %2, ptr noundef %3) #3 {
  %5 = tail call ptr @llvm.thread.pointer() #8
  %6 = getelementptr inbounds %struct.thread_info, ptr %5, i32 0, i32 1
  %7 = load volatile i32, ptr %6, align 4
  %8 = and i32 %7, 15728640
...
32:                                               ; preds = %30
  ...
  %37 = sub i32 %2, %33
  tail call void @sha1_transform_neon(ptr noundef %21, ptr noundef %34, i32 noundef 1) #8
  br label %38
...
43:                                               ; preds = %38
  %44 = lshr i32 %39, 6
  tail call void @sha1_transform_neon(ptr noundef %21, ptr noundef %40, i32 noundef %44) #8
  %45 = and i32 %39, -64
...
66:                                               ; preds = %56
  ...
  tail call void @sha1_transform_neon(ptr noundef %57, ptr noundef %58, i32 noundef 1) #8
  br label %69
