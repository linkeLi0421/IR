; ModuleID = '/llk/IR/arch/arm/mach-omap2/devices.c_pt.bc'
source_filename = "../arch/arm/mach-omap2/devices.c"
...
define dso_local i32 @omap_init_vout() local_unnamed_addr #0 section ".init.text" {
  ret i32 0
}
