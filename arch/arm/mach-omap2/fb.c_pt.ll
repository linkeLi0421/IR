; ModuleID = '/llk/IR/arch/arm/mach-omap2/fb.c_pt.bc'
...
define dso_local i32 @omap_init_vrfb() local_unnamed_addr #0 section ".init.text" {
  ret i32 0
}

; Function Attrs: cold mustprogress nofree norecurse nosync nounwind null_pointer_is_valid optsize readnone sspstrong willreturn uwtable(sync)
define dso_local i32 @omap_init_fb() local_unnamed_addr #0 section ".init.text" {
  ret i32 0
}
