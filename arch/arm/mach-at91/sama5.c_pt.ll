; ModuleID = '/llk/IR/arch/arm/mach-at91/sama5.c_pt.bc'
...
@.str = private unnamed_addr constant [12 x i8] c"Atmel SAMA5\00", align 1
...
@.str.1 = private unnamed_addr constant [12 x i8] c"atmel,sama5\00", align 1
@.str.2 = private unnamed_addr constant [14 x i8] c"atmel,sama5d4\00", align 1
@.str.3 = private unnamed_addr constant [14 x i8] c"atmel,sama5d2\00", align 1
@llvm.compiler.used = appending global [3 x ptr] [ptr @__mach_desc_sama5_alt_dt, ptr @__mach_desc_sama5_dt, ptr @__mach_desc_sama5d2], section "llvm.metadata"

; Function Attrs: cold nounwind null_pointer_is_valid optsize sspstrong uwtable(sync)
define internal void @sama5_dt_device_init() #0 section ".init.text" {
  %1 = tail call i32 @of_platform_default_populate(ptr noundef null, ptr noundef null, ptr noundef null) #3
  tail call void @sama5_pm_init() #4
  ret void
}

; Function Attrs: cold nounwind null_pointer_is_valid optsize sspstrong uwtable(sync)
define internal void @sama5d2_init() #0 section ".init.text" {
  %1 = tail call i32 @of_platform_default_populate(ptr noundef null, ptr noundef null, ptr noundef null) #3
  tail call void @sama5d2_pm_init() #4
  ret void
}
