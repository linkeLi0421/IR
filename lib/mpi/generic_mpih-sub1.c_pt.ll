; ModuleID = '/llk/IR/lib/mpi/generic_mpih-sub1.c_pt.bc'
...
define dso_local i32 @mpihelp_sub_n(ptr nocapture noundef writeonly %0, ptr nocapture noundef readonly %1, ptr nocapture noundef readonly %2, i32 noundef %3) local_unnamed_addr #0 {
  %5 = sub i32 0, %3
