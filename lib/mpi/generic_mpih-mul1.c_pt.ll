; ModuleID = '/llk/IR/lib/mpi/generic_mpih-mul1.c_pt.bc'
source_filename = "../lib/mpi/generic_mpih-mul1.c"
...
define dso_local i32 @mpihelp_mul_1(ptr nocapture noundef writeonly %0, ptr nocapture noundef readonly %1, i32 noundef %2, i32 noundef %3) local_unnamed_addr #0 {
  %5 = sub i32 0, %2
...
8:                                                ; preds = %8, %4
  ...
  %19 = add i32 %14, %18
  %20 = getelementptr i32, ptr %7, i32 %10
...
!8 = !{i64 2152392440, i64 2152392469}
