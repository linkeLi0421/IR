; ModuleID = '/llk/IR/net/unix/sysctl_net_unix.c_pt.bc'
...
@unix_table = internal global [2 x %struct.ctl_table] [%struct.ctl_table { ptr @.str.1, ptr getelementptr (i8, ptr @init_net, i64 292), i32 4, i16 420, ptr null, ptr @proc_dointvec, ptr null, ptr null, ptr null }, %struct.ctl_table zeroinitializer], align 4
...
define dso_local i32 @unix_sysctl_register(ptr noundef %0) local_unnamed_addr #0 section ".init.text" {
  %2 = tail call ptr @kmemdup(ptr noundef nonnull @unix_table, i32 noundef 72, i32 noundef 3264) #3
  %3 = icmp eq ptr %2, null
  br i1 %3, label %11, label %4

4:                                                ; preds = %1
  %5 = getelementptr inbounds %struct.net, ptr %0, i32 0, i32 32
  %6 = getelementptr inbounds %struct.ctl_table, ptr %2, i32 0, i32 1
  store ptr %5, ptr %6, align 4
  %7 = tail call ptr @register_net_sysctl(ptr noundef %0, ptr noundef nonnull @.str, ptr noundef nonnull %2) #3
  %8 = getelementptr inbounds %struct.net, ptr %0, i32 0, i32 32, i32 1
...
define dso_local void @unix_sysctl_unregister(ptr nocapture noundef readonly %0) local_unnamed_addr #2 {
  %2 = getelementptr inbounds %struct.net, ptr %0, i32 0, i32 32, i32 1
  %3 = load ptr, ptr %2, align 4
  %4 = getelementptr inbounds %struct.ctl_table_header, ptr %3, i32 0, i32 2
  %5 = load ptr, ptr %4, align 4
  tail call void @unregister_net_sysctl_table(ptr noundef %3) #3
