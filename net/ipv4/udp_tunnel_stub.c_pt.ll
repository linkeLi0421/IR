; ModuleID = '/llk/IR/net/ipv4/udp_tunnel_stub.c_pt.bc'
...
@udp_tunnel_nic_ops = dso_local global ptr null, align 4
...
@llvm.compiler.used = appending global [1 x ptr] [ptr @__ksymtab_udp_tunnel_nic_ops], section "llvm.metadata"
