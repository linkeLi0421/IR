; ModuleID = '/llk/IR/net/xfrm/xfrm_device.c_pt.bc'
...
@xfrm_dev_notifier = internal global %struct.notifier_block { ptr @xfrm_dev_event, ptr null, i32 0 }, align 4
@init_net = external dso_local global %struct.net, align 64

; Function Attrs: cold nounwind null_pointer_is_valid optsize sspstrong uwtable(sync)
define dso_local void @xfrm_dev_init() local_unnamed_addr #0 section ".init.text" {
  %1 = tail call i32 @register_netdevice_notifier(ptr noundef nonnull @xfrm_dev_notifier) #3
  ret void
}
...
define internal i32 @xfrm_dev_event(ptr nocapture noundef readnone %0, i32 noundef %1, ptr nocapture noundef readonly %2) #2 {
...
5:                                                ; preds = %3
  %6 = getelementptr inbounds %struct.net_device, ptr %4, i32 0, i32 23
  %7 = load i64, ptr %6, align 16
  %8 = and i64 %7, 3377699720527872
  %9 = icmp eq i64 %8, 0
  %10 = select i1 %9, i32 0, i32 32770
  br label %24

11:                                               ; preds = %3
  %12 = getelementptr inbounds %struct.net_device, ptr %4, i32 0, i32 23
  %13 = load i64, ptr %12, align 16
  %14 = and i64 %13, 3377699720527872
  %15 = icmp eq i64 %14, 0
  %16 = select i1 %15, i32 0, i32 32770
  br label %24

17:                                               ; preds = %3, %3
  %18 = getelementptr inbounds %struct.net_device, ptr %4, i32 0, i32 23
...
22:                                               ; preds = %17
  %23 = tail call i32 @xfrm_dev_state_flush(ptr noundef nonnull @init_net, ptr noundef %4, i1 noundef zeroext true) #3
  br label %24

24:                                               ; preds = %22, %17, %11, %5, %3
  %25 = phi i32 [ %16, %11 ], [ %10, %5 ], [ 0, %3 ], [ 0, %17 ], [ 0, %22 ]
  ret i32 %25
}

; Function Attrs: null_pointer_is_valid
declare dso_local i32 @xfrm_dev_state_flush(ptr noundef, ptr noundef, i1 noundef zeroext) local_unnamed_addr #1
