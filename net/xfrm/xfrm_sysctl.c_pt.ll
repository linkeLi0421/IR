; ModuleID = '/llk/IR/net/xfrm/xfrm_sysctl.c_pt.bc'
source_filename = "../net/xfrm/xfrm_sysctl.c"
...
@xfrm_table = internal global [5 x %struct.ctl_table] [%struct.ctl_table { ptr @.str.1, ptr null, i32 4, i16 420, ptr null, ptr @proc_douintvec, ptr null, ptr null, ptr null }, %struct.ctl_table { ptr @.str.2, ptr null, i32 4, i16 420, ptr null, ptr @proc_douintvec, ptr null, ptr null, ptr null }, %struct.ctl_table { ptr @.str.3, ptr null, i32 4, i16 420, ptr null, ptr @proc_dointvec, ptr null, ptr null, ptr null }, %struct.ctl_table { ptr @.str.4, ptr null, i32 4, i16 420, ptr null, ptr @proc_dointvec, ptr null, ptr null, ptr null }, %struct.ctl_table zeroinitializer], align 4
...
define dso_local i32 @xfrm_sysctl_init(ptr noundef %0) local_unnamed_addr #0 section ".init.text" {
  %2 = getelementptr inbounds %struct.net, ptr %0, i32 0, i32 40, i32 19
  store i32 10, ptr %2, align 4
  %3 = getelementptr inbounds %struct.net, ptr %0, i32 0, i32 40, i32 20
  store i32 2, ptr %3, align 8
  %4 = getelementptr inbounds %struct.net, ptr %0, i32 0, i32 40, i32 21
  store i32 1, ptr %4, align 4
  %5 = getelementptr inbounds %struct.net, ptr %0, i32 0, i32 40, i32 22
  store i32 30, ptr %5, align 16
  %6 = tail call ptr @kmemdup(ptr noundef nonnull @xfrm_table, i32 noundef 180, i32 noundef 3264) #3
...
8:                                                ; preds = %1
  ...
  %10 = getelementptr %struct.ctl_table, ptr %6, i32 1, i32 1
  store ptr %3, ptr %10, align 4
  %11 = getelementptr %struct.ctl_table, ptr %6, i32 2, i32 1
  store ptr %4, ptr %11, align 4
  %12 = getelementptr %struct.ctl_table, ptr %6, i32 3, i32 1
  store ptr %5, ptr %12, align 4
  %13 = getelementptr inbounds %struct.net, ptr %0, i32 0, i32 11
...
17:                                               ; preds = %16, %8
  %18 = tail call ptr @register_net_sysctl(ptr noundef %0, ptr noundef nonnull @.str, ptr noundef nonnull %6) #3
  %19 = getelementptr inbounds %struct.net, ptr %0, i32 0, i32 40, i32 24
...
define dso_local void @xfrm_sysctl_fini(ptr nocapture noundef readonly %0) local_unnamed_addr #2 section ".ref.text" {
  %2 = getelementptr inbounds %struct.net, ptr %0, i32 0, i32 40, i32 24
