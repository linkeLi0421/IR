; ModuleID = '/llk/IR/fs/autofs/symlink.c_pt.bc'
source_filename = "../fs/autofs/symlink.c"
...
@autofs_symlink_inode_operations = dso_local local_unnamed_addr constant %struct.inode_operations { ptr null, ptr @autofs_get_link, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, [36 x i8] undef }, align 64
@jiffies = external dso_local global i32, section ".data..cacheline_aligned", align 64

; Function Attrs: mustprogress nofree nounwind null_pointer_is_valid sspstrong willreturn uwtable(sync)
define internal ptr @autofs_get_link(ptr noundef readonly %0, ptr nocapture noundef readnone %1, ptr nocapture noundef readnone %2) #0 {
...
5:                                                ; preds = %3
  ...
  %10 = getelementptr inbounds %struct.dentry, ptr %0, i32 0, i32 11
...
18:                                               ; preds = %13
  %19 = tail call ptr @llvm.thread.pointer() #2
...
27:                                               ; preds = %18
  ...
  %29 = getelementptr inbounds %struct.autofs_info, ptr %11, i32 0, i32 7
  store i32 %28, ptr %29, align 4
  br label %30

30:                                               ; preds = %27, %18, %13, %5
  %31 = getelementptr inbounds %struct.dentry, ptr %0, i32 0, i32 5
  %32 = load ptr, ptr %31, align 8
  %33 = getelementptr inbounds %struct.inode, ptr %32, i32 0, i32 47
  %34 = load ptr, ptr %33, align 4
  br label %35

35:                                               ; preds = %30, %3
  %36 = phi ptr [ %34, %30 ], [ inttoptr (i32 -10 to ptr), %3 ]
  ret ptr %36
}
