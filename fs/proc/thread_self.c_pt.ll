; ModuleID = '/llk/IR/fs/proc/thread_self.c_pt.bc'
...
@proc_thread_self_inode_operations = internal constant %struct.inode_operations { ptr null, ptr @proc_thread_self_get_link, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, [36 x i8] undef }, align 64
...
define dso_local i32 @proc_setup_thread_self(ptr noundef %0) local_unnamed_addr #0 {
...
19:                                               ; preds = %13
  %20 = load i32, ptr @thread_self_inum, align 4
  ...
  store ptr @proc_thread_self_inode_operations, ptr %27, align 8
  call void @d_add(ptr noundef nonnull %11, ptr noundef nonnull %14) #9
  call void @up_write(ptr noundef %9) #9
  %28 = getelementptr inbounds %struct.proc_fs_info, ptr %8, i32 0, i32 2
...
define dso_local void @proc_thread_self_init() local_unnamed_addr #5 section ".init.text" {
  %1 = tail call i32 @proc_alloc_inum(ptr noundef nonnull @thread_self_inum) #9
  ret void
}
...
; Function Attrs: nounwind null_pointer_is_valid sspstrong uwtable(sync)
define internal ptr @proc_thread_self_get_link(ptr noundef readnone %0, ptr nocapture noundef readonly %1, ptr nocapture noundef writeonly %2) #0 {
  ...
  %11 = tail call i32 @__task_pid_nr_ns(ptr noundef %9, i32 noundef 0, ptr noundef %8) #9
  %12 = icmp eq i32 %11, 0
  br i1 %12, label %24, label %13

13:                                               ; preds = %3
  %14 = icmp eq ptr %0, null
  %15 = select i1 %14, i32 2592, i32 3264
  %16 = load ptr, ptr getelementptr inbounds ([3 x [14 x ptr]], ptr @kmalloc_caches, i32 0, i32 0, i32 6), align 4
  %17 = tail call noalias align 8 ptr @kmem_cache_alloc_trace(ptr noundef %16, i32 noundef %15, i32 noundef 27) #11
  %18 = icmp eq ptr %17, null
  br i1 %18, label %19, label %21, !prof !8

19:                                               ; preds = %13
  %20 = select i1 %14, ptr inttoptr (i32 -10 to ptr), ptr inttoptr (i32 -12 to ptr)
  br label %24

21:                                               ; preds = %13
  %22 = tail call i32 (ptr, ptr, ...) @sprintf(ptr noundef nonnull %17, ptr noundef nonnull @.str.2, i32 noundef %10, i32 noundef %11)
  store ptr @kfree_link, ptr %2, align 4
  %23 = getelementptr inbounds %struct.delayed_call, ptr %2, i32 0, i32 1
  store ptr %17, ptr %23, align 4
  br label %24

24:                                               ; preds = %21, %19, %3
  %25 = phi ptr [ %17, %21 ], [ inttoptr (i32 -2 to ptr), %3 ], [ %20, %19 ]
  ret ptr %25
}
