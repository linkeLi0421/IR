; ModuleID = '/llk/IR/fs/ext4/xattr_user.c_pt.bc'
source_filename = "../fs/ext4/xattr_user.c"
...
@ext4_xattr_user_handler = dso_local local_unnamed_addr constant %struct.xattr_handler { ptr null, ptr @.str, i32 0, ptr @ext4_xattr_user_list, ptr @ext4_xattr_user_get, ptr @ext4_xattr_user_set }, align 4

; Function Attrs: mustprogress nofree norecurse nosync nounwind null_pointer_is_valid readonly sspstrong willreturn uwtable(sync)
define internal zeroext i1 @ext4_xattr_user_list(ptr nocapture noundef readonly %0) #0 {
...
define internal i32 @ext4_xattr_user_get(ptr nocapture noundef readnone %0, ptr nocapture noundef readnone %1, ptr noundef %2, ptr noundef %3, ptr noundef %4, i32 noundef %5) #1 {
...
15:                                               ; preds = %6
  %16 = tail call i32 @ext4_xattr_get(ptr noundef %2, i32 noundef 1, ptr noundef %3, ptr noundef %4, i32 noundef %5) #3
  br label %17
...
; Function Attrs: nounwind null_pointer_is_valid sspstrong uwtable(sync)
define internal i32 @ext4_xattr_user_set(ptr nocapture noundef readnone %0, ptr nocapture noundef readnone %1, ptr nocapture noundef readnone %2, ptr noundef %3, ptr noundef %4, ptr noundef %5, i32 noundef %6, i32 noundef %7) #1 {
  %9 = getelementptr inbounds %struct.inode, ptr %3, i32 0, i32 8
  %10 = load ptr, ptr %9, align 4
...
17:                                               ; preds = %8
  %18 = tail call i32 @ext4_xattr_set(ptr noundef %3, i32 noundef 1, ptr noundef %4, ptr noundef %5, i32 noundef %6, i32 noundef %7) #3
  br label %19
...
; Function Attrs: null_pointer_is_valid
declare dso_local i32 @ext4_xattr_set(ptr noundef, i32 noundef, ptr noundef, ptr noundef, i32 noundef, i32 noundef) local_unnamed_addr #2
