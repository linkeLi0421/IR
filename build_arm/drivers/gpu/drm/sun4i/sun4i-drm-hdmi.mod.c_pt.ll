; ModuleID = '/llk/IR/build_arm/drivers/gpu/drm/sun4i/sun4i-drm-hdmi.mod.c_pt.bc'
source_filename = "drivers/gpu/drm/sun4i/sun4i-drm-hdmi.mod.c"
...
@__UNIQUE_ID_alias104 = internal constant [39 x i8] c"alias=of:N*T*Callwinner,sun4i-a10-hdmi\00", section ".modinfo", align 1
@__UNIQUE_ID_alias105 = internal constant [41 x i8] c"alias=of:N*T*Callwinner,sun4i-a10-hdmiC*\00", section ".modinfo", align 1
@__UNIQUE_ID_alias106 = internal constant [40 x i8] c"alias=of:N*T*Callwinner,sun5i-a10s-hdmi\00", section ".modinfo", align 1
@__UNIQUE_ID_alias107 = internal constant [42 x i8] c"alias=of:N*T*Callwinner,sun5i-a10s-hdmiC*\00", section ".modinfo", align 1
@__UNIQUE_ID_alias108 = internal constant [39 x i8] c"alias=of:N*T*Callwinner,sun6i-a31-hdmi\00", section ".modinfo", align 1
@__UNIQUE_ID_alias109 = internal constant [41 x i8] c"alias=of:N*T*Callwinner,sun6i-a31-hdmiC*\00", section ".modinfo", align 1
