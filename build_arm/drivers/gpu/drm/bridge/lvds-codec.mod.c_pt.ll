; ModuleID = '/llk/IR/build_arm/drivers/gpu/drm/bridge/lvds-codec.mod.c_pt.bc'
source_filename = "drivers/gpu/drm/bridge/lvds-codec.mod.c"
...
@__UNIQUE_ID_alias104 = internal constant [27 x i8] c"alias=of:N*T*Clvds-decoder\00", section ".modinfo", align 1
@__UNIQUE_ID_alias105 = internal constant [29 x i8] c"alias=of:N*T*Clvds-decoderC*\00", section ".modinfo", align 1
@__UNIQUE_ID_alias106 = internal constant [27 x i8] c"alias=of:N*T*Clvds-encoder\00", section ".modinfo", align 1
@__UNIQUE_ID_alias107 = internal constant [29 x i8] c"alias=of:N*T*Clvds-encoderC*\00", section ".modinfo", align 1
@__UNIQUE_ID_alias108 = internal constant [33 x i8] c"alias=of:N*T*Cthine,thc63lvdm83d\00", section ".modinfo", align 1
@__UNIQUE_ID_alias109 = internal constant [35 x i8] c"alias=of:N*T*Cthine,thc63lvdm83dC*\00", section ".modinfo", align 1
