; ModuleID = '/llk/IR/build_arm/drivers/gpu/drm/bridge/sii902x.mod.c_pt.bc'
source_filename = "drivers/gpu/drm/bridge/sii902x.mod.c"
...
@__UNIQUE_ID_name101 = internal constant [13 x i8] c"name=sii902x\00", section ".modinfo", align 1
...
@__UNIQUE_ID_alias104 = internal constant [26 x i8] c"alias=of:N*T*Csil,sii9022\00", section ".modinfo", align 1
@__UNIQUE_ID_alias105 = internal constant [28 x i8] c"alias=of:N*T*Csil,sii9022C*\00", section ".modinfo", align 1
@__UNIQUE_ID_alias106 = internal constant [18 x i8] c"alias=i2c:sii9022\00", section ".modinfo", align 1
