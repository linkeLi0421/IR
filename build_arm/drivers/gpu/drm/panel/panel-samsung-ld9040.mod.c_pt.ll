; ModuleID = '/llk/IR/build_arm/drivers/gpu/drm/panel/panel-samsung-ld9040.mod.c_pt.bc'
source_filename = "drivers/gpu/drm/panel/panel-samsung-ld9040.mod.c"
...
@__UNIQUE_ID_alias104 = internal constant [29 x i8] c"alias=of:N*T*Csamsung,ld9040\00", section ".modinfo", align 1
@__UNIQUE_ID_alias105 = internal constant [31 x i8] c"alias=of:N*T*Csamsung,ld9040C*\00", section ".modinfo", align 1
@__UNIQUE_ID_alias106 = internal constant [17 x i8] c"alias=spi:ld9040\00", section ".modinfo", align 1
