; ModuleID = '/llk/IR/build_arm/drivers/gpu/drm/panel/panel-samsung-s6e8aa0.mod.c_pt.bc'
source_filename = "drivers/gpu/drm/panel/panel-samsung-s6e8aa0.mod.c"
...
@__UNIQUE_ID_alias104 = internal constant [30 x i8] c"alias=of:N*T*Csamsung,s6e8aa0\00", section ".modinfo", align 1
@__UNIQUE_ID_alias105 = internal constant [32 x i8] c"alias=of:N*T*Csamsung,s6e8aa0C*\00", section ".modinfo", align 1
