; ModuleID = '/llk/IR/build_arm/drivers/gpu/drm/stm/stm-drm.mod.c_pt.bc'
source_filename = "drivers/gpu/drm/stm/stm-drm.mod.c"
...
@__UNIQUE_ID_alias104 = internal constant [28 x i8] c"alias=of:N*T*Cst,stm32-ltdc\00", section ".modinfo", align 1
@__UNIQUE_ID_alias105 = internal constant [30 x i8] c"alias=of:N*T*Cst,stm32-ltdcC*\00", section ".modinfo", align 1
