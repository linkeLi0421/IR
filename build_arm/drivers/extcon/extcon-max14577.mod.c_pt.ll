; ModuleID = '/llk/IR/build_arm/drivers/extcon/extcon-max14577.mod.c_pt.bc'
source_filename = "drivers/extcon/extcon-max14577.mod.c"
...
@__UNIQUE_ID_alias104 = internal constant [29 x i8] c"alias=platform:max14577-muic\00", section ".modinfo", align 1
@__UNIQUE_ID_alias105 = internal constant [29 x i8] c"alias=platform:max77836-muic\00", section ".modinfo", align 1
@__UNIQUE_ID_alias106 = internal constant [34 x i8] c"alias=of:N*T*Cmaxim,max14577-muic\00", section ".modinfo", align 1
@__UNIQUE_ID_alias107 = internal constant [36 x i8] c"alias=of:N*T*Cmaxim,max14577-muicC*\00", section ".modinfo", align 1
@__UNIQUE_ID_alias108 = internal constant [34 x i8] c"alias=of:N*T*Cmaxim,max77836-muic\00", section ".modinfo", align 1
@__UNIQUE_ID_alias109 = internal constant [36 x i8] c"alias=of:N*T*Cmaxim,max77836-muicC*\00", section ".modinfo", align 1
