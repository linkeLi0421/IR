; ModuleID = '/llk/IR/build_arm/drivers/nvmem/nvmem_meson_mx_efuse.mod.c_pt.bc'
source_filename = "drivers/nvmem/nvmem_meson_mx_efuse.mod.c"
...
@__UNIQUE_ID_alias104 = internal constant [35 x i8] c"alias=of:N*T*Camlogic,meson6-efuse\00", section ".modinfo", align 1
@__UNIQUE_ID_alias105 = internal constant [37 x i8] c"alias=of:N*T*Camlogic,meson6-efuseC*\00", section ".modinfo", align 1
@__UNIQUE_ID_alias106 = internal constant [35 x i8] c"alias=of:N*T*Camlogic,meson8-efuse\00", section ".modinfo", align 1
@__UNIQUE_ID_alias107 = internal constant [37 x i8] c"alias=of:N*T*Camlogic,meson8-efuseC*\00", section ".modinfo", align 1
@__UNIQUE_ID_alias108 = internal constant [36 x i8] c"alias=of:N*T*Camlogic,meson8b-efuse\00", section ".modinfo", align 1
@__UNIQUE_ID_alias109 = internal constant [38 x i8] c"alias=of:N*T*Camlogic,meson8b-efuseC*\00", section ".modinfo", align 1
