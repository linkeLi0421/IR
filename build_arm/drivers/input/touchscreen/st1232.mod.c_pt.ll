; ModuleID = '/llk/IR/build_arm/drivers/input/touchscreen/st1232.mod.c_pt.bc'
source_filename = "drivers/input/touchscreen/st1232.mod.c"
...
@__UNIQUE_ID_alias104 = internal constant [20 x i8] c"alias=i2c:st1232-ts\00", section ".modinfo", align 1
@__UNIQUE_ID_alias105 = internal constant [20 x i8] c"alias=i2c:st1633-ts\00", section ".modinfo", align 1
@__UNIQUE_ID_alias106 = internal constant [30 x i8] c"alias=of:N*T*Csitronix,st1232\00", section ".modinfo", align 1
@__UNIQUE_ID_alias107 = internal constant [32 x i8] c"alias=of:N*T*Csitronix,st1232C*\00", section ".modinfo", align 1
@__UNIQUE_ID_alias108 = internal constant [30 x i8] c"alias=of:N*T*Csitronix,st1633\00", section ".modinfo", align 1
@__UNIQUE_ID_alias109 = internal constant [32 x i8] c"alias=of:N*T*Csitronix,st1633C*\00", section ".modinfo", align 1
