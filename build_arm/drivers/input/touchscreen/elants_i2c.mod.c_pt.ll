; ModuleID = '/llk/IR/build_arm/drivers/input/touchscreen/elants_i2c.mod.c_pt.bc'
source_filename = "drivers/input/touchscreen/elants_i2c.mod.c"
...
@__UNIQUE_ID_alias104 = internal constant [21 x i8] c"alias=i2c:elants_i2c\00", section ".modinfo", align 1
@__UNIQUE_ID_alias105 = internal constant [19 x i8] c"alias=i2c:ekth3500\00", section ".modinfo", align 1
@__UNIQUE_ID_alias106 = internal constant [19 x i8] c"alias=i2c:ektf3624\00", section ".modinfo", align 1
@__UNIQUE_ID_alias107 = internal constant [28 x i8] c"alias=of:N*T*Celan,ekth3500\00", section ".modinfo", align 1
@__UNIQUE_ID_alias108 = internal constant [30 x i8] c"alias=of:N*T*Celan,ekth3500C*\00", section ".modinfo", align 1
@__UNIQUE_ID_alias109 = internal constant [28 x i8] c"alias=of:N*T*Celan,ektf3624\00", section ".modinfo", align 1
@__UNIQUE_ID_alias110 = internal constant [30 x i8] c"alias=of:N*T*Celan,ektf3624C*\00", section ".modinfo", align 1
