; ModuleID = '/llk/IR/build_arm/drivers/input/keyboard/samsung-keypad.mod.c_pt.bc'
source_filename = "drivers/input/keyboard/samsung-keypad.mod.c"
...
@__UNIQUE_ID_alias104 = internal constant [37 x i8] c"alias=of:N*T*Csamsung,s3c6410-keypad\00", section ".modinfo", align 1
@__UNIQUE_ID_alias105 = internal constant [39 x i8] c"alias=of:N*T*Csamsung,s3c6410-keypadC*\00", section ".modinfo", align 1
@__UNIQUE_ID_alias106 = internal constant [37 x i8] c"alias=of:N*T*Csamsung,s5pv210-keypad\00", section ".modinfo", align 1
@__UNIQUE_ID_alias107 = internal constant [39 x i8] c"alias=of:N*T*Csamsung,s5pv210-keypadC*\00", section ".modinfo", align 1
@__UNIQUE_ID_alias108 = internal constant [30 x i8] c"alias=platform:samsung-keypad\00", section ".modinfo", align 1
@__UNIQUE_ID_alias109 = internal constant [30 x i8] c"alias=platform:s5pv210-keypad\00", section ".modinfo", align 1
