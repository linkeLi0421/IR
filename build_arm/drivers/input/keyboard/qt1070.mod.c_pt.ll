; ModuleID = '/llk/IR/build_arm/drivers/input/keyboard/qt1070.mod.c_pt.bc'
source_filename = "drivers/input/keyboard/qt1070.mod.c"
...
@__UNIQUE_ID_alias104 = internal constant [17 x i8] c"alias=i2c:qt1070\00", section ".modinfo", align 1
@__UNIQUE_ID_alias105 = internal constant [21 x i8] c"alias=of:N*T*Cqt1070\00", section ".modinfo", align 1
@__UNIQUE_ID_alias106 = internal constant [23 x i8] c"alias=of:N*T*Cqt1070C*\00", section ".modinfo", align 1
