; ModuleID = '/llk/IR/build_arm/drivers/i2c/busses/i2c-cros-ec-tunnel.mod.c_pt.bc'
source_filename = "drivers/i2c/busses/i2c-cros-ec-tunnel.mod.c"
...
@__UNIQUE_ID_alias104 = internal constant [23 x i8] c"alias=acpi*:GOOG0012:*\00", section ".modinfo", align 1
@__UNIQUE_ID_alias105 = internal constant [40 x i8] c"alias=of:N*T*Cgoogle,cros-ec-i2c-tunnel\00", section ".modinfo", align 1
@__UNIQUE_ID_alias106 = internal constant [42 x i8] c"alias=of:N*T*Cgoogle,cros-ec-i2c-tunnelC*\00", section ".modinfo", align 1
