; ModuleID = '/llk/IR/build_arm/drivers/spi/spi-stm32.mod.c_pt.bc'
source_filename = "drivers/spi/spi-stm32.mod.c"
...
@__UNIQUE_ID_name101 = internal constant [15 x i8] c"name=spi_stm32\00", section ".modinfo", align 1
...
@__UNIQUE_ID_alias104 = internal constant [29 x i8] c"alias=of:N*T*Cst,stm32h7-spi\00", section ".modinfo", align 1
@__UNIQUE_ID_alias105 = internal constant [31 x i8] c"alias=of:N*T*Cst,stm32h7-spiC*\00", section ".modinfo", align 1
@__UNIQUE_ID_alias106 = internal constant [29 x i8] c"alias=of:N*T*Cst,stm32f4-spi\00", section ".modinfo", align 1
@__UNIQUE_ID_alias107 = internal constant [31 x i8] c"alias=of:N*T*Cst,stm32f4-spiC*\00", section ".modinfo", align 1
