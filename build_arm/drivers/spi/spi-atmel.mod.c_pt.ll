; ModuleID = '/llk/IR/build_arm/drivers/spi/spi-atmel.mod.c_pt.bc'
source_filename = "drivers/spi/spi-atmel.mod.c"
...
@__UNIQUE_ID_alias104 = internal constant [35 x i8] c"alias=of:N*T*Catmel,at91rm9200-spi\00", section ".modinfo", align 1
@__UNIQUE_ID_alias105 = internal constant [37 x i8] c"alias=of:N*T*Catmel,at91rm9200-spiC*\00", section ".modinfo", align 1
