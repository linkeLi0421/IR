; ModuleID = '/llk/IR/build_arm/drivers/dma/sh/usb-dmac.mod.c_pt.bc'
source_filename = "drivers/dma/sh/usb-dmac.mod.c"
...
@__UNIQUE_ID_alias104 = internal constant [31 x i8] c"alias=of:N*T*Crenesas,usb-dmac\00", section ".modinfo", align 1
@__UNIQUE_ID_alias105 = internal constant [33 x i8] c"alias=of:N*T*Crenesas,usb-dmacC*\00", section ".modinfo", align 1
