; ModuleID = '/llk/IR/build_arm/drivers/media/dvb-frontends/lgdt3306a.mod.c_pt.bc'
source_filename = "drivers/media/dvb-frontends/lgdt3306a.mod.c"
...
@__UNIQUE_ID_alias104 = internal constant [20 x i8] c"alias=i2c:lgdt3306a\00", section ".modinfo", align 1
@__UNIQUE_ID_srcversion105 = internal constant [35 x i8] c"srcversion=B55A232D3B155FC635E9BA6\00", section ".modinfo", align 1
@llvm.compiler.used = appending global [8 x ptr] [ptr @__UNIQUE_ID_alias104, ptr @__UNIQUE_ID_depends103, ptr @__UNIQUE_ID_intree102, ptr @__UNIQUE_ID_name101, ptr @__UNIQUE_ID_srcversion105, ptr @__UNIQUE_ID_vermagic100, ptr @_note_8, ptr @_note_9], section "llvm.metadata"
