; ModuleID = '/llk/IR/build_arm/drivers/media/platform/sti/hva/st-hva.mod.c_pt.bc'
source_filename = "drivers/media/platform/sti/hva/st-hva.mod.c"
...
@__UNIQUE_ID_alias104 = internal constant [24 x i8] c"alias=of:N*T*Cst,st-hva\00", section ".modinfo", align 1
@__UNIQUE_ID_alias105 = internal constant [26 x i8] c"alias=of:N*T*Cst,st-hvaC*\00", section ".modinfo", align 1
