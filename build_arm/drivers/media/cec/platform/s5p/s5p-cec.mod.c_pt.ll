; ModuleID = '/llk/IR/build_arm/drivers/media/cec/platform/s5p/s5p-cec.mod.c_pt.bc'
source_filename = "drivers/media/cec/platform/s5p/s5p-cec.mod.c"
...
@__UNIQUE_ID_alias104 = internal constant [30 x i8] c"alias=of:N*T*Csamsung,s5p-cec\00", section ".modinfo", align 1
@__UNIQUE_ID_alias105 = internal constant [32 x i8] c"alias=of:N*T*Csamsung,s5p-cecC*\00", section ".modinfo", align 1
