; ModuleID = '/llk/IR/build_arm/drivers/power/supply/max14577_charger.mod.c_pt.bc'
source_filename = "drivers/power/supply/max14577_charger.mod.c"
...
@__UNIQUE_ID_alias104 = internal constant [32 x i8] c"alias=platform:max14577-charger\00", section ".modinfo", align 1
@__UNIQUE_ID_alias105 = internal constant [32 x i8] c"alias=platform:max77836-charger\00", section ".modinfo", align 1
@__UNIQUE_ID_alias106 = internal constant [37 x i8] c"alias=of:N*T*Cmaxim,max14577-charger\00", section ".modinfo", align 1
@__UNIQUE_ID_alias107 = internal constant [39 x i8] c"alias=of:N*T*Cmaxim,max14577-chargerC*\00", section ".modinfo", align 1
@__UNIQUE_ID_alias108 = internal constant [37 x i8] c"alias=of:N*T*Cmaxim,max77836-charger\00", section ".modinfo", align 1
@__UNIQUE_ID_alias109 = internal constant [39 x i8] c"alias=of:N*T*Cmaxim,max77836-chargerC*\00", section ".modinfo", align 1
