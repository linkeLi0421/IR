; ModuleID = '/llk/IR/build_arm/drivers/net/usb/lan78xx.mod.c_pt.bc'
source_filename = "drivers/net/usb/lan78xx.mod.c"
...
@__UNIQUE_ID_alias104 = internal constant [46 x i8] c"alias=usb:v0424p7800d*dc*dsc*dp*ic*isc*ip*in*\00", section ".modinfo", align 1
@__UNIQUE_ID_alias105 = internal constant [46 x i8] c"alias=usb:v0424p7850d*dc*dsc*dp*ic*isc*ip*in*\00", section ".modinfo", align 1
@__UNIQUE_ID_alias106 = internal constant [46 x i8] c"alias=usb:v0424p7801d*dc*dsc*dp*ic*isc*ip*in*\00", section ".modinfo", align 1
@__UNIQUE_ID_alias107 = internal constant [46 x i8] c"alias=usb:v07C9p0012d*dc*dsc*dp*ic*isc*ip*in*\00", section ".modinfo", align 1
