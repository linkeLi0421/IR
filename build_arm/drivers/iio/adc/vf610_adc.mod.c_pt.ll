; ModuleID = '/llk/IR/build_arm/drivers/iio/adc/vf610_adc.mod.c_pt.bc'
source_filename = "drivers/iio/adc/vf610_adc.mod.c"
...
@__UNIQUE_ID_alias104 = internal constant [28 x i8] c"alias=of:N*T*Cfsl,vf610-adc\00", section ".modinfo", align 1
@__UNIQUE_ID_alias105 = internal constant [30 x i8] c"alias=of:N*T*Cfsl,vf610-adcC*\00", section ".modinfo", align 1
