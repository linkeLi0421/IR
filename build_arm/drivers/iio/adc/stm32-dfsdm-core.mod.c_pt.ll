; ModuleID = '/llk/IR/build_arm/drivers/iio/adc/stm32-dfsdm-core.mod.c_pt.bc'
source_filename = "drivers/iio/adc/stm32-dfsdm-core.mod.c"
...
@__UNIQUE_ID_alias104 = internal constant [31 x i8] c"alias=of:N*T*Cst,stm32h7-dfsdm\00", section ".modinfo", align 1
@__UNIQUE_ID_alias105 = internal constant [33 x i8] c"alias=of:N*T*Cst,stm32h7-dfsdmC*\00", section ".modinfo", align 1
@__UNIQUE_ID_alias106 = internal constant [32 x i8] c"alias=of:N*T*Cst,stm32mp1-dfsdm\00", section ".modinfo", align 1
@__UNIQUE_ID_alias107 = internal constant [34 x i8] c"alias=of:N*T*Cst,stm32mp1-dfsdmC*\00", section ".modinfo", align 1
