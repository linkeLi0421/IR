; ModuleID = '/llk/IR/build_arm/drivers/iio/adc/cpcap-adc.mod.c_pt.bc'
source_filename = "drivers/iio/adc/cpcap-adc.mod.c"
...
@__UNIQUE_ID_alias104 = internal constant [33 x i8] c"alias=of:N*T*Cmotorola,cpcap-adc\00", section ".modinfo", align 1
@__UNIQUE_ID_alias105 = internal constant [35 x i8] c"alias=of:N*T*Cmotorola,cpcap-adcC*\00", section ".modinfo", align 1
@__UNIQUE_ID_alias106 = internal constant [42 x i8] c"alias=of:N*T*Cmotorola,mapphone-cpcap-adc\00", section ".modinfo", align 1
@__UNIQUE_ID_alias107 = internal constant [44 x i8] c"alias=of:N*T*Cmotorola,mapphone-cpcap-adcC*\00", section ".modinfo", align 1
