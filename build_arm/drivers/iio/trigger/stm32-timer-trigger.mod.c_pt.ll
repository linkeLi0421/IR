; ModuleID = '/llk/IR/build_arm/drivers/iio/trigger/stm32-timer-trigger.mod.c_pt.bc'
source_filename = "drivers/iio/trigger/stm32-timer-trigger.mod.c"
...
@__UNIQUE_ID_alias104 = internal constant [37 x i8] c"alias=of:N*T*Cst,stm32-timer-trigger\00", section ".modinfo", align 1
@__UNIQUE_ID_alias105 = internal constant [39 x i8] c"alias=of:N*T*Cst,stm32-timer-triggerC*\00", section ".modinfo", align 1
@__UNIQUE_ID_alias106 = internal constant [39 x i8] c"alias=of:N*T*Cst,stm32h7-timer-trigger\00", section ".modinfo", align 1
@__UNIQUE_ID_alias107 = internal constant [41 x i8] c"alias=of:N*T*Cst,stm32h7-timer-triggerC*\00", section ".modinfo", align 1
