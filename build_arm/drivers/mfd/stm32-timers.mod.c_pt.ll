; ModuleID = '/llk/IR/build_arm/drivers/mfd/stm32-timers.mod.c_pt.bc'
source_filename = "drivers/mfd/stm32-timers.mod.c"
...
@__UNIQUE_ID_alias104 = internal constant [30 x i8] c"alias=of:N*T*Cst,stm32-timers\00", section ".modinfo", align 1
@__UNIQUE_ID_alias105 = internal constant [32 x i8] c"alias=of:N*T*Cst,stm32-timersC*\00", section ".modinfo", align 1
