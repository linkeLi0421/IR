; ModuleID = '/llk/IR/build_arm/drivers/mfd/stm32-lptimer.mod.c_pt.bc'
source_filename = "drivers/mfd/stm32-lptimer.mod.c"
...
@__UNIQUE_ID_alias104 = internal constant [31 x i8] c"alias=of:N*T*Cst,stm32-lptimer\00", section ".modinfo", align 1
@__UNIQUE_ID_alias105 = internal constant [33 x i8] c"alias=of:N*T*Cst,stm32-lptimerC*\00", section ".modinfo", align 1
