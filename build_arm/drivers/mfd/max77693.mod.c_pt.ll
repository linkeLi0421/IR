; ModuleID = '/llk/IR/build_arm/drivers/mfd/max77693.mod.c_pt.bc'
source_filename = "drivers/mfd/max77693.mod.c"
...
@__UNIQUE_ID_alias104 = internal constant [19 x i8] c"alias=i2c:max77693\00", section ".modinfo", align 1
@__UNIQUE_ID_alias105 = internal constant [29 x i8] c"alias=of:N*T*Cmaxim,max77693\00", section ".modinfo", align 1
@__UNIQUE_ID_alias106 = internal constant [31 x i8] c"alias=of:N*T*Cmaxim,max77693C*\00", section ".modinfo", align 1
