; ModuleID = '/llk/IR/build_arm/drivers/platform/chrome/cros_ec.mod.c_pt.bc'
source_filename = "drivers/platform/chrome/cros_ec.mod.c"
...
@__UNIQUE_ID_name101 = internal constant [13 x i8] c"name=cros_ec\00", section ".modinfo", align 1
