; ModuleID = '/llk/IR/build_arm/drivers/reset/reset-berlin.mod.c_pt.bc'
source_filename = "drivers/reset/reset-berlin.mod.c"
...
@__UNIQUE_ID_alias104 = internal constant [36 x i8] c"alias=of:N*T*Cmarvell,berlin2-reset\00", section ".modinfo", align 1
@__UNIQUE_ID_alias105 = internal constant [38 x i8] c"alias=of:N*T*Cmarvell,berlin2-resetC*\00", section ".modinfo", align 1
