; ModuleID = '/llk/IR/build_arm/drivers/rtc/rtc-meson-vrtc.mod.c_pt.bc'
source_filename = "drivers/rtc/rtc-meson-vrtc.mod.c"
...
@__UNIQUE_ID_alias104 = internal constant [33 x i8] c"alias=of:N*T*Camlogic,meson-vrtc\00", section ".modinfo", align 1
@__UNIQUE_ID_alias105 = internal constant [35 x i8] c"alias=of:N*T*Camlogic,meson-vrtcC*\00", section ".modinfo", align 1
