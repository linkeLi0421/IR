; ModuleID = '/llk/IR/build_arm/drivers/rtc/rtc-s5m.mod.c_pt.bc'
source_filename = "drivers/rtc/rtc-s5m.mod.c"
...
@__UNIQUE_ID_alias104 = internal constant [23 x i8] c"alias=platform:s5m-rtc\00", section ".modinfo", align 1
@__UNIQUE_ID_alias105 = internal constant [27 x i8] c"alias=platform:s2mps13-rtc\00", section ".modinfo", align 1
@__UNIQUE_ID_alias106 = internal constant [27 x i8] c"alias=platform:s2mps14-rtc\00", section ".modinfo", align 1
@__UNIQUE_ID_alias107 = internal constant [27 x i8] c"alias=platform:s2mps15-rtc\00", section ".modinfo", align 1
