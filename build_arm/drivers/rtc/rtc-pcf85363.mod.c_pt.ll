; ModuleID = '/llk/IR/build_arm/drivers/rtc/rtc-pcf85363.mod.c_pt.bc'
source_filename = "drivers/rtc/rtc-pcf85363.mod.c"
...
@__UNIQUE_ID_alias104 = internal constant [27 x i8] c"alias=of:N*T*Cnxp,pcf85263\00", section ".modinfo", align 1
@__UNIQUE_ID_alias105 = internal constant [29 x i8] c"alias=of:N*T*Cnxp,pcf85263C*\00", section ".modinfo", align 1
@__UNIQUE_ID_alias106 = internal constant [27 x i8] c"alias=of:N*T*Cnxp,pcf85363\00", section ".modinfo", align 1
@__UNIQUE_ID_alias107 = internal constant [29 x i8] c"alias=of:N*T*Cnxp,pcf85363C*\00", section ".modinfo", align 1
