; ModuleID = '/llk/IR/build_arm/drivers/rtc/rtc-aspeed.mod.c_pt.bc'
source_filename = "drivers/rtc/rtc-aspeed.mod.c"
...
@__UNIQUE_ID_alias104 = internal constant [33 x i8] c"alias=of:N*T*Caspeed,ast2400-rtc\00", section ".modinfo", align 1
@__UNIQUE_ID_alias105 = internal constant [35 x i8] c"alias=of:N*T*Caspeed,ast2400-rtcC*\00", section ".modinfo", align 1
@__UNIQUE_ID_alias106 = internal constant [33 x i8] c"alias=of:N*T*Caspeed,ast2500-rtc\00", section ".modinfo", align 1
@__UNIQUE_ID_alias107 = internal constant [35 x i8] c"alias=of:N*T*Caspeed,ast2500-rtcC*\00", section ".modinfo", align 1
@__UNIQUE_ID_alias108 = internal constant [33 x i8] c"alias=of:N*T*Caspeed,ast2600-rtc\00", section ".modinfo", align 1
@__UNIQUE_ID_alias109 = internal constant [35 x i8] c"alias=of:N*T*Caspeed,ast2600-rtcC*\00", section ".modinfo", align 1
