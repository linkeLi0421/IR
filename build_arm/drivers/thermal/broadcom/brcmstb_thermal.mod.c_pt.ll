; ModuleID = '/llk/IR/build_arm/drivers/thermal/broadcom/brcmstb_thermal.mod.c_pt.bc'
source_filename = "drivers/thermal/broadcom/brcmstb_thermal.mod.c"
...
@__UNIQUE_ID_alias104 = internal constant [36 x i8] c"alias=of:N*T*Cbrcm,avs-tmon-bcm7216\00", section ".modinfo", align 1
@__UNIQUE_ID_alias105 = internal constant [38 x i8] c"alias=of:N*T*Cbrcm,avs-tmon-bcm7216C*\00", section ".modinfo", align 1
@__UNIQUE_ID_alias106 = internal constant [28 x i8] c"alias=of:N*T*Cbrcm,avs-tmon\00", section ".modinfo", align 1
@__UNIQUE_ID_alias107 = internal constant [30 x i8] c"alias=of:N*T*Cbrcm,avs-tmonC*\00", section ".modinfo", align 1
