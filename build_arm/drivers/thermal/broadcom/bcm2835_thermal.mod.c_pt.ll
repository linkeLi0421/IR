; ModuleID = '/llk/IR/build_arm/drivers/thermal/broadcom/bcm2835_thermal.mod.c_pt.bc'
source_filename = "drivers/thermal/broadcom/bcm2835_thermal.mod.c"
...
@__UNIQUE_ID_alias104 = internal constant [35 x i8] c"alias=of:N*T*Cbrcm,bcm2835-thermal\00", section ".modinfo", align 1
@__UNIQUE_ID_alias105 = internal constant [37 x i8] c"alias=of:N*T*Cbrcm,bcm2835-thermalC*\00", section ".modinfo", align 1
@__UNIQUE_ID_alias106 = internal constant [35 x i8] c"alias=of:N*T*Cbrcm,bcm2836-thermal\00", section ".modinfo", align 1
@__UNIQUE_ID_alias107 = internal constant [37 x i8] c"alias=of:N*T*Cbrcm,bcm2836-thermalC*\00", section ".modinfo", align 1
@__UNIQUE_ID_alias108 = internal constant [35 x i8] c"alias=of:N*T*Cbrcm,bcm2837-thermal\00", section ".modinfo", align 1
@__UNIQUE_ID_alias109 = internal constant [37 x i8] c"alias=of:N*T*Cbrcm,bcm2837-thermalC*\00", section ".modinfo", align 1
