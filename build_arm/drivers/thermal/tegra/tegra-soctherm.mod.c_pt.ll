; ModuleID = '/llk/IR/build_arm/drivers/thermal/tegra/tegra-soctherm.mod.c_pt.bc'
source_filename = "drivers/thermal/tegra/tegra-soctherm.mod.c"
...
@__UNIQUE_ID_alias104 = internal constant [39 x i8] c"alias=of:N*T*Cnvidia,tegra124-soctherm\00", section ".modinfo", align 1
@__UNIQUE_ID_alias105 = internal constant [41 x i8] c"alias=of:N*T*Cnvidia,tegra124-socthermC*\00", section ".modinfo", align 1
