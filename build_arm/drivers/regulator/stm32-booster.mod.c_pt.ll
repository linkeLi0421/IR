; ModuleID = '/llk/IR/build_arm/drivers/regulator/stm32-booster.mod.c_pt.bc'
source_filename = "drivers/regulator/stm32-booster.mod.c"
...
@__UNIQUE_ID_alias104 = internal constant [33 x i8] c"alias=of:N*T*Cst,stm32h7-booster\00", section ".modinfo", align 1
@__UNIQUE_ID_alias105 = internal constant [35 x i8] c"alias=of:N*T*Cst,stm32h7-boosterC*\00", section ".modinfo", align 1
@__UNIQUE_ID_alias106 = internal constant [34 x i8] c"alias=of:N*T*Cst,stm32mp1-booster\00", section ".modinfo", align 1
@__UNIQUE_ID_alias107 = internal constant [36 x i8] c"alias=of:N*T*Cst,stm32mp1-boosterC*\00", section ".modinfo", align 1
