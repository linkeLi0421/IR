; ModuleID = '/llk/IR/build_arm/drivers/devfreq/tegra30-devfreq.mod.c_pt.bc'
source_filename = "drivers/devfreq/tegra30-devfreq.mod.c"
...
@__UNIQUE_ID_alias104 = internal constant [36 x i8] c"alias=of:N*T*Cnvidia,tegra30-actmon\00", section ".modinfo", align 1
@__UNIQUE_ID_alias105 = internal constant [38 x i8] c"alias=of:N*T*Cnvidia,tegra30-actmonC*\00", section ".modinfo", align 1
@__UNIQUE_ID_alias106 = internal constant [37 x i8] c"alias=of:N*T*Cnvidia,tegra124-actmon\00", section ".modinfo", align 1
@__UNIQUE_ID_alias107 = internal constant [39 x i8] c"alias=of:N*T*Cnvidia,tegra124-actmonC*\00", section ".modinfo", align 1
