; ModuleID = '/llk/IR/build_arm/drivers/devfreq/exynos-bus.mod.c_pt.bc'
source_filename = "drivers/devfreq/exynos-bus.mod.c"
...
@__UNIQUE_ID_alias104 = internal constant [33 x i8] c"alias=of:N*T*Csamsung,exynos-bus\00", section ".modinfo", align 1
@__UNIQUE_ID_alias105 = internal constant [35 x i8] c"alias=of:N*T*Csamsung,exynos-busC*\00", section ".modinfo", align 1
