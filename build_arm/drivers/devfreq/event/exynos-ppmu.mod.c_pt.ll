; ModuleID = '/llk/IR/build_arm/drivers/devfreq/event/exynos-ppmu.mod.c_pt.bc'
source_filename = "drivers/devfreq/event/exynos-ppmu.mod.c"
...
@__UNIQUE_ID_alias104 = internal constant [34 x i8] c"alias=of:N*T*Csamsung,exynos-ppmu\00", section ".modinfo", align 1
@__UNIQUE_ID_alias105 = internal constant [36 x i8] c"alias=of:N*T*Csamsung,exynos-ppmuC*\00", section ".modinfo", align 1
@__UNIQUE_ID_alias106 = internal constant [37 x i8] c"alias=of:N*T*Csamsung,exynos-ppmu-v2\00", section ".modinfo", align 1
@__UNIQUE_ID_alias107 = internal constant [39 x i8] c"alias=of:N*T*Csamsung,exynos-ppmu-v2C*\00", section ".modinfo", align 1
