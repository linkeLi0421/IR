; ModuleID = '/llk/IR/build_arm/drivers/crypto/amlogic/amlogic-gxl-crypto.mod.c_pt.bc'
source_filename = "drivers/crypto/amlogic/amlogic-gxl-crypto.mod.c"
...
@__UNIQUE_ID_alias104 = internal constant [33 x i8] c"alias=of:N*T*Camlogic,gxl-crypto\00", section ".modinfo", align 1
@__UNIQUE_ID_alias105 = internal constant [35 x i8] c"alias=of:N*T*Camlogic,gxl-cryptoC*\00", section ".modinfo", align 1
