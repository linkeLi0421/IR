; ModuleID = '/llk/IR/build_arm/drivers/crypto/exynos-rng.mod.c_pt.bc'
source_filename = "drivers/crypto/exynos-rng.mod.c"
...
@__UNIQUE_ID_alias104 = internal constant [34 x i8] c"alias=of:N*T*Csamsung,exynos4-rng\00", section ".modinfo", align 1
@__UNIQUE_ID_alias105 = internal constant [36 x i8] c"alias=of:N*T*Csamsung,exynos4-rngC*\00", section ".modinfo", align 1
@__UNIQUE_ID_alias106 = internal constant [38 x i8] c"alias=of:N*T*Csamsung,exynos5250-prng\00", section ".modinfo", align 1
@__UNIQUE_ID_alias107 = internal constant [40 x i8] c"alias=of:N*T*Csamsung,exynos5250-prngC*\00", section ".modinfo", align 1
