; ModuleID = '/llk/IR/build_arm/drivers/crypto/atmel-tdes.mod.c_pt.bc'
source_filename = "drivers/crypto/atmel-tdes.mod.c"
...
@__UNIQUE_ID_alias104 = internal constant [37 x i8] c"alias=of:N*T*Catmel,at91sam9g46-tdes\00", section ".modinfo", align 1
@__UNIQUE_ID_alias105 = internal constant [39 x i8] c"alias=of:N*T*Catmel,at91sam9g46-tdesC*\00", section ".modinfo", align 1
