; ModuleID = '/llk/IR/build_arm/drivers/crypto/s5p-sss.mod.c_pt.bc'
source_filename = "drivers/crypto/s5p-sss.mod.c"
...
@__UNIQUE_ID_alias104 = internal constant [36 x i8] c"alias=of:N*T*Csamsung,s5pv210-secss\00", section ".modinfo", align 1
@__UNIQUE_ID_alias105 = internal constant [38 x i8] c"alias=of:N*T*Csamsung,s5pv210-secssC*\00", section ".modinfo", align 1
@__UNIQUE_ID_alias106 = internal constant [39 x i8] c"alias=of:N*T*Csamsung,exynos4210-secss\00", section ".modinfo", align 1
@__UNIQUE_ID_alias107 = internal constant [41 x i8] c"alias=of:N*T*Csamsung,exynos4210-secssC*\00", section ".modinfo", align 1
@__UNIQUE_ID_alias108 = internal constant [42 x i8] c"alias=of:N*T*Csamsung,exynos5433-slim-sss\00", section ".modinfo", align 1
@__UNIQUE_ID_alias109 = internal constant [44 x i8] c"alias=of:N*T*Csamsung,exynos5433-slim-sssC*\00", section ".modinfo", align 1
