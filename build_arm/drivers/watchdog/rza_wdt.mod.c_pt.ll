; ModuleID = '/llk/IR/build_arm/drivers/watchdog/rza_wdt.mod.c_pt.bc'
source_filename = "drivers/watchdog/rza_wdt.mod.c"
...
@__UNIQUE_ID_alias104 = internal constant [34 x i8] c"alias=of:N*T*Crenesas,r7s9210-wdt\00", section ".modinfo", align 1
@__UNIQUE_ID_alias105 = internal constant [36 x i8] c"alias=of:N*T*Crenesas,r7s9210-wdtC*\00", section ".modinfo", align 1
@__UNIQUE_ID_alias106 = internal constant [30 x i8] c"alias=of:N*T*Crenesas,rza-wdt\00", section ".modinfo", align 1
@__UNIQUE_ID_alias107 = internal constant [32 x i8] c"alias=of:N*T*Crenesas,rza-wdtC*\00", section ".modinfo", align 1
