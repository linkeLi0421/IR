; ModuleID = '/llk/IR/build_arm/drivers/watchdog/tegra_wdt.mod.c_pt.bc'
source_filename = "drivers/watchdog/tegra_wdt.mod.c"
...
@__UNIQUE_ID_alias104 = internal constant [35 x i8] c"alias=of:N*T*Cnvidia,tegra30-timer\00", section ".modinfo", align 1
@__UNIQUE_ID_alias105 = internal constant [37 x i8] c"alias=of:N*T*Cnvidia,tegra30-timerC*\00", section ".modinfo", align 1
