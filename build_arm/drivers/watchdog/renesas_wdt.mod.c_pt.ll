; ModuleID = '/llk/IR/build_arm/drivers/watchdog/renesas_wdt.mod.c_pt.bc'
source_filename = "drivers/watchdog/renesas_wdt.mod.c"
...
@__UNIQUE_ID_alias104 = internal constant [36 x i8] c"alias=of:N*T*Crenesas,rcar-gen2-wdt\00", section ".modinfo", align 1
@__UNIQUE_ID_alias105 = internal constant [38 x i8] c"alias=of:N*T*Crenesas,rcar-gen2-wdtC*\00", section ".modinfo", align 1
@__UNIQUE_ID_alias106 = internal constant [36 x i8] c"alias=of:N*T*Crenesas,rcar-gen3-wdt\00", section ".modinfo", align 1
@__UNIQUE_ID_alias107 = internal constant [38 x i8] c"alias=of:N*T*Crenesas,rcar-gen3-wdtC*\00", section ".modinfo", align 1
