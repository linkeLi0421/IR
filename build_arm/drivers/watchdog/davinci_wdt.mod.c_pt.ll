; ModuleID = '/llk/IR/build_arm/drivers/watchdog/davinci_wdt.mod.c_pt.bc'
source_filename = "drivers/watchdog/davinci_wdt.mod.c"
...
@__UNIQUE_ID_alias104 = internal constant [29 x i8] c"alias=of:N*T*Cti,davinci-wdt\00", section ".modinfo", align 1
@__UNIQUE_ID_alias105 = internal constant [31 x i8] c"alias=of:N*T*Cti,davinci-wdtC*\00", section ".modinfo", align 1
