; ModuleID = '/llk/IR/build_arm/drivers/remoteproc/st_remoteproc.mod.c_pt.bc'
source_filename = "drivers/remoteproc/st_remoteproc.mod.c"
...
@__UNIQUE_ID_alias104 = internal constant [28 x i8] c"alias=of:N*T*Cst,st40-rproc\00", section ".modinfo", align 1
@__UNIQUE_ID_alias105 = internal constant [30 x i8] c"alias=of:N*T*Cst,st40-rprocC*\00", section ".modinfo", align 1
@__UNIQUE_ID_alias106 = internal constant [29 x i8] c"alias=of:N*T*Cst,st231-rproc\00", section ".modinfo", align 1
@__UNIQUE_ID_alias107 = internal constant [31 x i8] c"alias=of:N*T*Cst,st231-rprocC*\00", section ".modinfo", align 1
