; ModuleID = '/llk/IR/build_arm/sound/soc/stm/snd-soc-stm32-sai.mod.c_pt.bc'
source_filename = "sound/soc/stm/snd-soc-stm32-sai.mod.c"
...
@__UNIQUE_ID_alias104 = internal constant [29 x i8] c"alias=of:N*T*Cst,stm32f4-sai\00", section ".modinfo", align 1
@__UNIQUE_ID_alias105 = internal constant [31 x i8] c"alias=of:N*T*Cst,stm32f4-saiC*\00", section ".modinfo", align 1
@__UNIQUE_ID_alias106 = internal constant [29 x i8] c"alias=of:N*T*Cst,stm32h7-sai\00", section ".modinfo", align 1
@__UNIQUE_ID_alias107 = internal constant [31 x i8] c"alias=of:N*T*Cst,stm32h7-saiC*\00", section ".modinfo", align 1
