; ModuleID = '/llk/IR/build_arm/sound/soc/sh/snd-soc-fsi.mod.c_pt.bc'
source_filename = "sound/soc/sh/snd-soc-fsi.mod.c"
...
@__UNIQUE_ID_alias104 = internal constant [29 x i8] c"alias=of:N*T*Crenesas,sh_fsi\00", section ".modinfo", align 1
@__UNIQUE_ID_alias105 = internal constant [31 x i8] c"alias=of:N*T*Crenesas,sh_fsiC*\00", section ".modinfo", align 1
@__UNIQUE_ID_alias106 = internal constant [30 x i8] c"alias=of:N*T*Crenesas,sh_fsi2\00", section ".modinfo", align 1
@__UNIQUE_ID_alias107 = internal constant [32 x i8] c"alias=of:N*T*Crenesas,sh_fsi2C*\00", section ".modinfo", align 1
@__UNIQUE_ID_alias108 = internal constant [22 x i8] c"alias=platform:sh_fsi\00", section ".modinfo", align 1
@llvm.compiler.used = appending global [11 x ptr] [ptr @__UNIQUE_ID_alias104, ptr @__UNIQUE_ID_alias105, ptr @__UNIQUE_ID_alias106, ptr @__UNIQUE_ID_alias107, ptr @__UNIQUE_ID_alias108, ptr @__UNIQUE_ID_depends103, ptr @__UNIQUE_ID_intree102, ptr @__UNIQUE_ID_name101, ptr @__UNIQUE_ID_vermagic100, ptr @_note_8, ptr @_note_9], section "llvm.metadata"
