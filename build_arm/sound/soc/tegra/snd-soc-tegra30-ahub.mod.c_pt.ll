; ModuleID = '/llk/IR/build_arm/sound/soc/tegra/snd-soc-tegra30-ahub.mod.c_pt.bc'
source_filename = "sound/soc/tegra/snd-soc-tegra30-ahub.mod.c"
...
@__UNIQUE_ID_alias104 = internal constant [35 x i8] c"alias=of:N*T*Cnvidia,tegra124-ahub\00", section ".modinfo", align 1
@__UNIQUE_ID_alias105 = internal constant [37 x i8] c"alias=of:N*T*Cnvidia,tegra124-ahubC*\00", section ".modinfo", align 1
@__UNIQUE_ID_alias106 = internal constant [35 x i8] c"alias=of:N*T*Cnvidia,tegra114-ahub\00", section ".modinfo", align 1
@__UNIQUE_ID_alias107 = internal constant [37 x i8] c"alias=of:N*T*Cnvidia,tegra114-ahubC*\00", section ".modinfo", align 1
@__UNIQUE_ID_alias108 = internal constant [34 x i8] c"alias=of:N*T*Cnvidia,tegra30-ahub\00", section ".modinfo", align 1
@__UNIQUE_ID_alias109 = internal constant [36 x i8] c"alias=of:N*T*Cnvidia,tegra30-ahubC*\00", section ".modinfo", align 1
