; ModuleID = '/llk/IR/build_arm/sound/soc/atmel/snd-soc-atmel-i2s.mod.c_pt.bc'
source_filename = "sound/soc/atmel/snd-soc-atmel-i2s.mod.c"
...
@__UNIQUE_ID_alias104 = internal constant [32 x i8] c"alias=of:N*T*Catmel,sama5d2-i2s\00", section ".modinfo", align 1
@__UNIQUE_ID_alias105 = internal constant [34 x i8] c"alias=of:N*T*Catmel,sama5d2-i2sC*\00", section ".modinfo", align 1
