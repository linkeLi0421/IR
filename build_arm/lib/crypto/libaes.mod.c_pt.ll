; ModuleID = '/llk/IR/build_arm/lib/crypto/libaes.mod.c_pt.bc'
source_filename = "lib/crypto/libaes.mod.c"
...
@__UNIQUE_ID_name101 = internal constant [12 x i8] c"name=libaes\00", section ".modinfo", align 1
