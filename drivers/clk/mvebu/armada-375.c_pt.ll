; ModuleID = '/llk/IR/drivers/clk/mvebu/armada-375.c_pt.bc'
...
@armada_375_coreclks = internal constant %struct.coreclk_soc_desc { ptr @armada_375_get_tclk_freq, ptr @armada_375_get_cpu_freq, ptr @armada_375_get_clk_ratio, ptr null, ptr null, ptr null, ptr @armada_375_coreclk_ratios, i32 2 }, align 4
@armada_375_coreclk_ratios = internal constant [2 x %struct.coreclk_ratio] [%struct.coreclk_ratio { i32 1, ptr @.str.1 }, %struct.coreclk_ratio { i32 0, ptr @.str.2 }], section ".init.rodata", align 4
...
@armada_375_gating_desc = internal constant [24 x %struct.clk_gating_soc_desc] [%struct.clk_gating_soc_desc { ptr @.str.3, ptr null, i32 2, i32 0 }, %struct.clk_gating_soc_desc { ptr @.str.4, ptr null, i32 3, i32 0 }, %struct.clk_gating_soc_desc { ptr @.str.5, ptr null, i32 4, i32 0 }, %struct.clk_gating_soc_desc { ptr @.str.6, ptr null, i32 5, i32 0 }, %struct.clk_gating_soc_desc { ptr @.str.7, ptr null, i32 6, i32 0 }, %struct.clk_gating_soc_desc { ptr @.str.8, ptr null, i32 8, i32 0 }, %struct.clk_gating_soc_desc { ptr @.str.9, ptr @.str.10, i32 11, i32 0 }, %struct.clk_gating_soc_desc { ptr @.str.11, ptr @.str.12, i32 14, i32 0 }, %struct.clk_gating_soc_desc { ptr @.str.12, ptr null, i32 15, i32 0 }, %struct.clk_gating_soc_desc { ptr @.str.13, ptr null, i32 16, i32 0 }, %struct.clk_gating_soc_desc { ptr @.str.14, ptr null, i32 17, i32 0 }, %struct.clk_gating_soc_desc { ptr @.str.15, ptr null, i32 18, i32 0 }, %struct.clk_gating_soc_desc { ptr @.str.16, ptr null, i32 19, i32 0 }, %struct.clk_gating_soc_desc { ptr @.str.17, ptr @.str.18, i32 20, i32 0 }, %struct.clk_gating_soc_desc { ptr @.str.18, ptr null, i32 21, i32 0 }, %struct.clk_gating_soc_desc { ptr @.str.19, ptr null, i32 22, i32 0 }, %struct.clk_gating_soc_desc { ptr @.str.20, ptr null, i32 23, i32 0 }, %struct.clk_gating_soc_desc { ptr @.str.21, ptr null, i32 24, i32 0 }, %struct.clk_gating_soc_desc { ptr @.str.22, ptr null, i32 25, i32 0 }, %struct.clk_gating_soc_desc { ptr @.str.23, ptr null, i32 28, i32 0 }, %struct.clk_gating_soc_desc { ptr @.str.24, ptr null, i32 29, i32 0 }, %struct.clk_gating_soc_desc { ptr @.str.25, ptr null, i32 30, i32 0 }, %struct.clk_gating_soc_desc { ptr @.str.26, ptr null, i32 31, i32 0 }, %struct.clk_gating_soc_desc zeroinitializer], section ".init.rodata", align 4
@.str.3 = private unnamed_addr constant [3 x i8] c"mu\00", align 1
@.str.4 = private unnamed_addr constant [3 x i8] c"pp\00", align 1
@.str.5 = private unnamed_addr constant [4 x i8] c"ptp\00", align 1
@.str.6 = private unnamed_addr constant [5 x i8] c"pex0\00", align 1
...
@.str.9 = private unnamed_addr constant [7 x i8] c"nd_clk\00", align 1
@.str.10 = private unnamed_addr constant [5 x i8] c"nand\00", align 1
@.str.11 = private unnamed_addr constant [11 x i8] c"sata0_link\00", align 1
@.str.12 = private unnamed_addr constant [11 x i8] c"sata0_core\00", align 1
@.str.13 = private unnamed_addr constant [5 x i8] c"usb3\00", align 1
@.str.14 = private unnamed_addr constant [5 x i8] c"sdio\00", align 1
@.str.15 = private unnamed_addr constant [4 x i8] c"usb\00", align 1
@.str.16 = private unnamed_addr constant [4 x i8] c"gop\00", align 1
@.str.17 = private unnamed_addr constant [11 x i8] c"sata1_link\00", align 1
@.str.18 = private unnamed_addr constant [11 x i8] c"sata1_core\00", align 1
@.str.19 = private unnamed_addr constant [5 x i8] c"xor0\00", align 1
@.str.20 = private unnamed_addr constant [5 x i8] c"xor1\00", align 1
@.str.21 = private unnamed_addr constant [6 x i8] c"copro\00", align 1
@.str.22 = private unnamed_addr constant [4 x i8] c"tdm\00", align 1
@.str.23 = private unnamed_addr constant [12 x i8] c"crypto0_enc\00", align 1
@.str.24 = private unnamed_addr constant [13 x i8] c"crypto0_core\00", align 1
@.str.25 = private unnamed_addr constant [12 x i8] c"crypto1_enc\00", align 1
@.str.26 = private unnamed_addr constant [13 x i8] c"crypto1_core\00", align 1
@llvm.compiler.used = appending global [2 x ptr] [ptr @__of_table_armada_375_clk_gating, ptr @__of_table_armada_375_core_clk], section "llvm.metadata"

; Function Attrs: cold nounwind null_pointer_is_valid optsize sspstrong uwtable(sync)
define internal void @armada_375_coreclk_init(ptr noundef %0) #0 section ".init.text" {
  tail call void @mvebu_coreclk_setup(ptr noundef %0, ptr noundef nonnull @armada_375_coreclks) #2
  ret void
}

; Function Attrs: cold nounwind null_pointer_is_valid optsize sspstrong uwtable(sync)
define internal void @armada_375_clk_gating_init(ptr noundef %0) #0 section ".init.text" {
  tail call void @mvebu_clk_gating_setup(ptr noundef %0, ptr noundef nonnull @armada_375_gating_desc) #2
  ret void
}
...
; Function Attrs: cold nounwind null_pointer_is_valid optsize sspstrong uwtable(sync)
define internal i32 @armada_375_get_tclk_freq(ptr noundef %0) #0 section ".init.text" {
  ...
  %3 = lshr i32 %2, 22
  %4 = and i32 %3, 1
  %5 = getelementptr [2 x i32], ptr @armada_375_tclk_frequencies, i32 0, i32 %4
  %6 = load i32, ptr %5, align 4
  ret i32 %6
}

; Function Attrs: cold nounwind null_pointer_is_valid optsize sspstrong uwtable(sync)
define internal i32 @armada_375_get_cpu_freq(ptr noundef %0) #0 section ".init.text" {
  %2 = tail call i32 asm sideeffect "ldr $0, $1", "=r,*Qo"(ptr elementtype(i32) %0) #3, !srcloc !8
...
8:                                                ; preds = %1
  %9 = getelementptr [26 x i32], ptr @armada_375_cpu_frequencies, i32 0, i32 %4
...
; Function Attrs: cold nounwind null_pointer_is_valid optsize sspstrong uwtable(sync)
define internal void @armada_375_get_clk_ratio(ptr noundef %0, i32 noundef %1, ptr nocapture noundef writeonly %2, ptr nocapture noundef writeonly %3) #0 section ".init.text" {
...
9:                                                ; preds = %8, %4
  %10 = phi ptr [ @armada_375_cpu_ddr_ratios, %8 ], [ @armada_375_cpu_l2_ratios, %4 ]
