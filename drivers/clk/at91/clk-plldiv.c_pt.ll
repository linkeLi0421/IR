; ModuleID = '/llk/IR/drivers/clk/at91/clk-plldiv.c_pt.bc'
...
@plldiv_ops = internal constant %struct.clk_ops { ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr @clk_plldiv_recalc_rate, ptr @clk_plldiv_round_rate, ptr null, ptr null, ptr null, ptr @clk_plldiv_set_rate, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null }, align 4
@kmalloc_caches = external dso_local local_unnamed_addr global [3 x [14 x ptr]], align 4

; Function Attrs: cold nounwind null_pointer_is_valid optsize sspstrong uwtable(sync)
define dso_local ptr @at91_clk_register_plldiv(ptr noundef %0, ptr noundef %1, ptr noundef %2) local_unnamed_addr #0 section ".init.text" {
...
10:                                               ; preds = %3
  ...
  store ptr @plldiv_ops, ptr %11, align 4
  ...
  %20 = getelementptr inbounds %struct.clk_plldiv, ptr %8, i32 0, i32 1
  store ptr %0, ptr %20, align 4
  %21 = call i32 @clk_hw_register(ptr noundef null, ptr noundef nonnull %8) #7
  %22 = icmp eq i32 %21, 0
...
define internal i32 @clk_plldiv_recalc_rate(ptr nocapture noundef readonly %0, i32 noundef %1) #5 {
  %3 = alloca i32, align 4
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %3) #7
  store i32 0, ptr %3, align 4, !annotation !8
  %4 = getelementptr inbounds %struct.clk_plldiv, ptr %0, i32 0, i32 1
  %5 = load ptr, ptr %4, align 4
  %6 = call i32 @regmap_read(ptr noundef %5, i32 noundef 48, ptr noundef nonnull %3) #7
...
define internal i32 @clk_plldiv_round_rate(ptr nocapture noundef readnone %0, i32 noundef %1, ptr nocapture noundef readonly %2) #6 {
...
; Function Attrs: nounwind null_pointer_is_valid sspstrong uwtable(sync)
define internal i32 @clk_plldiv_set_rate(ptr nocapture noundef readonly %0, i32 noundef %1, i32 noundef %2) #5 {
  %4 = icmp eq i32 %2, %1
...
8:                                                ; preds = %5, %3
  %9 = phi i32 [ 4096, %5 ], [ 0, %3 ]
  %10 = getelementptr inbounds %struct.clk_plldiv, ptr %0, i32 0, i32 1
  %11 = load ptr, ptr %10, align 4
  %12 = tail call i32 @regmap_update_bits_base(ptr noundef %11, i32 noundef 48, i32 noundef 4096, i32 noundef %9, ptr noundef null, i1 noundef zeroext false, i1 noundef zeroext false) #7
  br label %13
