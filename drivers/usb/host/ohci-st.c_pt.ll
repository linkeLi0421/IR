; ModuleID = '/llk/IR/drivers/usb/host/ohci-st.c_pt.bc'
...
@__initcall__kmod_ohci_st__254_332_ohci_platform_init6 = internal global ptr @ohci_platform_init, section ".initcall6.init", align 4
@ohci_platform_driver = internal global %struct.platform_driver { ptr @st_ohci_platform_probe, ptr @st_ohci_platform_remove, ptr @usb_hcd_platform_shutdown, ptr null, ptr null, %struct.device_driver { ptr @.str.2, ptr null, ptr null, ptr null, i8 0, i32 0, ptr @st_ohci_platform_ids, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr @st_ohci_pm_ops, ptr null, ptr null }, ptr null, i8 0 }, align 4
@__exitcall_ohci_platform_cleanup = internal global ptr @ohci_platform_cleanup, section ".exitcall.exit", align 4
@__UNIQUE_ID_description255 = internal constant [51 x i8] c"ohci_st.description=OHCI STMicroelectronics driver\00", section ".modinfo", align 1
@__UNIQUE_ID_author256 = internal constant [56 x i8] c"ohci_st.author=Peter Griffin <peter.griffin@linaro.org>\00", section ".modinfo", align 1
@__UNIQUE_ID_file257 = internal constant [38 x i8] c"ohci_st.file=drivers/usb/host/ohci-st\00", section ".modinfo", align 1
@__UNIQUE_ID_license258 = internal constant [20 x i8] c"ohci_st.license=GPL\00", section ".modinfo", align 1
@.str = private unnamed_addr constant [38 x i8] c"\016%s: OHCI STMicroelectronics driver\0A\00", align 1
@hcd_name = internal constant [8 x i8] c"ohci-st\00", align 1
@ohci_platform_hc_driver = internal global %struct.hc_driver zeroinitializer, section ".data..read_mostly", align 4
@platform_overrides = internal constant %struct.ohci_driver_overrides { ptr @.str.1, i32 28, ptr null }, section ".init.rodata", align 4
@.str.1 = private unnamed_addr constant [19 x i8] c"ST OHCI controller\00", align 1
@.str.2 = private unnamed_addr constant [8 x i8] c"st-ohci\00", align 1
@st_ohci_platform_ids = internal constant [2 x %struct.of_device_id] [%struct.of_device_id { [32 x i8] zeroinitializer, [32 x i8] zeroinitializer, [128 x i8] c"st,st-ohci-300x\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00", ptr null }, %struct.of_device_id zeroinitializer], align 4
@st_ohci_pm_ops = internal constant %struct.dev_pm_ops { ptr null, ptr null, ptr @st_ohci_suspend, ptr @st_ohci_resume, ptr @st_ohci_suspend, ptr @st_ohci_resume, ptr @st_ohci_suspend, ptr @st_ohci_resume, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null }, align 4
@ohci_platform_defaults = internal global %struct.usb_ohci_pdata { i8 0, i32 0, ptr @st_ohci_platform_power_on, ptr @st_ohci_platform_power_off, ptr @st_ohci_platform_power_off }, align 4
@.str.3 = private unnamed_addr constant [28 x i8] c"no memory resource provided\00", align 1
@.str.4 = private unnamed_addr constant [4 x i8] c"usb\00", align 1
@.str.5 = private unnamed_addr constant [6 x i8] c"clk48\00", align 1
@.str.6 = private unnamed_addr constant [21 x i8] c"48MHz clk not found\0A\00", align 1
@.str.7 = private unnamed_addr constant [6 x i8] c"power\00", align 1
@.str.8 = private unnamed_addr constant [10 x i8] c"softreset\00", align 1
@llvm.compiler.used = appending global [7 x ptr] [ptr @__UNIQUE_ID_author256, ptr @__UNIQUE_ID_description255, ptr @__UNIQUE_ID_file257, ptr @__UNIQUE_ID_license258, ptr @__exitcall_ohci_platform_cleanup, ptr @__initcall__kmod_ohci_st__254_332_ohci_platform_init6, ptr @ohci_platform_cleanup], section "llvm.metadata"
...
define internal i32 @st_ohci_platform_probe(ptr noundef %0) #3 {
...
18:                                               ; preds = %16, %12
  ...
  %20 = tail call ptr @usb_create_hcd(ptr noundef nonnull @ohci_platform_hc_driver, ptr noundef %10, ptr noundef %19) #4
...
22:                                               ; preds = %18
  ...
  store ptr @ohci_platform_defaults, ptr %24, align 4
  %25 = getelementptr inbounds %struct.usb_hcd, ptr %20, i32 2, i32 22
  %26 = tail call ptr @devm_phy_get(ptr noundef %10, ptr noundef nonnull @.str.4) #4
  %27 = getelementptr inbounds %struct.usb_hcd, ptr %20, i32 2, i32 26, i32 2
...
42:                                               ; preds = %29
  ...
  %45 = getelementptr %struct.usb_hcd, ptr %20, i32 2, i32 23
...
47:                                               ; preds = %42
  ...
  %50 = getelementptr %struct.usb_hcd, ptr %20, i32 2, i32 24
...
52:                                               ; preds = %47, %40
  ...
  %54 = tail call ptr @devm_clk_get(ptr noundef %10, ptr noundef nonnull @.str.5) #4
  %55 = getelementptr inbounds %struct.usb_hcd, ptr %20, i32 2, i32 25
...
58:                                               ; preds = %57, %52
  %59 = tail call ptr @__devm_reset_control_get(ptr noundef %10, ptr noundef nonnull @.str.7, i32 noundef 0, i1 noundef zeroext true, i1 noundef zeroext true, i1 noundef zeroext false) #4
  %60 = getelementptr inbounds %struct.usb_hcd, ptr %20, i32 2, i32 26, i32 1
...
64:                                               ; preds = %58
  %65 = tail call ptr @__devm_reset_control_get(ptr noundef %10, ptr noundef nonnull @.str.8, i32 noundef 0, i1 noundef zeroext true, i1 noundef zeroext true, i1 noundef zeroext false) #4
  %66 = getelementptr inbounds %struct.usb_hcd, ptr %20, i32 2, i32 26
...
70:                                               ; preds = %64
  %71 = load ptr, ptr getelementptr inbounds (%struct.usb_ohci_pdata, ptr @ohci_platform_defaults, i32 0, i32 2), align 4
  %72 = icmp eq ptr %71, null
  br i1 %72, label %76, label %73

73:                                               ; preds = %70
  %74 = tail call i32 %71(ptr noundef %0) #4
  %75 = icmp slt i32 %74, 0
  br i1 %75, label %96, label %76

76:                                               ; preds = %73, %70
  %77 = load i32, ptr %8, align 4
  %78 = getelementptr inbounds %struct.usb_hcd, ptr %20, i32 0, i32 17
  store i32 %77, ptr %78, align 4
  %79 = getelementptr inbounds %struct.resource, ptr %8, i32 0, i32 1
  %80 = load i32, ptr %79, align 4
  %81 = load i32, ptr %8, align 4
  %82 = add i32 %80, 1
  %83 = sub i32 %82, %81
  %84 = getelementptr inbounds %struct.usb_hcd, ptr %20, i32 0, i32 18
  store i32 %83, ptr %84, align 8
  %85 = tail call ptr @devm_ioremap_resource(ptr noundef %10, ptr noundef nonnull %8) #4
  %86 = getelementptr inbounds %struct.usb_hcd, ptr %20, i32 0, i32 16
...
90:                                               ; preds = %76
  %91 = tail call i32 @usb_add_hcd(ptr noundef nonnull %20, i32 noundef %5, i32 noundef 128) #4
  %92 = icmp eq i32 %91, 0
  br i1 %92, label %93, label %96

93:                                               ; preds = %90
  %94 = load ptr, ptr %20, align 8
  %95 = tail call i32 @device_wakeup_enable(ptr noundef %94) #4
  store ptr %20, ptr %23, align 8
  br label %121

96:                                               ; preds = %90, %88, %73
  %97 = phi i32 [ %74, %73 ], [ %89, %88 ], [ %91, %90 ]
  %98 = load ptr, ptr getelementptr inbounds (%struct.usb_ohci_pdata, ptr @ohci_platform_defaults, i32 0, i32 3), align 4
  %99 = icmp eq ptr %98, null
  br i1 %99, label %101, label %100

100:                                              ; preds = %96
  tail call void %98(ptr noundef %0) #4
  br label %101

101:                                              ; preds = %100, %96, %68, %62, %36
  %102 = phi i32 [ %37, %36 ], [ %53, %62 ], [ %53, %68 ], [ %53, %100 ], [ %53, %96 ]
  %103 = phi i32 [ -517, %36 ], [ %63, %62 ], [ %69, %68 ], [ %97, %100 ], [ %97, %96 ]
  %104 = icmp sgt i32 %102, 0
  br i1 %104, label %105, label %119

105:                                              ; preds = %101
  %106 = add nsw i32 %102, -1
  %107 = getelementptr [3 x ptr], ptr %25, i32 0, i32 %106
  %108 = load ptr, ptr %107, align 4
  tail call void @clk_put(ptr noundef %108) #4
  %109 = icmp eq i32 %106, 0
  br i1 %109, label %119, label %110

110:                                              ; preds = %105
  %111 = add nsw i32 %102, -2
  %112 = getelementptr [3 x ptr], ptr %25, i32 0, i32 %111
  %113 = load ptr, ptr %112, align 4
  tail call void @clk_put(ptr noundef %113) #4
  %114 = icmp eq i32 %111, 0
  br i1 %114, label %119, label %115

115:                                              ; preds = %110
  %116 = add nsw i32 %102, -3
  %117 = getelementptr [3 x ptr], ptr %25, i32 0, i32 %116
  %118 = load ptr, ptr %117, align 4
  tail call void @clk_put(ptr noundef %118) #4
  br label %119

119:                                              ; preds = %115, %110, %105, %101, %34
  %120 = phi i32 [ %35, %34 ], [ %103, %101 ], [ %103, %115 ], [ %103, %110 ], [ %103, %105 ]
  store ptr null, ptr %24, align 4
  tail call void @usb_put_hcd(ptr noundef nonnull %20) #4
  br label %121

121:                                              ; preds = %119, %93, %18, %11, %4, %1
  %122 = phi i32 [ %120, %119 ], [ 0, %93 ], [ -6, %11 ], [ -19, %1 ], [ %5, %4 ], [ -12, %18 ]
  ret i32 %122
}

; Function Attrs: nounwind null_pointer_is_valid sspstrong uwtable(sync)
define internal i32 @st_ohci_platform_remove(ptr noundef %0) #3 {
  %2 = getelementptr inbounds %struct.platform_device, ptr %0, i32 0, i32 3, i32 8
  %3 = load ptr, ptr %2, align 8
  %4 = getelementptr inbounds %struct.platform_device, ptr %0, i32 0, i32 3, i32 7
  %5 = load ptr, ptr %4, align 4
  %6 = getelementptr inbounds %struct.usb_hcd, ptr %3, i32 2, i32 22
  tail call void @usb_remove_hcd(ptr noundef %3) #4
  %7 = getelementptr inbounds %struct.usb_ohci_pdata, ptr %5, i32 0, i32 3
...
14:                                               ; preds = %11
  ...
  %15 = getelementptr %struct.usb_hcd, ptr %3, i32 2, i32 23
...
18:                                               ; preds = %14
  ...
  %19 = getelementptr %struct.usb_hcd, ptr %3, i32 2, i32 24
...
23:                                               ; preds = %22, %18, %14, %11
  ...
  %24 = icmp eq ptr %5, @ohci_platform_defaults
...
; Function Attrs: nounwind null_pointer_is_valid sspstrong uwtable(sync)
define internal i32 @st_ohci_platform_power_on(ptr nocapture noundef readonly %0) #3 {
  %2 = getelementptr inbounds %struct.platform_device, ptr %0, i32 0, i32 3, i32 8
  %3 = load ptr, ptr %2, align 8
  %4 = getelementptr inbounds %struct.usb_hcd, ptr %3, i32 2, i32 22
  %5 = getelementptr inbounds %struct.usb_hcd, ptr %3, i32 2, i32 26, i32 1
...
9:                                                ; preds = %1
  %10 = getelementptr inbounds %struct.usb_hcd, ptr %3, i32 2, i32 26
...
14:                                               ; preds = %9
  %15 = getelementptr inbounds %struct.usb_hcd, ptr %3, i32 2, i32 25
  %16 = load ptr, ptr %15, align 4
  %17 = icmp eq ptr %16, null
...
34:                                               ; preds = %27
  %35 = getelementptr %struct.usb_hcd, ptr %3, i32 2, i32 23
...
44:                                               ; preds = %41
  %45 = getelementptr %struct.usb_hcd, ptr %3, i32 2, i32 24
...
54:                                               ; preds = %51, %44, %34, %21
  ...
  %56 = getelementptr inbounds %struct.usb_hcd, ptr %3, i32 2, i32 26, i32 2
...
; Function Attrs: nounwind null_pointer_is_valid sspstrong uwtable(sync)
define internal void @st_ohci_platform_power_off(ptr nocapture noundef readonly %0) #3 {
  %2 = getelementptr inbounds %struct.platform_device, ptr %0, i32 0, i32 3, i32 8
  %3 = load ptr, ptr %2, align 8
  %4 = getelementptr inbounds %struct.usb_hcd, ptr %3, i32 2, i32 22
  %5 = getelementptr inbounds %struct.usb_hcd, ptr %3, i32 2, i32 26, i32 1
  ...
  %8 = getelementptr inbounds %struct.usb_hcd, ptr %3, i32 2, i32 26
  %9 = load ptr, ptr %8, align 4
  %10 = tail call i32 @reset_control_assert(ptr noundef %9) #4
  %11 = getelementptr inbounds %struct.usb_hcd, ptr %3, i32 2, i32 26, i32 2
  %12 = load ptr, ptr %11, align 4
  %13 = tail call i32 @phy_power_off(ptr noundef %12) #4
  %14 = load ptr, ptr %11, align 4
  %15 = tail call i32 @phy_exit(ptr noundef %14) #4
  %16 = getelementptr %struct.usb_hcd, ptr %3, i32 2, i32 24
...
20:                                               ; preds = %19, %1
  %21 = getelementptr %struct.usb_hcd, ptr %3, i32 2, i32 23
...
; Function Attrs: nounwind null_pointer_is_valid sspstrong uwtable(sync)
define internal i32 @st_ohci_suspend(ptr noundef %0) #3 {
...
; Function Attrs: nounwind null_pointer_is_valid sspstrong uwtable(sync)
define internal i32 @st_ohci_resume(ptr noundef %0) #3 {
  %2 = getelementptr inbounds %struct.device, ptr %0, i32 0, i32 8
  %3 = load ptr, ptr %2, align 8
  %4 = getelementptr inbounds %struct.device, ptr %0, i32 0, i32 7
  %5 = load ptr, ptr %4, align 4
