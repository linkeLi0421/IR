; ModuleID = '/llk/IR/drivers/usb/renesas_usbhs/rza2.c_pt.bc'
source_filename = "../drivers/usb/renesas_usbhs/rza2.c"
...
@usbhs_rza2_plat_info = dso_local local_unnamed_addr constant %struct.renesas_usbhs_platform_info { %struct.renesas_usbhs_platform_callback { ptr @usbhs_rza2_hardware_init, ptr @usbhs_rza2_hardware_exit, ptr @usbhs_rza2_power_ctrl, ptr null, ptr @usbhs_get_id_as_gadget, ptr null, ptr null, ptr null }, %struct.renesas_usbhs_driver_param { ptr null, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i8 44 } }, align 4
@.str = private unnamed_addr constant [4 x i8] c"usb\00", align 1
@arm_delay_ops = external dso_local local_unnamed_addr global %struct.arm_delay_ops, align 4

; Function Attrs: nounwind null_pointer_is_valid sspstrong uwtable(sync)
define internal i32 @usbhs_rza2_hardware_init(ptr noundef %0) #0 {
...
; Function Attrs: nounwind null_pointer_is_valid sspstrong uwtable(sync)
define internal i32 @usbhs_rza2_hardware_exit(ptr noundef %0) #0 {
  %2 = tail call ptr @usbhs_pdev_to_priv(ptr noundef %0) #2
  %3 = getelementptr inbounds %struct.platform_device, ptr %0, i32 0, i32 3
  %4 = getelementptr inbounds %struct.usbhs_priv, ptr %2, i32 0, i32 11
  %5 = load ptr, ptr %4, align 4
  tail call void @phy_put(ptr noundef %3, ptr noundef %5) #2
  store ptr null, ptr %4, align 4
  ret i32 0
}

; Function Attrs: nounwind null_pointer_is_valid sspstrong uwtable(sync)
define internal i32 @usbhs_rza2_power_ctrl(ptr noundef %0, ptr nocapture noundef readnone %1, i32 noundef %2) #0 {
...
10:                                               ; preds = %8
  ...
  tail call void %12(i32 noundef 21474800) #2
  %13 = icmp eq i32 %11, 0
  br i1 %13, label %14, label %22

14:                                               ; preds = %10
  %15 = load ptr, ptr %5, align 4
  %16 = tail call i32 @phy_power_on(ptr noundef %15) #2
  br label %22

17:                                               ; preds = %8
  tail call void @usbhs_bset(ptr noundef %4, i32 noundef 258, i16 noundef zeroext 16384, i16 noundef zeroext 0) #2
  %18 = load ptr, ptr %5, align 4
  %19 = tail call i32 @phy_power_off(ptr noundef %18) #2
  %20 = load ptr, ptr %5, align 4
  %21 = tail call i32 @phy_exit(ptr noundef %20) #2
  br label %22

22:                                               ; preds = %17, %14, %10, %3
  %23 = phi i32 [ -19, %3 ], [ %11, %10 ], [ %16, %14 ], [ 0, %17 ]
  ret i32 %23
}
