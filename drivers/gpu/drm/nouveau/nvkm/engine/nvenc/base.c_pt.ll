; ModuleID = '/llk/IR/drivers/gpu/drm/nouveau/nvkm/engine/nvenc/base.c_pt.bc'
...
@nvkm_nvenc = internal constant %struct.nvkm_engine_func { ptr @nvkm_nvenc_dtor, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, %struct.anon.124 zeroinitializer, %struct.anon.125 zeroinitializer, ptr null, [0 x %struct.nvkm_sclass] zeroinitializer }, align 4
@.str = private unnamed_addr constant [6 x i8] c"Nvenc\00", align 1
...
define dso_local i32 @nvkm_nvenc_new_(ptr noundef %0, ptr noundef %1, i32 noundef %2, i32 noundef %3, ptr nocapture noundef writeonly %4) local_unnamed_addr #0 {
...
10:                                               ; preds = %5
  %11 = getelementptr inbounds %struct.nvkm_nvenc, ptr %8, i32 0, i32 1
  %12 = tail call i32 @nvkm_engine_ctor(ptr noundef nonnull @nvkm_nvenc, ptr noundef %1, i32 noundef %2, i32 noundef %3, i1 noundef zeroext true, ptr noundef %11) #7
  %13 = icmp eq i32 %12, 0
  br i1 %13, label %14, label %80

14:                                               ; preds = %10
  %15 = getelementptr inbounds %struct.nvkm_nvenc, ptr %8, i32 0, i32 1, i32 1
  ...
  %17 = getelementptr inbounds %struct.nvkm_nvenc, ptr %8, i32 0, i32 1, i32 1, i32 1
...
25:                                               ; preds = %30, %14
  ...
  %27 = getelementptr inbounds %struct.nvkm_nvenc_fwif, ptr %26, i32 0, i32 1
...
30:                                               ; preds = %25
  ...
  %33 = getelementptr %struct.nvkm_nvenc_fwif, ptr %26, i32 1
...
39:                                               ; preds = %36, %23
  ...
  %47 = getelementptr inbounds %struct.nvkm_nvenc_fwif, ptr %41, i32 0, i32 1
...
59:                                               ; preds = %55
  %60 = getelementptr %struct.nvkm_nvenc_fwif, ptr %54, i32 1
  %61 = getelementptr %struct.nvkm_nvenc_fwif, ptr %54, i32 1, i32 1
...
73:                                               ; preds = %70
  %74 = getelementptr inbounds %struct.nvkm_nvenc_fwif, ptr %71, i32 0, i32 2
  %75 = load ptr, ptr %74, align 4
  store ptr %75, ptr %8, align 8
  %76 = load ptr, ptr %75, align 4
  %77 = getelementptr inbounds %struct.nvkm_nvenc, ptr %8, i32 0, i32 1, i32 1, i32 4
  %78 = getelementptr inbounds %struct.nvkm_nvenc, ptr %8, i32 0, i32 2
...
; Function Attrs: nounwind null_pointer_is_valid sspstrong uwtable(sync)
define internal ptr @nvkm_nvenc_dtor(ptr noundef %0) #0 {
