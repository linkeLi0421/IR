; ModuleID = '/llk/IR/drivers/gpu/drm/nouveau/nvkm/engine/nvenc/gm107.c_pt.bc'
...
@gm107_nvenc_fwif = internal constant [2 x %struct.nvkm_nvenc_fwif] [%struct.nvkm_nvenc_fwif { i32 -1, ptr @gm107_nvenc_nofw, ptr @gm107_nvenc }, %struct.nvkm_nvenc_fwif zeroinitializer], align 4
@gm107_nvenc = internal constant %struct.nvkm_nvenc_func { ptr @gm107_nvenc_flcn }, align 4
@gm107_nvenc_flcn = internal constant %struct.nvkm_falcon_func { %struct.anon.123 zeroinitializer, %struct.anon.124 zeroinitializer, ptr null, ptr null, i32 0, i32 2048, ptr @nvkm_falcon_v1_load_imem, ptr @nvkm_falcon_v1_load_dmem, ptr @nvkm_falcon_v1_read_dmem, i32 0, ptr @nvkm_falcon_v1_bind_context, ptr @nvkm_falcon_v1_wait_for_halt, ptr @nvkm_falcon_v1_clear_interrupt, ptr @nvkm_falcon_v1_set_start_addr, ptr @nvkm_falcon_v1_start, ptr @nvkm_falcon_v1_enable, ptr @nvkm_falcon_v1_disable, ptr null, %struct.anon.127 zeroinitializer, %struct.anon.127 zeroinitializer, [0 x %struct.nvkm_sclass] zeroinitializer }, align 4

; Function Attrs: nounwind null_pointer_is_valid sspstrong uwtable(sync)
define dso_local i32 @gm107_nvenc_new(ptr noundef %0, i32 noundef %1, i32 noundef %2, ptr noundef %3) local_unnamed_addr #0 {
  %5 = tail call i32 @nvkm_nvenc_new_(ptr noundef nonnull @gm107_nvenc_fwif, ptr noundef %0, i32 noundef %1, i32 noundef %2, ptr noundef %3) #3
  ret i32 %5
}
...
define internal i32 @gm107_nvenc_nofw(ptr nocapture noundef readnone %0, i32 noundef %1, ptr nocapture noundef readnone %2) #2 {
  ret i32 0
}
