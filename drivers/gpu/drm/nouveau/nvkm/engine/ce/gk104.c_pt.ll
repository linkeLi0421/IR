; ModuleID = '/llk/IR/drivers/gpu/drm/nouveau/nvkm/engine/ce/gk104.c_pt.bc'
...
@.str.7 = private unnamed_addr constant [17 x i8] c"INVALID_ARGUMENT\00", align 1
...
@gk104_ce = internal constant { ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, %struct.anon, %struct.anon.121, ptr, [2 x %struct.nvkm_sclass] } { ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr @gk104_ce_intr, ptr null, ptr null, %struct.anon zeroinitializer, %struct.anon.121 zeroinitializer, ptr null, [2 x %struct.nvkm_sclass] [%struct.nvkm_sclass { i32 -1, i32 -1, i32 41141, ptr null, ptr null }, %struct.nvkm_sclass zeroinitializer] }, align 4

; Function Attrs: nounwind null_pointer_is_valid sspstrong uwtable(sync)
define dso_local void @gk104_ce_intr(ptr noundef %0) #0 {
...
53:                                               ; preds = %49
  ...
  %57 = add i32 %6, 1068820
  %58 = getelementptr i8, ptr %56, i32 %57
  %59 = tail call i32 asm sideeffect "ldr $0, $1", "=r,*Qo"(ptr elementtype(i32) %58) #3, !srcloc !8
  tail call void asm sideeffect "dsb ", "~{memory}"() #3, !srcloc !9
  %60 = and i32 %59, 15
  %61 = tail call ptr @nvkm_enum_find(ptr noundef nonnull @gk104_ce_launcherr_report, i32 noundef %60) #3
...
76:                                               ; preds = %74, %53
  ...
  %78 = getelementptr i8, ptr %77, i32 %57
  tail call void asm sideeffect "dsb st", "~{memory}"() #3, !srcloc !10
  tail call void @arm_heavy_mb() #3
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %78, i32 0) #3, !srcloc !11
  %79 = load ptr, ptr %7, align 4
  %80 = getelementptr i8, ptr %79, i32 %13
  tail call void asm sideeffect "dsb st", "~{memory}"() #3, !srcloc !10
  tail call void @arm_heavy_mb() #3
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %80, i32 4) #3, !srcloc !11
  %81 = and i32 %50, -5
  br label %82

82:                                               ; preds = %76, %49
  %83 = phi i32 [ %81, %76 ], [ %50, %49 ]
  %84 = icmp eq i32 %83, 0
  br i1 %84, label %97, label %85

85:                                               ; preds = %82
  %86 = getelementptr inbounds %struct.nvkm_engine, ptr %0, i32 0, i32 1, i32 5
...
89:                                               ; preds = %85
  ...
  %93 = getelementptr inbounds %struct.nvkm_engine, ptr %0, i32 0, i32 1, i32 4
  tail call void (ptr, ptr, ...) @_dev_notice(ptr noundef %92, ptr noundef nonnull @.str.2, ptr noundef %93, i32 noundef %83) #4
  br label %94

94:                                               ; preds = %89, %85
  %95 = load ptr, ptr %7, align 4
  %96 = getelementptr i8, ptr %95, i32 %13
  tail call void asm sideeffect "dsb st", "~{memory}"() #3, !srcloc !10
  tail call void @arm_heavy_mb() #3
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %96, i32 %83) #3, !srcloc !11
  br label %97
...
; Function Attrs: nounwind null_pointer_is_valid sspstrong uwtable(sync)
define dso_local i32 @gk104_ce_new(ptr noundef %0, i32 noundef %1, i32 noundef %2, ptr noundef %3) local_unnamed_addr #0 {
  %5 = tail call i32 @nvkm_engine_new_(ptr noundef nonnull @gk104_ce, ptr noundef %0, i32 noundef %1, i32 noundef %2, i1 noundef zeroext true, ptr noundef %3) #3
  ret i32 %5
}
