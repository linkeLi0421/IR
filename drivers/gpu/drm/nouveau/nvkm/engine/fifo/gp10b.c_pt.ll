; ModuleID = '/llk/IR/drivers/gpu/drm/nouveau/nvkm/engine/fifo/gp10b.c_pt.bc'
source_filename = "../drivers/gpu/drm/nouveau/nvkm/engine/fifo/gp10b.c"
...
@gp100_fifo_fault_engine = external dso_local constant [0 x %struct.nvkm_enum], align 4
...
define dso_local i32 @gp10b_fifo_new(ptr noundef %0, i32 noundef %1, i32 noundef %2, ptr noundef %3) local_unnamed_addr #0 {
  %5 = tail call i32 @gk104_fifo_new_(ptr noundef nonnull @gp10b_fifo, ptr noundef %0, i32 noundef %1, i32 noundef %2, i32 noundef 512, ptr noundef %3) #2
  ret i32 %5
}
...
; Function Attrs: null_pointer_is_valid
declare dso_local void @gp100_fifo_intr_fault(ptr noundef, i32 noundef) #1
