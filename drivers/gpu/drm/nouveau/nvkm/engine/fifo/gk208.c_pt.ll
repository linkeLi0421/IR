; ModuleID = '/llk/IR/drivers/gpu/drm/nouveau/nvkm/engine/fifo/gk208.c_pt.bc'
...
@gk208_fifo_pbdma = dso_local constant %struct.gk104_fifo_pbdma_func { ptr @gk104_fifo_pbdma_nr, ptr @gk104_fifo_pbdma_init, ptr @gk208_fifo_pbdma_init_timeout }, align 4
@gk208_fifo = internal constant %struct.gk104_fifo_func { %struct.anon { ptr @gf100_fifo_intr_fault }, ptr @gk208_fifo_pbdma, %struct.anon.127 { ptr @gk104_fifo_fault_access, ptr @gk104_fifo_fault_engine, ptr @gk104_fifo_fault_reason, ptr @gk104_fifo_fault_hubclient, ptr @gk104_fifo_fault_gpcclient }, ptr @gk110_fifo_runlist, %struct.gk104_fifo_user_user zeroinitializer, %struct.gk104_fifo_chan_user { %struct.nvkm_sclass { i32 0, i32 0, i32 41071, ptr null, ptr null }, ptr @gk104_fifo_gpfifo_new }, i8 0 }, align 4
...
define dso_local void @gk208_fifo_pbdma_init_timeout(ptr nocapture noundef readonly %0) #0 {
  %2 = getelementptr inbounds %struct.gk104_fifo, ptr %0, i32 0, i32 3
...
9:                                                ; preds = %9, %5
  ...
  %12 = shl i32 %10, 13
  %13 = add i32 %12, 262444
  %14 = getelementptr i8, ptr %11, i32 %13
  tail call void asm sideeffect "dsb st", "~{memory}"() #2, !srcloc !8
  tail call void @arm_heavy_mb() #2
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %14, i32 65535) #2, !srcloc !9
...
; Function Attrs: nounwind null_pointer_is_valid sspstrong uwtable(sync)
define dso_local i32 @gk208_fifo_new(ptr noundef %0, i32 noundef %1, i32 noundef %2, ptr noundef %3) local_unnamed_addr #0 {
  %5 = tail call i32 @gk104_fifo_new_(ptr noundef nonnull @gk208_fifo, ptr noundef %0, i32 noundef %1, i32 noundef %2, i32 noundef 1024, ptr noundef %3) #2
  ret i32 %5
}
