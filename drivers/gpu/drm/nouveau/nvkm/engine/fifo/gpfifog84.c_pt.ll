; ModuleID = '/llk/IR/drivers/gpu/drm/nouveau/nvkm/engine/fifo/gpfifog84.c_pt.bc'
source_filename = "../drivers/gpu/drm/nouveau/nvkm/engine/fifo/gpfifog84.c"
...
%struct.g82_channel_gpfifo_v0 = type { i8, i8, [2 x i8], i32, i64, i64, i64 }
...
@g84_fifo_gpfifo_oclass = dso_local local_unnamed_addr constant %struct.nvkm_fifo_chan_oclass { ptr @g84_fifo_gpfifo_new, %struct.nvkm_sclass { i32 0, i32 0, i32 33391, ptr null, ptr null } }, align 4
...
define internal i32 @g84_fifo_gpfifo_new(ptr noundef %0, ptr noundef %1, ptr nocapture noundef %2, i32 noundef %3, ptr nocapture noundef writeonly %4) #0 {
...
32:                                               ; preds = %27
  ...
  %38 = getelementptr inbounds %struct.g82_channel_gpfifo_v0, ptr %2, i32 0, i32 6
  %39 = load i64, ptr %38, align 8
  %40 = getelementptr inbounds %struct.g82_channel_gpfifo_v0, ptr %2, i32 0, i32 5
  %41 = load i64, ptr %40, align 8
  %42 = getelementptr inbounds %struct.g82_channel_gpfifo_v0, ptr %2, i32 0, i32 4
  %43 = load i64, ptr %42, align 8
  %44 = getelementptr inbounds %struct.g82_channel_gpfifo_v0, ptr %2, i32 0, i32 3
...
47:                                               ; preds = %32, %27
  %48 = getelementptr inbounds %struct.g82_channel_gpfifo_v0, ptr %2, i32 0, i32 5
...
55:                                               ; preds = %51
  ...
  %57 = getelementptr inbounds %struct.g82_channel_gpfifo_v0, ptr %2, i32 0, i32 6
  %58 = load i64, ptr %57, align 8
  %59 = load i64, ptr %48, align 8
  %60 = tail call i32 @g84_fifo_chan_ctor(ptr noundef %0, i64 noundef %58, i64 noundef %59, ptr noundef %1, ptr noundef nonnull %53) #7
  %61 = icmp eq i32 %60, 0
...
62:                                               ; preds = %55
  ...
  %66 = getelementptr inbounds %struct.g82_channel_gpfifo_v0, ptr %2, i32 0, i32 1
  store i8 %65, ptr %66, align 1
  %67 = getelementptr inbounds %struct.g82_channel_gpfifo_v0, ptr %2, i32 0, i32 4
  %68 = load i64, ptr %67, align 8
  %69 = getelementptr inbounds %struct.g82_channel_gpfifo_v0, ptr %2, i32 0, i32 3
  ...
  %150 = getelementptr inbounds %struct.nv50_fifo_chan, ptr %53, i32 0, i32 3
  %151 = load ptr, ptr %150, align 4
  %152 = getelementptr inbounds %struct.nvkm_gpuobj, ptr %151, i32 0, i32 4
  %153 = load i64, ptr %152, align 8
  %154 = lshr i64 %153, 10
  %155 = trunc i64 %154 to i32
  tail call void %149(ptr noundef %146, i32 noundef 136, i32 noundef %155) #7
  %156 = load ptr, ptr %78, align 8
  %157 = load ptr, ptr %156, align 8
  %158 = getelementptr inbounds %struct.nvkm_gpuobj_func, ptr %157, i32 0, i32 3
  %159 = load ptr, ptr %158, align 4
  %160 = getelementptr inbounds %struct.nv50_fifo_chan, ptr %53, i32 0, i32 1, i32 6
  %161 = load ptr, ptr %160, align 4
  %162 = getelementptr inbounds %struct.nvkm_gpuobj, ptr %161, i32 0, i32 4
  %163 = load i64, ptr %162, align 8
  %164 = lshr i64 %163, 12
  %165 = trunc i64 %164 to i32
  tail call void %159(ptr noundef %156, i32 noundef 152, i32 noundef %165) #7
  %166 = load ptr, ptr %78, align 8
  %167 = load ptr, ptr %166, align 8
  %168 = getelementptr inbounds %struct.nvkm_gpuobj_func, ptr %167, i32 0, i32 1
  %169 = load ptr, ptr %168, align 4
  tail call void %169(ptr noundef %166) #7
  br label %170

170:                                              ; preds = %62, %55, %51, %47, %25, %22, %20
  %171 = phi i32 [ 0, %62 ], [ -22, %47 ], [ -12, %51 ], [ %60, %55 ], [ -38, %20 ], [ -38, %22 ], [ -7, %25 ]
  ret i32 %171
}
...
declare dso_local i32 @g84_fifo_chan_ctor(ptr noundef, i64 noundef, i64 noundef, ptr noundef, ptr noundef) local_unnamed_addr #2
