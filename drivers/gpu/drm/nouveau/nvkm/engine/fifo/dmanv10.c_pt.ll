; ModuleID = '/llk/IR/drivers/gpu/drm/nouveau/nvkm/engine/fifo/dmanv10.c_pt.bc'
...
@nv10_fifo_dma_oclass = dso_local local_unnamed_addr constant %struct.nvkm_fifo_chan_oclass { ptr @nv10_fifo_dma_new, %struct.nvkm_sclass { i32 0, i32 0, i32 110, ptr null, ptr null } }, align 4
...
define internal i32 @nv10_fifo_dma_new(ptr noundef %0, ptr noundef %1, ptr nocapture noundef %2, i32 noundef %3, ptr nocapture noundef writeonly %4) #0 {
...
55:                                               ; preds = %51
  ...
  %58 = tail call i32 @nvkm_fifo_chan_ctor(ptr noundef nonnull @nv04_fifo_dma_func, ptr noundef %0, i32 noundef 4096, i32 noundef 4096, i1 noundef zeroext false, i64 noundef 0, i64 noundef %57, i32 noundef 11, i32 noundef 0, i32 noundef 8388608, i32 noundef 65536, ptr noundef %1, ptr noundef nonnull %53) #6
