; ModuleID = '/llk/IR/drivers/gpu/drm/nouveau/nvkm/engine/gr/nv25.c_pt.bc'
...
@nv25_gr = internal constant { ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, %struct.anon.124, [16 x %struct.nvkm_sclass] } { ptr @nv20_gr_dtor, ptr @nv20_gr_oneinit, ptr @nv20_gr_init, ptr null, ptr @nv20_gr_intr, ptr @nv20_gr_tile, ptr null, ptr @nv25_gr_chan_new, ptr null, ptr null, ptr null, %struct.anon.124 zeroinitializer, [16 x %struct.nvkm_sclass] [%struct.nvkm_sclass { i32 -1, i32 -1, i32 18, ptr @nv04_gr_object, ptr null }, %struct.nvkm_sclass { i32 -1, i32 -1, i32 25, ptr @nv04_gr_object, ptr null }, %struct.nvkm_sclass { i32 -1, i32 -1, i32 48, ptr @nv04_gr_object, ptr null }, %struct.nvkm_sclass { i32 -1, i32 -1, i32 57, ptr @nv04_gr_object, ptr null }, %struct.nvkm_sclass { i32 -1, i32 -1, i32 67, ptr @nv04_gr_object, ptr null }, %struct.nvkm_sclass { i32 -1, i32 -1, i32 68, ptr @nv04_gr_object, ptr null }, %struct.nvkm_sclass { i32 -1, i32 -1, i32 74, ptr @nv04_gr_object, ptr null }, %struct.nvkm_sclass { i32 -1, i32 -1, i32 98, ptr @nv04_gr_object, ptr null }, %struct.nvkm_sclass { i32 -1, i32 -1, i32 114, ptr @nv04_gr_object, ptr null }, %struct.nvkm_sclass { i32 -1, i32 -1, i32 137, ptr @nv04_gr_object, ptr null }, %struct.nvkm_sclass { i32 -1, i32 -1, i32 138, ptr @nv04_gr_object, ptr null }, %struct.nvkm_sclass { i32 -1, i32 -1, i32 150, ptr @nv04_gr_object, ptr null }, %struct.nvkm_sclass { i32 -1, i32 -1, i32 158, ptr @nv04_gr_object, ptr null }, %struct.nvkm_sclass { i32 -1, i32 -1, i32 159, ptr @nv04_gr_object, ptr null }, %struct.nvkm_sclass { i32 -1, i32 -1, i32 1431, ptr @nv04_gr_object, ptr null }, %struct.nvkm_sclass zeroinitializer] }, align 4
@nv25_gr_chan = internal constant %struct.nvkm_object_func { ptr @nv20_gr_chan_dtor, ptr @nv20_gr_chan_init, ptr @nv20_gr_chan_fini, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null }, align 4
@kmalloc_caches = external dso_local local_unnamed_addr global [3 x [14 x ptr]], align 4

; Function Attrs: nounwind null_pointer_is_valid sspstrong uwtable(sync)
define dso_local i32 @nv25_gr_new(ptr noundef %0, i32 noundef %1, i32 noundef %2, ptr noundef %3) local_unnamed_addr #0 {
  %5 = tail call i32 @nv20_gr_new_(ptr noundef nonnull @nv25_gr, ptr noundef %0, i32 noundef %1, i32 noundef %2, ptr noundef %3) #3
  ret i32 %5
}
...
; Function Attrs: nounwind null_pointer_is_valid sspstrong uwtable(sync)
define internal i32 @nv25_gr_chan_new(ptr noundef %0, ptr nocapture noundef readonly %1, ptr noundef %2, ptr nocapture noundef writeonly %3) #0 {
...
8:                                                ; preds = %4
  tail call void @nvkm_object_ctor(ptr noundef nonnull @nv25_gr_chan, ptr noundef %2, ptr noundef nonnull %6) #3
  ...
  %17 = tail call i32 @nvkm_memory_new(ptr noundef %15, i32 noundef 0, i64 noundef 14116, i32 noundef 16, i1 noundef zeroext true, ptr noundef %16) #3
  %18 = icmp eq i32 %17, 0
...
19:                                               ; preds = %8
  ...
  tail call void %37(ptr noundef %33, i64 noundef 860, i32 noundef -65536) #3
  ...
  tail call void %42(ptr noundef %38, i64 noundef 960, i32 noundef 268369920) #3
  ...
  tail call void %47(ptr noundef %43, i64 noundef 964, i32 noundef 268369920) #3
  ...
  tail call void %52(ptr noundef %48, i64 noundef 1180, i32 noundef 257) #3
  ...
  tail call void %57(ptr noundef %53, i64 noundef 1200, i32 noundef 273) #3
  ...
  tail call void %62(ptr noundef %58, i64 noundef 1224, i32 noundef 128) #3
  ...
  tail call void %67(ptr noundef %63, i64 noundef 1228, i32 noundef -65536) #3
  ...
  tail call void %72(ptr noundef %68, i64 noundef 1232, i32 noundef 1) #3
  ...
  tail call void %77(ptr noundef %73, i64 noundef 1252, i32 noundef 1145044992) #3
  ...
  tail call void %82(ptr noundef %78, i64 noundef 1276, i32 noundef 1266679808) #3
  ...
  tail call void %92(ptr noundef %88, i64 noundef 1300, i32 noundef 197379) #3
  ...
  tail call void %97(ptr noundef %93, i64 noundef 1304, i32 noundef 197379) #3
  ...
  tail call void %102(ptr noundef %98, i64 noundef 1308, i32 noundef 197379) #3
  ...
  tail call void %107(ptr noundef %103, i64 noundef 1328, i32 noundef 524288) #3
  ...
  tail call void %112(ptr noundef %108, i64 noundef 1332, i32 noundef 524288) #3
  ...
  tail call void %117(ptr noundef %113, i64 noundef 1336, i32 noundef 524288) #3
  ...
  tail call void %122(ptr noundef %118, i64 noundef 1340, i32 noundef 524288) #3
  ...
  tail call void %127(ptr noundef %123, i64 noundef 1352, i32 noundef 16850944) #3
  ...
  tail call void %132(ptr noundef %128, i64 noundef 1356, i32 noundef 16850944) #3
  ...
  tail call void %137(ptr noundef %133, i64 noundef 1360, i32 noundef 16850944) #3
  ...
  tail call void %142(ptr noundef %138, i64 noundef 1364, i32 noundef 16850944) #3
  ...
  tail call void %147(ptr noundef %143, i64 noundef 1368, i32 noundef 67000) #3
  ...
  tail call void %152(ptr noundef %148, i64 noundef 1372, i32 noundef 67000) #3
  ...
  tail call void %157(ptr noundef %153, i64 noundef 1376, i32 noundef 67000) #3
  ...
  tail call void %162(ptr noundef %158, i64 noundef 1380, i32 noundef 67000) #3
  ...
  tail call void %167(ptr noundef %163, i64 noundef 1384, i32 noundef 524296) #3
  ...
  tail call void %172(ptr noundef %168, i64 noundef 1388, i32 noundef 524296) #3
  ...
  tail call void %177(ptr noundef %173, i64 noundef 1392, i32 noundef 524296) #3
  ...
  tail call void %182(ptr noundef %178, i64 noundef 1396, i32 noundef 524296) #3
  ...
  tail call void %187(ptr noundef %183, i64 noundef 1432, i32 noundef 134152192) #3
  ...
  tail call void %192(ptr noundef %188, i64 noundef 1436, i32 noundef 134152192) #3
  ...
  tail call void %197(ptr noundef %193, i64 noundef 1440, i32 noundef 134152192) #3
  ...
  tail call void %202(ptr noundef %198, i64 noundef 1444, i32 noundef 134152192) #3
  ...
  tail call void %207(ptr noundef %203, i64 noundef 1448, i32 noundef 134152192) #3
  ...
  tail call void %212(ptr noundef %208, i64 noundef 1452, i32 noundef 134152192) #3
  ...
  tail call void %217(ptr noundef %213, i64 noundef 1456, i32 noundef 134152192) #3
  ...
  tail call void %222(ptr noundef %218, i64 noundef 1460, i32 noundef 134152192) #3
  ...
  tail call void %227(ptr noundef %223, i64 noundef 1464, i32 noundef 134152192) #3
  ...
  tail call void %232(ptr noundef %228, i64 noundef 1468, i32 noundef 134152192) #3
  ...
  tail call void %237(ptr noundef %233, i64 noundef 1472, i32 noundef 134152192) #3
  ...
  tail call void %242(ptr noundef %238, i64 noundef 1476, i32 noundef 134152192) #3
  ...
  tail call void %247(ptr noundef %243, i64 noundef 1480, i32 noundef 134152192) #3
  ...
  tail call void %252(ptr noundef %248, i64 noundef 1484, i32 noundef 134152192) #3
  ...
  tail call void %257(ptr noundef %253, i64 noundef 1488, i32 noundef 134152192) #3
  ...
  tail call void %262(ptr noundef %258, i64 noundef 1492, i32 noundef 134152192) #3
  ...
  tail call void %267(ptr noundef %263, i64 noundef 1504, i32 noundef 1266679807) #3
  ...
  tail call void %272(ptr noundef %268, i64 noundef 1568, i32 noundef 128) #3
  ...
  tail call void %277(ptr noundef %273, i64 noundef 1572, i32 noundef 807407616) #3
  ...
  tail call void %282(ptr noundef %278, i64 noundef 1576, i32 noundef 1885360192) #3
  ...
  tail call void %287(ptr noundef %283, i64 noundef 1580, i32 noundef -1331654528) #3
  ...
  tail call void %292(ptr noundef %288, i64 noundef 1584, i32 noundef -253701952) #3
  ...
  tail call void %297(ptr noundef %293, i64 noundef 1636, i32 noundef 1) #3
  ...
  tail call void %302(ptr noundef %298, i64 noundef 1644, i32 noundef 16384) #3
  ...
  tail call void %307(ptr noundef %303, i64 noundef 1656, i32 noundef 1) #3
  ...
  tail call void %312(ptr noundef %308, i64 noundef 1664, i32 noundef 262144) #3
  ...
  tail call void %317(ptr noundef %313, i64 noundef 1668, i32 noundef 65536) #3
  br label %318

318:                                              ; preds = %318, %19
  %319 = phi i32 [ 6916, %19 ], [ %340, %318 ]
  %320 = load ptr, ptr %16, align 8
  %321 = getelementptr inbounds %struct.nvkm_memory, ptr %320, i32 0, i32 1
  %322 = load ptr, ptr %321, align 4
  %323 = getelementptr inbounds %struct.nvkm_memory_ptrs, ptr %322, i32 0, i32 1
  %324 = load ptr, ptr %323, align 4
  %325 = zext i32 %319 to i64
  tail call void %324(ptr noundef %320, i64 noundef %325, i32 noundef 275779577) #3
  %326 = load ptr, ptr %16, align 8
  %327 = getelementptr inbounds %struct.nvkm_memory, ptr %326, i32 0, i32 1
  %328 = load ptr, ptr %327, align 4
  %329 = getelementptr inbounds %struct.nvkm_memory_ptrs, ptr %328, i32 0, i32 1
  %330 = load ptr, ptr %329, align 4
  %331 = add nuw nsw i32 %319, 4
  %332 = zext i32 %331 to i64
  tail call void %330(ptr noundef %326, i64 noundef %332, i32 noundef 70649964) #3
  ...
  %338 = add nuw nsw i32 %319, 8
  %339 = zext i32 %338 to i64
  tail call void %337(ptr noundef %333, i64 noundef %339, i32 noundef 786459) #3
  %340 = add nuw nsw i32 %319, 16
  %341 = icmp ult i32 %319, 9061
  br i1 %341, label %318, label %342
...
342:                                              ; preds = %318
  ...
  tail call void %347(ptr noundef %343, i64 noundef 9988, i32 noundef 1065353216) #3
  ...
  tail call void %352(ptr noundef %348, i64 noundef 10008, i32 noundef 1065353216) #3
  ...
  tail call void %357(ptr noundef %353, i64 noundef 10052, i32 noundef 1073741824) #3
  ...
  tail call void %362(ptr noundef %358, i64 noundef 10056, i32 noundef 1065353216) #3
  ...
  tail call void %367(ptr noundef %363, i64 noundef 10060, i32 noundef 1056964608) #3
  ...
  tail call void %372(ptr noundef %368, i64 noundef 10068, i32 noundef 1073741824) #3
  ...
  tail call void %377(ptr noundef %373, i64 noundef 10072, i32 noundef 1065353216) #3
  ...
  tail call void %382(ptr noundef %378, i64 noundef 10080, i32 noundef -1082130432) #3
  ...
  tail call void %387(ptr noundef %383, i64 noundef 10088, i32 noundef -1082130432) #3
  ...
  tail call void %392(ptr noundef %388, i64 noundef 12428, i32 noundef 1040384) #3
  ...
  tail call void %397(ptr noundef %393, i64 noundef 12552, i32 noundef 1016) #3
  ...
  tail call void %402(ptr noundef %398, i64 noundef 13416, i32 noundef 3137536) #3
  ...
  tail call void %407(ptr noundef %403, i64 noundef 13444, i32 noundef 1856124) #3
  ...
  tail call void %412(ptr noundef %408, i64 noundef 13448, i32 noundef 1856124) #3
  ...
  tail call void %417(ptr noundef %413, i64 noundef 13452, i32 noundef 1856124) #3
  ...
  tail call void %422(ptr noundef %418, i64 noundef 13456, i32 noundef 1856124) #3
  ...
  tail call void %427(ptr noundef %423, i64 noundef 13460, i32 noundef 1856124) #3
  ...
  tail call void %432(ptr noundef %428, i64 noundef 13464, i32 noundef 1856124) #3
  ...
  tail call void %437(ptr noundef %433, i64 noundef 13468, i32 noundef 1856124) #3
  ...
  tail call void %442(ptr noundef %438, i64 noundef 13472, i32 noundef 1856124) #3
  %443 = load ptr, ptr %16, align 8
  %444 = load ptr, ptr %443, align 4
  %445 = getelementptr inbounds %struct.nvkm_memory_func, ptr %444, i32 0, i32 8
  %446 = load ptr, ptr %445, align 4
  tail call void %446(ptr noundef %443) #3
  br label %447

447:                                              ; preds = %342, %8, %4
  %448 = phi i32 [ 0, %342 ], [ -12, %4 ], [ %17, %8 ]
  ret i32 %448
}
