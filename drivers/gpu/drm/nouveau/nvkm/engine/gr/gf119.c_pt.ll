; ModuleID = '/llk/IR/drivers/gpu/drm/nouveau/nvkm/engine/gr/gf119.c_pt.bc'
...
@gf119_gr_init_pe_0 = internal constant [8 x %struct.gf100_gr_init] [%struct.gf100_gr_init { i32 4298764, i8 1, i32 4, i32 16 }, %struct.gf100_gr_init { i32 4298768, i8 1, i32 4, i32 0 }, %struct.gf100_gr_init { i32 4298772, i8 1, i32 4, i32 4 }, %struct.gf100_gr_init { i32 4298820, i8 1, i32 4, i32 0 }, %struct.gf100_gr_init { i32 4298828, i8 1, i32 4, i32 43288 }, %struct.gf100_gr_init { i32 4298832, i8 4, i32 4, i32 0 }, %struct.gf100_gr_init { i32 4298880, i8 1, i32 4, i32 2 }, %struct.gf100_gr_init zeroinitializer], align 4
@gf100_gr_init_l1c_0 = external dso_local constant [0 x %struct.gf100_gr_init], align 4
@gf119_gr_init_wwdx_0 = internal constant [4 x %struct.gf100_gr_init] [%struct.gf100_gr_init { i32 4299732, i8 1, i32 4, i32 8388608 }, %struct.gf100_gr_init { i32 4299740, i8 1, i32 4, i32 0 }, %struct.gf100_gr_init { i32 4299768, i8 2, i32 4, i32 0 }, %struct.gf100_gr_init zeroinitializer], align 4
@gf119_gr_init_tpccs_1 = internal constant [3 x %struct.gf100_gr_init] [%struct.gf100_gr_init { i32 4300076, i8 1, i32 4, i32 0 }, %struct.gf100_gr_init { i32 4300104, i8 2, i32 4, i32 0 }, %struct.gf100_gr_init zeroinitializer], align 4
...
define dso_local i32 @gf119_gr_new(ptr noundef %0, i32 noundef %1, i32 noundef %2, ptr noundef %3) local_unnamed_addr #0 {
  %5 = tail call i32 @gf100_gr_new_(ptr noundef nonnull @gf119_gr_fwif, ptr noundef %0, i32 noundef %1, i32 noundef %2, ptr noundef %3) #2
  ret i32 %5
}
