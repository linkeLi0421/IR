; ModuleID = '/llk/IR/drivers/gpu/drm/nouveau/nvkm/engine/gr/gp10b.c_pt.bc'
...
@gp10b_gr_fwif = internal constant [3 x %struct.gf100_gr_fwif] [%struct.gf100_gr_fwif { i32 0, ptr @gm200_gr_load, ptr @gp10b_gr, ptr @gm20b_gr_fecs_acr, ptr @gp10b_gr_gpccs_acr }, %struct.gf100_gr_fwif { i32 -1, ptr @gm200_gr_nofw, ptr null, ptr null, ptr null }, %struct.gf100_gr_fwif zeroinitializer], align 4
@gm20b_gr_fecs_acr = external dso_local constant %struct.nvkm_acr_lsf_func, align 8
@gp10b_gr_gpccs_acr = internal constant %struct.nvkm_acr_lsf_func { i32 8, i32 76, ptr @gm20b_gr_acr_bld_write, ptr @gm20b_gr_acr_bld_patch, ptr null, i64 0, ptr null, ptr null }, align 8
