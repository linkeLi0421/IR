; ModuleID = '/llk/IR/drivers/gpu/drm/nouveau/nvkm/engine/gr/nv30.c_pt.bc'
source_filename = "../drivers/gpu/drm/nouveau/nvkm/engine/gr/nv30.c"
...
@nv30_gr = internal constant { ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, %struct.anon.4, [19 x %struct.nvkm_sclass] } { ptr @nv20_gr_dtor, ptr @nv20_gr_oneinit, ptr @nv30_gr_init, ptr null, ptr @nv20_gr_intr, ptr @nv20_gr_tile, ptr null, ptr @nv30_gr_chan_new, ptr null, ptr null, ptr null, %struct.anon.4 zeroinitializer, [19 x %struct.nvkm_sclass] [%struct.nvkm_sclass { i32 -1, i32 -1, i32 18, ptr @nv04_gr_object, ptr null }, %struct.nvkm_sclass { i32 -1, i32 -1, i32 25, ptr @nv04_gr_object, ptr null }, %struct.nvkm_sclass { i32 -1, i32 -1, i32 48, ptr @nv04_gr_object, ptr null }, %struct.nvkm_sclass { i32 -1, i32 -1, i32 57, ptr @nv04_gr_object, ptr null }, %struct.nvkm_sclass { i32 -1, i32 -1, i32 67, ptr @nv04_gr_object, ptr null }, %struct.nvkm_sclass { i32 -1, i32 -1, i32 68, ptr @nv04_gr_object, ptr null }, %struct.nvkm_sclass { i32 -1, i32 -1, i32 74, ptr @nv04_gr_object, ptr null }, %struct.nvkm_sclass { i32 -1, i32 -1, i32 98, ptr @nv04_gr_object, ptr null }, %struct.nvkm_sclass { i32 -1, i32 -1, i32 114, ptr @nv04_gr_object, ptr null }, %struct.nvkm_sclass { i32 -1, i32 -1, i32 137, ptr @nv04_gr_object, ptr null }, %struct.nvkm_sclass { i32 -1, i32 -1, i32 138, ptr @nv04_gr_object, ptr null }, %struct.nvkm_sclass { i32 -1, i32 -1, i32 159, ptr @nv04_gr_object, ptr null }, %struct.nvkm_sclass { i32 -1, i32 -1, i32 866, ptr @nv04_gr_object, ptr null }, %struct.nvkm_sclass { i32 -1, i32 -1, i32 905, ptr @nv04_gr_object, ptr null }, %struct.nvkm_sclass { i32 -1, i32 -1, i32 906, ptr @nv04_gr_object, ptr null }, %struct.nvkm_sclass { i32 -1, i32 -1, i32 926, ptr @nv04_gr_object, ptr null }, %struct.nvkm_sclass { i32 -1, i32 -1, i32 919, ptr @nv04_gr_object, ptr null }, %struct.nvkm_sclass { i32 -1, i32 -1, i32 1431, ptr @nv04_gr_object, ptr null }, %struct.nvkm_sclass zeroinitializer] }, align 4
@nv30_gr_chan = internal constant %struct.nvkm_object_func { ptr @nv20_gr_chan_dtor, ptr @nv20_gr_chan_init, ptr @nv20_gr_chan_fini, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null }, align 4
@kmalloc_caches = external dso_local local_unnamed_addr global [3 x [14 x ptr]], align 4

; Function Attrs: nounwind null_pointer_is_valid sspstrong uwtable(sync)
define dso_local i32 @nv30_gr_init(ptr nocapture noundef readonly %0) #0 {
  ...
  %9 = tail call i64 %8(ptr noundef %5) #3
  %10 = lshr i64 %9, 4
  %11 = trunc i64 %10 to i32
  %12 = getelementptr inbounds %struct.nvkm_device, ptr %3, i32 0, i32 11
  %13 = load ptr, ptr %12, align 4
  %14 = getelementptr i8, ptr %13, i32 4196224
  tail call void asm sideeffect "dsb st", "~{memory}"() #3, !srcloc !8
  tail call void @arm_heavy_mb() #3
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %14, i32 %11) #3, !srcloc !9
  ...
  %18 = getelementptr i8, ptr %17, i32 4194624
  tail call void asm sideeffect "dsb st", "~{memory}"() #3, !srcloc !8
  tail call void @arm_heavy_mb() #3
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %18, i32 -1) #3, !srcloc !9
  %19 = load ptr, ptr %12, align 4
  %20 = getelementptr i8, ptr %19, i32 4194432
  tail call void asm sideeffect "dsb st", "~{memory}"() #3, !srcloc !8
  tail call void @arm_heavy_mb() #3
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %20, i32 -1) #3, !srcloc !9
  %21 = load ptr, ptr %12, align 4
  %22 = getelementptr i8, ptr %21, i32 4194432
  tail call void asm sideeffect "dsb st", "~{memory}"() #3, !srcloc !8
  tail call void @arm_heavy_mb() #3
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %22, i32 0) #3, !srcloc !9
  %23 = load ptr, ptr %12, align 4
  %24 = getelementptr i8, ptr %23, i32 4194436
  tail call void asm sideeffect "dsb st", "~{memory}"() #3, !srcloc !8
  tail call void @arm_heavy_mb() #3
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %24, i32 1074956224) #3, !srcloc !9
  %25 = load ptr, ptr %12, align 4
  %26 = getelementptr i8, ptr %25, i32 4196496
  tail call void asm sideeffect "dsb st", "~{memory}"() #3, !srcloc !8
  tail call void @arm_heavy_mb() #3
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %26, i32 28599295) #3, !srcloc !9
  %27 = load ptr, ptr %12, align 4
  %28 = getelementptr i8, ptr %27, i32 4194444
  tail call void asm sideeffect "dsb st", "~{memory}"() #3, !srcloc !8
  tail call void @arm_heavy_mb() #3
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %28, i32 -220330891) #3, !srcloc !9
  %29 = load ptr, ptr %12, align 4
  %30 = getelementptr i8, ptr %29, i32 4194448
  tail call void asm sideeffect "dsb st", "~{memory}"() #3, !srcloc !8
  tail call void @arm_heavy_mb() #3
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %30, i32 32768) #3, !srcloc !9
  %31 = load ptr, ptr %12, align 4
  %32 = getelementptr i8, ptr %31, i32 4195856
  tail call void asm sideeffect "dsb st", "~{memory}"() #3, !srcloc !8
  tail call void @arm_heavy_mb() #3
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %32, i32 -263462922) #3, !srcloc !9
  %33 = load ptr, ptr %12, align 4
  %34 = getelementptr i8, ptr %33, i32 4197248
  tail call void asm sideeffect "dsb st", "~{memory}"() #3, !srcloc !8
  tail call void @arm_heavy_mb() #3
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %34, i32 268687496) #3, !srcloc !9
  %35 = load ptr, ptr %12, align 4
  %36 = getelementptr i8, ptr %35, i32 4197252
  tail call void asm sideeffect "dsb st", "~{memory}"() #3, !srcloc !8
  tail call void @arm_heavy_mb() #3
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %36, i32 201326592) #3, !srcloc !9
  %37 = load ptr, ptr %12, align 4
  %38 = getelementptr i8, ptr %37, i32 4194456
  tail call void asm sideeffect "dsb st", "~{memory}"() #3, !srcloc !8
  tail call void @arm_heavy_mb() #3
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %38, i32 0) #3, !srcloc !9
  %39 = load ptr, ptr %12, align 4
  %40 = getelementptr i8, ptr %39, i32 4194460
  tail call void asm sideeffect "dsb st", "~{memory}"() #3, !srcloc !8
  tail call void @arm_heavy_mb() #3
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %40, i32 371968) #3, !srcloc !9
  %41 = load ptr, ptr %12, align 4
  %42 = getelementptr i8, ptr %41, i32 4197256
  tail call void asm sideeffect "dsb st", "~{memory}"() #3, !srcloc !8
  tail call void @arm_heavy_mb() #3
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %42, i32 1660879103) #3, !srcloc !9
  %43 = load ptr, ptr %12, align 4
  %44 = getelementptr i8, ptr %43, i32 4194464
  tail call void asm sideeffect "dsb st", "~{memory}"() #3, !srcloc !8
  tail call void @arm_heavy_mb() #3
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %44, i32 0) #3, !srcloc !9
  %45 = load ptr, ptr %12, align 4
  %46 = getelementptr i8, ptr %45, i32 4194468
  tail call void asm sideeffect "dsb st", "~{memory}"() #3, !srcloc !8
  tail call void @arm_heavy_mb() #3
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %46, i32 8) #3, !srcloc !9
  %47 = load ptr, ptr %12, align 4
  %48 = getelementptr i8, ptr %47, i32 4196520
  tail call void asm sideeffect "dsb st", "~{memory}"() #3, !srcloc !8
  tail call void @arm_heavy_mb() #3
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %48, i32 -1216044032) #3, !srcloc !9
  %49 = load ptr, ptr %12, align 4
  %50 = getelementptr i8, ptr %49, i32 4197280
  tail call void asm sideeffect "dsb st", "~{memory}"() #3, !srcloc !8
  tail call void @arm_heavy_mb() #3
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %50, i32 3114629) #3, !srcloc !9
  %51 = load ptr, ptr %12, align 4
  %52 = getelementptr i8, ptr %51, i32 4197284
  tail call void asm sideeffect "dsb st", "~{memory}"() #3, !srcloc !8
  tail call void @arm_heavy_mb() #3
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %52, i32 2301759) #3, !srcloc !9
  %53 = load ptr, ptr %12, align 4
  %54 = getelementptr i8, ptr %53, i32 4196516
  tail call void asm sideeffect "dsb st", "~{memory}"() #3, !srcloc !8
  tail call void @arm_heavy_mb() #3
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %54, i32 1073741856) #3, !srcloc !9
  %55 = getelementptr inbounds %struct.nvkm_device, ptr %3, i32 0, i32 16
...
58:                                               ; preds = %1
  ...
  %60 = getelementptr i8, ptr %59, i32 4196176
  tail call void asm sideeffect "dsb st", "~{memory}"() #3, !srcloc !8
  tail call void @arm_heavy_mb() #3
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %60, i32 15335428) #3, !srcloc !9
  %61 = load ptr, ptr %12, align 4
  %62 = getelementptr i8, ptr %61, i32 4196180
  tail call void asm sideeffect "dsb st", "~{memory}"() #3, !srcloc !8
  tail call void @arm_heavy_mb() #3
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %62, i32 2097665) #3, !srcloc !9
  %63 = load ptr, ptr %12, align 4
  %64 = getelementptr i8, ptr %63, i32 4196176
  tail call void asm sideeffect "dsb st", "~{memory}"() #3, !srcloc !8
  tail call void @arm_heavy_mb() #3
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %64, i32 15335432) #3, !srcloc !9
  %65 = load ptr, ptr %12, align 4
  %66 = getelementptr i8, ptr %65, i32 4196180
  tail call void asm sideeffect "dsb st", "~{memory}"() #3, !srcloc !8
  tail call void @arm_heavy_mb() #3
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %66, i32 8) #3, !srcloc !9
  %67 = load ptr, ptr %12, align 4
  %68 = getelementptr i8, ptr %67, i32 4196176
  tail call void asm sideeffect "dsb st", "~{memory}"() #3, !srcloc !8
  tail call void @arm_heavy_mb() #3
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %68, i32 15335424) #3, !srcloc !9
  %69 = load ptr, ptr %12, align 4
  %70 = getelementptr i8, ptr %69, i32 4196180
  tail call void asm sideeffect "dsb st", "~{memory}"() #3, !srcloc !8
  tail call void @arm_heavy_mb() #3
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %70, i32 50) #3, !srcloc !9
  %71 = load ptr, ptr %12, align 4
  %72 = getelementptr i8, ptr %71, i32 4196176
  tail call void asm sideeffect "dsb st", "~{memory}"() #3, !srcloc !8
  tail call void @arm_heavy_mb() #3
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %72, i32 14680068) #3, !srcloc !9
  %73 = load ptr, ptr %12, align 4
  %74 = getelementptr i8, ptr %73, i32 4196180
  tail call void asm sideeffect "dsb st", "~{memory}"() #3, !srcloc !8
  tail call void @arm_heavy_mb() #3
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %74, i32 2) #3, !srcloc !9
  br label %75

75:                                               ; preds = %58, %1
  %76 = load ptr, ptr %12, align 4
  %77 = getelementptr i8, ptr %76, i32 4194496
  tail call void asm sideeffect "dsb st", "~{memory}"() #3, !srcloc !8
  tail call void @arm_heavy_mb() #3
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %77, i32 22) #3, !srcloc !9
  %78 = load ptr, ptr %12, align 4
  %79 = getelementptr i8, ptr %78, i32 4194628
  tail call void asm sideeffect "dsb st", "~{memory}"() #3, !srcloc !8
  tail call void @arm_heavy_mb() #3
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %79, i32 268435712) #3, !srcloc !9
  %80 = load ptr, ptr %12, align 4
  %81 = getelementptr i8, ptr %80, i32 4196116
  tail call void asm sideeffect "dsb st", "~{memory}"() #3, !srcloc !8
  tail call void @arm_heavy_mb() #3
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %81, i32 -1) #3, !srcloc !9
  %82 = load ptr, ptr %12, align 4
  %83 = getelementptr i8, ptr %82, i32 4196188
  tail call void asm sideeffect "dsb st", "~{memory}"() #3, !srcloc !8
  tail call void @arm_heavy_mb() #3
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %83, i32 1) #3, !srcloc !9
  %84 = load ptr, ptr %12, align 4
  %85 = getelementptr i8, ptr %84, i32 1049088
  %86 = tail call i32 asm sideeffect "ldr $0, $1", "=r,*Qo"(ptr elementtype(i32) %85) #3, !srcloc !10
  tail call void asm sideeffect "dsb ", "~{memory}"() #3, !srcloc !11
  %87 = load ptr, ptr %12, align 4
  %88 = getelementptr i8, ptr %87, i32 4196772
  tail call void asm sideeffect "dsb st", "~{memory}"() #3, !srcloc !8
  tail call void @arm_heavy_mb() #3
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %88, i32 %86) #3, !srcloc !9
  %89 = load ptr, ptr %12, align 4
  %90 = getelementptr i8, ptr %89, i32 1049092
  %91 = tail call i32 asm sideeffect "ldr $0, $1", "=r,*Qo"(ptr elementtype(i32) %90) #3, !srcloc !10
  tail call void asm sideeffect "dsb ", "~{memory}"() #3, !srcloc !11
  %92 = load ptr, ptr %12, align 4
  %93 = getelementptr i8, ptr %92, i32 4196776
  tail call void asm sideeffect "dsb st", "~{memory}"() #3, !srcloc !8
  tail call void @arm_heavy_mb() #3
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %93, i32 %91) #3, !srcloc !9
...
96:                                               ; preds = %75
  ...
  %98 = getelementptr i8, ptr %97, i32 4196176
  tail call void asm sideeffect "dsb st", "~{memory}"() #3, !srcloc !8
  tail call void @arm_heavy_mb() #3
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %98, i32 15335424) #3, !srcloc !9
  %99 = load ptr, ptr %12, align 4
  %100 = getelementptr i8, ptr %99, i32 1049088
  %101 = tail call i32 asm sideeffect "ldr $0, $1", "=r,*Qo"(ptr elementtype(i32) %100) #3, !srcloc !10
  tail call void asm sideeffect "dsb ", "~{memory}"() #3, !srcloc !11
  %102 = load ptr, ptr %12, align 4
  %103 = getelementptr i8, ptr %102, i32 4196180
  tail call void asm sideeffect "dsb st", "~{memory}"() #3, !srcloc !8
  tail call void @arm_heavy_mb() #3
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %103, i32 %101) #3, !srcloc !9
  %104 = load ptr, ptr %12, align 4
  %105 = getelementptr i8, ptr %104, i32 4196176
  tail call void asm sideeffect "dsb st", "~{memory}"() #3, !srcloc !8
  tail call void @arm_heavy_mb() #3
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %105, i32 15335428) #3, !srcloc !9
  %106 = load ptr, ptr %12, align 4
  %107 = getelementptr i8, ptr %106, i32 1049092
  %108 = tail call i32 asm sideeffect "ldr $0, $1", "=r,*Qo"(ptr elementtype(i32) %107) #3, !srcloc !10
  tail call void asm sideeffect "dsb ", "~{memory}"() #3, !srcloc !11
  %109 = load ptr, ptr %12, align 4
  %110 = getelementptr i8, ptr %109, i32 4196180
  tail call void asm sideeffect "dsb st", "~{memory}"() #3, !srcloc !8
  tail call void @arm_heavy_mb() #3
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %110, i32 %108) #3, !srcloc !9
  br label %111
...
; Function Attrs: nounwind null_pointer_is_valid sspstrong uwtable(sync)
define dso_local i32 @nv30_gr_new(ptr noundef %0, i32 noundef %1, i32 noundef %2, ptr noundef %3) local_unnamed_addr #0 {
  %5 = tail call i32 @nv20_gr_new_(ptr noundef nonnull @nv30_gr, ptr noundef %0, i32 noundef %1, i32 noundef %2, ptr noundef %3) #3
  ret i32 %5
}
...
; Function Attrs: nounwind null_pointer_is_valid sspstrong uwtable(sync)
define internal i32 @nv30_gr_chan_new(ptr noundef %0, ptr nocapture noundef readonly %1, ptr noundef %2, ptr nocapture noundef writeonly %3) #0 {
...
8:                                                ; preds = %4
  tail call void @nvkm_object_ctor(ptr noundef nonnull @nv30_gr_chan, ptr noundef %2, ptr noundef nonnull %6) #3
  ...
  %17 = tail call i32 @nvkm_memory_new(ptr noundef %15, i32 noundef 0, i64 noundef 24392, i32 noundef 16, i1 noundef zeroext true, ptr noundef %16) #3
  %18 = icmp eq i32 %17, 0
...
19:                                               ; preds = %8
  ...
  tail call void %37(ptr noundef %33, i64 noundef 1040, i32 noundef 257) #3
  ...
  tail call void %42(ptr noundef %38, i64 noundef 1060, i32 noundef 273) #3
  ...
  tail call void %47(ptr noundef %43, i64 noundef 1064, i32 noundef 96) #3
  ...
  tail call void %52(ptr noundef %48, i64 noundef 1092, i32 noundef 128) #3
  ...
  tail call void %57(ptr noundef %53, i64 noundef 1096, i32 noundef -65536) #3
  ...
  tail call void %62(ptr noundef %58, i64 noundef 1100, i32 noundef 1) #3
  ...
  tail call void %67(ptr noundef %63, i64 noundef 1120, i32 noundef 1145044992) #3
  ...
  tail call void %72(ptr noundef %68, i64 noundef 1164, i32 noundef -65536) #3
  ...
  tail call void %77(ptr noundef %73, i64 noundef 1248, i32 noundef 268369920) #3
  ...
  tail call void %82(ptr noundef %78, i64 noundef 1252, i32 noundef 268369920) #3
  ...
  tail call void %87(ptr noundef %83, i64 noundef 1260, i32 noundef 69888) #3
  ...
  tail call void %92(ptr noundef %88, i64 noundef 1288, i32 noundef 134152192) #3
  ...
  tail call void %97(ptr noundef %93, i64 noundef 1292, i32 noundef 134152192) #3
  ...
  tail call void %102(ptr noundef %98, i64 noundef 1296, i32 noundef 134152192) #3
  ...
  tail call void %107(ptr noundef %103, i64 noundef 1300, i32 noundef 134152192) #3
  ...
  tail call void %112(ptr noundef %108, i64 noundef 1304, i32 noundef 134152192) #3
  ...
  tail call void %117(ptr noundef %113, i64 noundef 1308, i32 noundef 134152192) #3
  ...
  tail call void %122(ptr noundef %118, i64 noundef 1312, i32 noundef 134152192) #3
  ...
  tail call void %127(ptr noundef %123, i64 noundef 1316, i32 noundef 134152192) #3
  ...
  tail call void %132(ptr noundef %128, i64 noundef 1320, i32 noundef 134152192) #3
  ...
  tail call void %137(ptr noundef %133, i64 noundef 1324, i32 noundef 134152192) #3
  ...
  tail call void %142(ptr noundef %138, i64 noundef 1328, i32 noundef 134152192) #3
  ...
  tail call void %147(ptr noundef %143, i64 noundef 1332, i32 noundef 134152192) #3
  ...
  tail call void %152(ptr noundef %148, i64 noundef 1336, i32 noundef 134152192) #3
  ...
  tail call void %157(ptr noundef %153, i64 noundef 1340, i32 noundef 134152192) #3
  ...
  tail call void %162(ptr noundef %158, i64 noundef 1344, i32 noundef 134152192) #3
  ...
  tail call void %167(ptr noundef %163, i64 noundef 1348, i32 noundef 134152192) #3
  ...
  tail call void %172(ptr noundef %168, i64 noundef 1360, i32 noundef 1266679807) #3
  ...
  tail call void %177(ptr noundef %173, i64 noundef 1420, i32 noundef 128) #3
  ...
  tail call void %182(ptr noundef %178, i64 noundef 1424, i32 noundef 807407616) #3
  ...
  tail call void %187(ptr noundef %183, i64 noundef 1428, i32 noundef 1885360192) #3
  ...
  tail call void %192(ptr noundef %188, i64 noundef 1432, i32 noundef -1196910456) #3
  ...
  tail call void %197(ptr noundef %193, i64 noundef 1436, i32 noundef -118957880) #3
  ...
  tail call void %202(ptr noundef %198, i64 noundef 1456, i32 noundef -1342177280) #3
  ...
  tail call void %207(ptr noundef %203, i64 noundef 1536, i32 noundef 66952) #3
  ...
  tail call void %212(ptr noundef %208, i64 noundef 1540, i32 noundef 66952) #3
  ...
  tail call void %217(ptr noundef %213, i64 noundef 1544, i32 noundef 66952) #3
  ...
  tail call void %222(ptr noundef %218, i64 noundef 1548, i32 noundef 66952) #3
  ...
  tail call void %227(ptr noundef %223, i64 noundef 1552, i32 noundef 66952) #3
  ...
  tail call void %232(ptr noundef %228, i64 noundef 1556, i32 noundef 66952) #3
  ...
  tail call void %237(ptr noundef %233, i64 noundef 1560, i32 noundef 66952) #3
  ...
  tail call void %242(ptr noundef %238, i64 noundef 1564, i32 noundef 66952) #3
  ...
  tail call void %247(ptr noundef %243, i64 noundef 1568, i32 noundef 66952) #3
  ...
  tail call void %252(ptr noundef %248, i64 noundef 1572, i32 noundef 66952) #3
  ...
  tail call void %257(ptr noundef %253, i64 noundef 1576, i32 noundef 66952) #3
  ...
  tail call void %262(ptr noundef %258, i64 noundef 1580, i32 noundef 66952) #3
  ...
  tail call void %267(ptr noundef %263, i64 noundef 1584, i32 noundef 66952) #3
  ...
  tail call void %272(ptr noundef %268, i64 noundef 1588, i32 noundef 66952) #3
  ...
  tail call void %277(ptr noundef %273, i64 noundef 1592, i32 noundef 66952) #3
  ...
  tail call void %282(ptr noundef %278, i64 noundef 1596, i32 noundef 66952) #3
  ...
  tail call void %287(ptr noundef %283, i64 noundef 1600, i32 noundef 197379) #3
  ...
  tail call void %292(ptr noundef %288, i64 noundef 1604, i32 noundef 197379) #3
  ...
  tail call void %297(ptr noundef %293, i64 noundef 1608, i32 noundef 197379) #3
  ...
  tail call void %302(ptr noundef %298, i64 noundef 1612, i32 noundef 197379) #3
  ...
  tail call void %307(ptr noundef %303, i64 noundef 1616, i32 noundef 197379) #3
  ...
  tail call void %312(ptr noundef %308, i64 noundef 1620, i32 noundef 197379) #3
  ...
  tail call void %317(ptr noundef %313, i64 noundef 1624, i32 noundef 197379) #3
  ...
  tail call void %322(ptr noundef %318, i64 noundef 1628, i32 noundef 197379) #3
  ...
  tail call void %327(ptr noundef %323, i64 noundef 1632, i32 noundef 197379) #3
  ...
  tail call void %332(ptr noundef %328, i64 noundef 1636, i32 noundef 197379) #3
  ...
  tail call void %337(ptr noundef %333, i64 noundef 1640, i32 noundef 197379) #3
  ...
  tail call void %342(ptr noundef %338, i64 noundef 1644, i32 noundef 197379) #3
  ...
  tail call void %347(ptr noundef %343, i64 noundef 1648, i32 noundef 197379) #3
  ...
  tail call void %352(ptr noundef %348, i64 noundef 1652, i32 noundef 197379) #3
  ...
  tail call void %357(ptr noundef %353, i64 noundef 1656, i32 noundef 197379) #3
  ...
  tail call void %362(ptr noundef %358, i64 noundef 1660, i32 noundef 197379) #3
  ...
  tail call void %367(ptr noundef %363, i64 noundef 1728, i32 noundef 568036) #3
  ...
  tail call void %372(ptr noundef %368, i64 noundef 1732, i32 noundef 568036) #3
  ...
  tail call void %377(ptr noundef %373, i64 noundef 1736, i32 noundef 568036) #3
  ...
  tail call void %382(ptr noundef %378, i64 noundef 1740, i32 noundef 568036) #3
  ...
  tail call void %387(ptr noundef %383, i64 noundef 1744, i32 noundef 568036) #3
  ...
  tail call void %392(ptr noundef %388, i64 noundef 1748, i32 noundef 568036) #3
  ...
  tail call void %397(ptr noundef %393, i64 noundef 1752, i32 noundef 568036) #3
  ...
  tail call void %402(ptr noundef %398, i64 noundef 1756, i32 noundef 568036) #3
  ...
  tail call void %407(ptr noundef %403, i64 noundef 1760, i32 noundef 568036) #3
  ...
  tail call void %412(ptr noundef %408, i64 noundef 1764, i32 noundef 568036) #3
  ...
  tail call void %417(ptr noundef %413, i64 noundef 1768, i32 noundef 568036) #3
  ...
  tail call void %422(ptr noundef %418, i64 noundef 1772, i32 noundef 568036) #3
  ...
  tail call void %427(ptr noundef %423, i64 noundef 1776, i32 noundef 568036) #3
  ...
  tail call void %432(ptr noundef %428, i64 noundef 1780, i32 noundef 568036) #3
  ...
  tail call void %437(ptr noundef %433, i64 noundef 1784, i32 noundef 568036) #3
  ...
  tail call void %442(ptr noundef %438, i64 noundef 1788, i32 noundef 568036) #3
  ...
  tail call void %447(ptr noundef %443, i64 noundef 1792, i32 noundef 16850944) #3
  ...
  tail call void %452(ptr noundef %448, i64 noundef 1796, i32 noundef 16850944) #3
  ...
  tail call void %457(ptr noundef %453, i64 noundef 1800, i32 noundef 16850944) #3
  ...
  tail call void %462(ptr noundef %458, i64 noundef 1804, i32 noundef 16850944) #3
  ...
  tail call void %467(ptr noundef %463, i64 noundef 1808, i32 noundef 16850944) #3
  ...
  tail call void %472(ptr noundef %468, i64 noundef 1812, i32 noundef 16850944) #3
  ...
  tail call void %477(ptr noundef %473, i64 noundef 1816, i32 noundef 16850944) #3
  ...
  tail call void %482(ptr noundef %478, i64 noundef 1820, i32 noundef 16850944) #3
  ...
  tail call void %487(ptr noundef %483, i64 noundef 1824, i32 noundef 16850944) #3
  ...
  tail call void %492(ptr noundef %488, i64 noundef 1828, i32 noundef 16850944) #3
  ...
  tail call void %497(ptr noundef %493, i64 noundef 1832, i32 noundef 16850944) #3
  ...
  tail call void %502(ptr noundef %498, i64 noundef 1836, i32 noundef 16850944) #3
  ...
  tail call void %507(ptr noundef %503, i64 noundef 1840, i32 noundef 16850944) #3
  ...
  tail call void %512(ptr noundef %508, i64 noundef 1844, i32 noundef 16850944) #3
  ...
  tail call void %517(ptr noundef %513, i64 noundef 1848, i32 noundef 16850944) #3
  ...
  tail call void %522(ptr noundef %518, i64 noundef 1852, i32 noundef 16850944) #3
  ...
  tail call void %527(ptr noundef %523, i64 noundef 1856, i32 noundef 524296) #3
  ...
  tail call void %532(ptr noundef %528, i64 noundef 1860, i32 noundef 524296) #3
  ...
  tail call void %537(ptr noundef %533, i64 noundef 1864, i32 noundef 524296) #3
  ...
  tail call void %542(ptr noundef %538, i64 noundef 1868, i32 noundef 524296) #3
  ...
  tail call void %547(ptr noundef %543, i64 noundef 1872, i32 noundef 524296) #3
  ...
  tail call void %552(ptr noundef %548, i64 noundef 1876, i32 noundef 524296) #3
  ...
  tail call void %557(ptr noundef %553, i64 noundef 1880, i32 noundef 524296) #3
  ...
  tail call void %562(ptr noundef %558, i64 noundef 1884, i32 noundef 524296) #3
  ...
  tail call void %567(ptr noundef %563, i64 noundef 1888, i32 noundef 524296) #3
  ...
  tail call void %572(ptr noundef %568, i64 noundef 1892, i32 noundef 524296) #3
  ...
  tail call void %577(ptr noundef %573, i64 noundef 1896, i32 noundef 524296) #3
  ...
  tail call void %582(ptr noundef %578, i64 noundef 1900, i32 noundef 524296) #3
  ...
  tail call void %587(ptr noundef %583, i64 noundef 1904, i32 noundef 524296) #3
  ...
  tail call void %592(ptr noundef %588, i64 noundef 1908, i32 noundef 524296) #3
  ...
  tail call void %597(ptr noundef %593, i64 noundef 1912, i32 noundef 524296) #3
  ...
  tail call void %602(ptr noundef %598, i64 noundef 1916, i32 noundef 524296) #3
  ...
  tail call void %607(ptr noundef %603, i64 noundef 2140, i32 noundef 262144) #3
  ...
  tail call void %612(ptr noundef %608, i64 noundef 2144, i32 noundef 65536) #3
  ...
  tail call void %617(ptr noundef %613, i64 noundef 2148, i32 noundef 262148) #3
  ...
  tail call void %622(ptr noundef %618, i64 noundef 2152, i32 noundef 262148) #3
  ...
  tail call void %627(ptr noundef %623, i64 noundef 2156, i32 noundef 262148) #3
  ...
  tail call void %632(ptr noundef %628, i64 noundef 2160, i32 noundef 262148) #3
  br label %633

633:                                              ; preds = %633, %19
  %634 = phi i32 [ %655, %633 ], [ 7960, %19 ]
...
657:                                              ; preds = %633
  ...
  tail call void %662(ptr noundef %658, i64 noundef 12472, i32 noundef 65535) #3
  ...
  tail call void %667(ptr noundef %663, i64 noundef 12476, i32 noundef 65535) #3
  ...
  tail call void %672(ptr noundef %668, i64 noundef 12480, i32 noundef 65535) #3
  ...
  tail call void %677(ptr noundef %673, i64 noundef 12484, i32 noundef 65535) #3
  ...
  tail call void %682(ptr noundef %678, i64 noundef 13388, i32 noundef 1065353216) #3
  ...
  tail call void %687(ptr noundef %683, i64 noundef 14344, i32 noundef 1065353216) #3
  ...
  tail call void %692(ptr noundef %688, i64 noundef 14364, i32 noundef 1065353216) #3
  ...
  tail call void %697(ptr noundef %693, i64 noundef 14408, i32 noundef 1073741824) #3
  ...
  tail call void %702(ptr noundef %698, i64 noundef 14412, i32 noundef 1065353216) #3
  ...
  tail call void %707(ptr noundef %703, i64 noundef 14416, i32 noundef 1056964608) #3
  ...
  tail call void %712(ptr noundef %708, i64 noundef 14424, i32 noundef 1073741824) #3
  ...
  tail call void %717(ptr noundef %713, i64 noundef 14428, i32 noundef 1065353216) #3
  ...
  tail call void %722(ptr noundef %718, i64 noundef 14436, i32 noundef -1082130432) #3
  ...
  tail call void %727(ptr noundef %723, i64 noundef 14444, i32 noundef -1082130432) #3
