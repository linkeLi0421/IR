; ModuleID = '/llk/IR/drivers/gpu/drm/nouveau/nvkm/engine/disp/g84.c_pt.bc'
source_filename = "../drivers/gpu/drm/nouveau/nvkm/engine/disp/g84.c"
...
@g84_disp = internal constant %struct.nv50_disp_func { ptr @nv50_disp_init, ptr @nv50_disp_fini, ptr @nv50_disp_intr, ptr null, ptr @nv50_disp_chan_uevent, ptr @nv50_disp_super, ptr @g84_disp_root_oclass, %struct.anon.134 zeroinitializer, %struct.anon.134 { ptr @nv50_head_cnt, ptr @nv50_head_new }, %struct.anon.134 { ptr @nv50_dac_cnt, ptr @nv50_dac_new }, %struct.anon.134 { ptr @nv50_sor_cnt, ptr @g84_sor_new }, %struct.anon.134 { ptr @nv50_pior_cnt, ptr @nv50_pior_new }, i16 0 }, align 4
@nv50_disp_chan_uevent = external dso_local constant %struct.nvkm_event_func, align 4
@g84_disp_root_oclass = external dso_local constant %struct.nvkm_disp_oclass, align 4

; Function Attrs: nounwind null_pointer_is_valid sspstrong uwtable(sync)
define dso_local i32 @g84_disp_new(ptr noundef %0, i32 noundef %1, i32 noundef %2, ptr noundef %3) local_unnamed_addr #0 {
  %5 = tail call i32 @nv50_disp_new_(ptr noundef nonnull @g84_disp, ptr noundef %0, i32 noundef %1, i32 noundef %2, ptr noundef %3) #2
  ret i32 %5
}
