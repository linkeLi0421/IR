; ModuleID = '/llk/IR/drivers/gpu/drm/nouveau/nvkm/engine/disp/gt215.c_pt.bc'
source_filename = "../drivers/gpu/drm/nouveau/nvkm/engine/disp/gt215.c"
...
@gt215_disp = internal constant %struct.nv50_disp_func { ptr @nv50_disp_init, ptr @nv50_disp_fini, ptr @nv50_disp_intr, ptr null, ptr @nv50_disp_chan_uevent, ptr @nv50_disp_super, ptr @gt215_disp_root_oclass, %struct.anon.134 zeroinitializer, %struct.anon.134 { ptr @nv50_head_cnt, ptr @nv50_head_new }, %struct.anon.134 { ptr @nv50_dac_cnt, ptr @nv50_dac_new }, %struct.anon.134 { ptr @g94_sor_cnt, ptr @gt215_sor_new }, %struct.anon.134 { ptr @nv50_pior_cnt, ptr @nv50_pior_new }, i16 0 }, align 4
...
define dso_local i32 @gt215_disp_new(ptr noundef %0, i32 noundef %1, i32 noundef %2, ptr noundef %3) local_unnamed_addr #0 {
  %5 = tail call i32 @nv50_disp_new_(ptr noundef nonnull @gt215_disp, ptr noundef %0, i32 noundef %1, i32 noundef %2, ptr noundef %3) #2
  ret i32 %5
}
...
; Function Attrs: null_pointer_is_valid
declare dso_local i32 @gt215_sor_new(ptr noundef, i32 noundef) #1
