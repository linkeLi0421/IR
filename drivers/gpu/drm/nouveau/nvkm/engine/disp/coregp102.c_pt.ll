; ModuleID = '/llk/IR/drivers/gpu/drm/nouveau/nvkm/engine/disp/coregp102.c_pt.bc'
...
@gp102_disp_core_func = internal constant %struct.nv50_disp_chan_func { ptr @gp102_disp_core_init, ptr @gf119_disp_core_fini, ptr @gf119_disp_chan_intr, ptr @nv50_disp_chan_user, ptr @gf119_disp_dmac_bind }, align 4
@gk104_disp_core_mthd = external dso_local constant %struct.nv50_disp_chan_mthd, align 4
@.str = private unnamed_addr constant [53 x i8] c"drivers/gpu/drm/nouveau/nvkm/engine/disp/coregp102.c\00", align 1
@.str.1 = private unnamed_addr constant [16 x i8] c"%s %s: timeout\0A\00", align 1
@.str.2 = private unnamed_addr constant [21 x i8] c"%s: core init: %08x\0A\00", align 1

; Function Attrs: nounwind null_pointer_is_valid sspstrong uwtable(sync)
define dso_local i32 @gp102_disp_core_new(ptr noundef %0, ptr noundef %1, i32 noundef %2, ptr noundef %3, ptr noundef %4) local_unnamed_addr #0 {
  %6 = tail call i32 @nv50_disp_core_new_(ptr noundef nonnull @gp102_disp_core_func, ptr noundef nonnull @gk104_disp_core_mthd, ptr noundef %3, i32 noundef 0, ptr noundef %0, ptr noundef %1, i32 noundef %2, ptr noundef %4) #5
  ret i32 %6
}
...
; Function Attrs: nounwind null_pointer_is_valid sspstrong uwtable(sync)
define internal i32 @gp102_disp_core_init(ptr nocapture noundef readonly %0) #0 {
  ...
  %12 = getelementptr i8, ptr %11, i32 6362260
  ...
  %14 = getelementptr i8, ptr %13, i32 6362264
  tail call void asm sideeffect "dsb st", "~{memory}"() #5, !srcloc !8
  tail call void @arm_heavy_mb() #5
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %14, i32 65536) #5, !srcloc !9
  %15 = load ptr, ptr %10, align 4
  %16 = getelementptr i8, ptr %15, i32 6362268
  tail call void asm sideeffect "dsb st", "~{memory}"() #5, !srcloc !8
  tail call void @arm_heavy_mb() #5
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %16, i32 1) #5, !srcloc !9
  ...
  tail call void asm sideeffect "dsb st", "~{memory}"() #5, !srcloc !8
  tail call void @arm_heavy_mb() #5
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %28, i32 16777235) #5, !srcloc !9
...
29:                                               ; preds = %34, %1
  ...
  %32 = call i32 asm sideeffect "ldr $0, $1", "=r,*Qo"(ptr elementtype(i32) %31) #5, !srcloc !10
...
54:                                               ; preds = %52, %37
  ...
  call void (ptr, i32, i32, ptr, ...) @warn_slowpath_fmt(ptr noundef nonnull @.str, i32 noundef 46, i32 noundef 9, ptr noundef nonnull @.str.1, ptr noundef %43, ptr noundef %55) #5
...
59:                                               ; preds = %54
  ...
  %66 = call i32 asm sideeffect "ldr $0, $1", "=r,*Qo"(ptr elementtype(i32) %65) #5, !srcloc !10
  call void asm sideeffect "dsb ", "~{memory}"() #5, !srcloc !11
  call void (ptr, ptr, ...) @_dev_err(ptr noundef %62, ptr noundef nonnull @.str.2, ptr noundef %63, i32 noundef %66) #6
  br label %68
