; ModuleID = '/llk/IR/drivers/gpu/drm/nouveau/nvkm/engine/disp/oimmnv50.c_pt.bc'
source_filename = "../drivers/gpu/drm/nouveau/nvkm/engine/disp/oimmnv50.c"
...
%struct.nv50_disp_overlay_v0 = type { i8, i8, [6 x i8] }
...
@.str = private unnamed_addr constant [61 x i8] c"\016nouveau: %s:%08x:%08x: ioctl: create disp overlay size %d\0A\00", align 1
@.str.1 = private unnamed_addr constant [69 x i8] c"\016nouveau: %s:%08x:%08x: ioctl: create disp overlay vers %d head %d\0A\00", align 1
@nv50_disp_pioc_func = external dso_local constant %struct.nv50_disp_chan_func, align 4

; Function Attrs: nounwind null_pointer_is_valid sspstrong uwtable(sync)
define dso_local i32 @nv50_disp_oimm_new_(ptr noundef %0, ptr noundef %1, i32 noundef %2, i32 noundef %3, ptr noundef %4, ptr nocapture noundef readonly %5, i32 noundef %6, ptr noundef %7) local_unnamed_addr #0 {
...
35:                                               ; preds = %30
  ...
  %41 = getelementptr inbounds %struct.nv50_disp_overlay_v0, ptr %5, i32 0, i32 1
...
45:                                               ; preds = %35, %30
  ...
  %47 = getelementptr inbounds %struct.nv50_disp_overlay_v0, ptr %5, i32 0, i32 1
...
; Function Attrs: nounwind null_pointer_is_valid sspstrong uwtable(sync)
define dso_local i32 @nv50_disp_oimm_new(ptr noundef %0, ptr nocapture noundef readonly %1, i32 noundef %2, ptr noundef %3, ptr noundef %4) local_unnamed_addr #0 {
  %6 = tail call i32 @nv50_disp_oimm_new_(ptr noundef nonnull @nv50_disp_pioc_func, ptr noundef %3, i32 noundef 5, i32 noundef 5, ptr noundef %0, ptr noundef %1, i32 noundef %2, ptr noundef %4)
  ret i32 %6
}
