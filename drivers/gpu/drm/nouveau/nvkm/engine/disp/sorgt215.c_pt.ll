; ModuleID = '/llk/IR/drivers/gpu/drm/nouveau/nvkm/engine/disp/sorgt215.c_pt.bc'
...
@.str = private unnamed_addr constant [52 x i8] c"drivers/gpu/drm/nouveau/nvkm/engine/disp/sorgt215.c\00", align 1
@.str.1 = private unnamed_addr constant [16 x i8] c"%s %s: timeout\0A\00", align 1
@gt215_sor = internal constant %struct.nvkm_ior_func { %struct.anon zeroinitializer, ptr @g94_sor_state, ptr @nv50_sor_power, ptr null, ptr @nv50_sor_clock, ptr null, ptr null, %struct.anon.132 { ptr @gt215_hdmi_ctrl, ptr null }, %struct.anon.133 { [4 x i8] c"\02\01\00\03", ptr @g94_sor_dp_links, ptr @g94_sor_dp_power, ptr @g94_sor_dp_pattern, ptr @g94_sor_dp_drive, ptr null, ptr @gt215_sor_dp_audio, ptr @g94_sor_dp_audio_sym, ptr @g94_sor_dp_activesym, ptr @g94_sor_dp_watermark }, %struct.anon.134 { ptr @gt215_hda_hpd, ptr @gt215_hda_eld, ptr null } }, align 4

; Function Attrs: nounwind null_pointer_is_valid sspstrong uwtable(sync)
define dso_local void @gt215_sor_dp_audio(ptr nocapture noundef readonly %0, i32 %1, i1 noundef zeroext %2) #0 {
...
23:                                               ; preds = %28, %3
  ...
  %26 = call i32 asm sideeffect "ldr $0, $1", "=r,*Qo"(ptr elementtype(i32) %25) #4, !srcloc !8
  call void asm sideeffect "dsb ", "~{memory}"() #4, !srcloc !9
  %27 = icmp sgt i32 %26, -1
  br i1 %27, label %50, label %28

28:                                               ; preds = %23
  %29 = call i64 @nvkm_timer_wait_test(ptr noundef nonnull %4) #4
...
31:                                               ; preds = %28
  ...
  %37 = call ptr @dev_driver_string(ptr noundef %36) #4
...
48:                                               ; preds = %46, %31
  ...
  call void (ptr, i32, i32, ptr, ...) @warn_slowpath_fmt(ptr noundef nonnull @.str, i32 noundef 37, i32 noundef 9, ptr noundef nonnull @.str.1, ptr noundef %37, ptr noundef %49) #4
  br label %50
...
; Function Attrs: nounwind null_pointer_is_valid sspstrong uwtable(sync)
define dso_local i32 @gt215_sor_new(ptr noundef %0, i32 noundef %1) local_unnamed_addr #0 {
  %3 = tail call i32 @nvkm_ior_new_(ptr noundef nonnull @gt215_sor, ptr noundef %0, i32 noundef 1, i32 noundef %1) #4
  ret i32 %3
}
...
; Function Attrs: null_pointer_is_valid
declare dso_local void @g94_sor_state(ptr noundef, ptr noundef) #3
...
; Function Attrs: null_pointer_is_valid
declare dso_local void @gt215_hdmi_ctrl(ptr noundef, i32 noundef, i1 noundef zeroext, i8 noundef zeroext, i8 noundef zeroext, ptr noundef, i8 noundef zeroext, ptr noundef, i8 noundef zeroext) #3

; Function Attrs: null_pointer_is_valid
declare dso_local i32 @g94_sor_dp_links(ptr noundef, ptr noundef) #3

; Function Attrs: null_pointer_is_valid
declare dso_local void @g94_sor_dp_power(ptr noundef, i32 noundef) #3

; Function Attrs: null_pointer_is_valid
declare dso_local void @g94_sor_dp_pattern(ptr noundef, i32 noundef) #3

; Function Attrs: null_pointer_is_valid
declare dso_local void @g94_sor_dp_drive(ptr noundef, i32 noundef, i32 noundef, i32 noundef, i32 noundef, i32 noundef) #3

; Function Attrs: null_pointer_is_valid
declare dso_local void @g94_sor_dp_audio_sym(ptr noundef, i32 noundef, i16 noundef zeroext, i32 noundef) #3

; Function Attrs: null_pointer_is_valid
declare dso_local void @g94_sor_dp_activesym(ptr noundef, i32 noundef, i8 noundef zeroext, i8 noundef zeroext, i8 noundef zeroext, i8 noundef zeroext) #3

; Function Attrs: null_pointer_is_valid
declare dso_local void @g94_sor_dp_watermark(ptr noundef, i32 noundef, i8 noundef zeroext) #3

; Function Attrs: null_pointer_is_valid
declare dso_local void @gt215_hda_hpd(ptr noundef, i32 noundef, i1 noundef zeroext) #3

; Function Attrs: null_pointer_is_valid
declare dso_local void @gt215_hda_eld(ptr noundef, i32 noundef, ptr noundef, i8 noundef zeroext) #3
