; ModuleID = '/llk/IR/drivers/gpu/drm/nouveau/nvkm/engine/disp/sormcp77.c_pt.bc'
source_filename = "../drivers/gpu/drm/nouveau/nvkm/engine/disp/sormcp77.c"
...
@mcp77_sor = internal constant %struct.nvkm_ior_func { %struct.anon.131 zeroinitializer, ptr @g94_sor_state, ptr @nv50_sor_power, ptr null, ptr @nv50_sor_clock, ptr null, ptr null, %struct.anon.140 { ptr @g84_hdmi_ctrl, ptr null }, %struct.anon.141 { [4 x i8] c"\02\01\00\03", ptr @g94_sor_dp_links, ptr @g94_sor_dp_power, ptr @g94_sor_dp_pattern, ptr @g94_sor_dp_drive, ptr null, ptr null, ptr @g94_sor_dp_audio_sym, ptr @g94_sor_dp_activesym, ptr @g94_sor_dp_watermark }, %struct.anon.142 zeroinitializer }, align 4

; Function Attrs: nounwind null_pointer_is_valid sspstrong uwtable(sync)
define dso_local i32 @mcp77_sor_new(ptr noundef %0, i32 noundef %1) local_unnamed_addr #0 {
  %3 = tail call i32 @nvkm_ior_new_(ptr noundef nonnull @mcp77_sor, ptr noundef %0, i32 noundef 1, i32 noundef %1) #2
  ret i32 %3
}
...
; Function Attrs: null_pointer_is_valid
declare dso_local void @g84_hdmi_ctrl(ptr noundef, i32 noundef, i1 noundef zeroext, i8 noundef zeroext, i8 noundef zeroext, ptr noundef, i8 noundef zeroext, ptr noundef, i8 noundef zeroext) #1
