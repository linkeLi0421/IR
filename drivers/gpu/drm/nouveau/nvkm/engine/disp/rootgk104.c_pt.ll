; ModuleID = '/llk/IR/drivers/gpu/drm/nouveau/nvkm/engine/disp/rootgk104.c_pt.bc'
source_filename = "../drivers/gpu/drm/nouveau/nvkm/engine/disp/rootgk104.c"
...
@gk104_disp_root_oclass = dso_local local_unnamed_addr constant %struct.nvkm_disp_oclass { ptr @gk104_disp_root_new, %struct.nvkm_sclass { i32 -1, i32 -1, i32 37232, ptr null, ptr null } }, align 4
@gk104_disp_root = internal constant { i32, [6 x %struct.nv50_disp_user] } { i32 0, [6 x %struct.nv50_disp_user] [%struct.nv50_disp_user { %struct.nvkm_sclass { i32 0, i32 0, i32 37242, ptr null, ptr null }, ptr @gf119_disp_curs_new }, %struct.nv50_disp_user { %struct.nvkm_sclass { i32 0, i32 0, i32 37243, ptr null, ptr null }, ptr @gf119_disp_oimm_new }, %struct.nv50_disp_user { %struct.nvkm_sclass { i32 0, i32 0, i32 37244, ptr null, ptr null }, ptr @gf119_disp_base_new }, %struct.nv50_disp_user { %struct.nvkm_sclass { i32 0, i32 0, i32 37245, ptr null, ptr null }, ptr @gk104_disp_core_new }, %struct.nv50_disp_user { %struct.nvkm_sclass { i32 0, i32 0, i32 37246, ptr null, ptr null }, ptr @gk104_disp_ovly_new }, %struct.nv50_disp_user zeroinitializer] }, align 4

; Function Attrs: nounwind null_pointer_is_valid sspstrong uwtable(sync)
define internal i32 @gk104_disp_root_new(ptr noundef %0, ptr noundef %1, ptr noundef %2, i32 noundef %3, ptr noundef %4) #0 {
  %6 = tail call i32 @nv50_disp_root_new_(ptr noundef nonnull @gk104_disp_root, ptr noundef %0, ptr noundef %1, ptr noundef %2, i32 noundef %3, ptr noundef %4) #2
  ret i32 %6
}
