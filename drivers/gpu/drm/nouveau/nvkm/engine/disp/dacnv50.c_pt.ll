; ModuleID = '/llk/IR/drivers/gpu/drm/nouveau/nvkm/engine/disp/dacnv50.c_pt.bc'
...
@nv50_dac = internal constant %struct.nvkm_ior_func { %struct.anon zeroinitializer, ptr @nv50_dac_state, ptr @nv50_dac_power, ptr @nv50_dac_sense, ptr @nv50_dac_clock, ptr null, ptr null, %struct.anon.132 zeroinitializer, %struct.anon.133 zeroinitializer, %struct.anon.134 zeroinitializer }, align 4
@.str = private unnamed_addr constant [51 x i8] c"drivers/gpu/drm/nouveau/nvkm/engine/disp/dacnv50.c\00", align 1
@.str.1 = private unnamed_addr constant [16 x i8] c"%s %s: timeout\0A\00", align 1

; Function Attrs: nounwind null_pointer_is_valid sspstrong uwtable(sync)
define dso_local i32 @nv50_dac_sense(ptr noundef %0, i32 noundef %1) #0 {
  ...
  %11 = getelementptr inbounds %struct.nvkm_ior_func, ptr %10, i32 0, i32 2
  %12 = load ptr, ptr %11, align 4
  tail call void %12(ptr noundef %0, i1 noundef zeroext false, i1 noundef zeroext true, i1 noundef zeroext false, i1 noundef zeroext false, i1 noundef zeroext false) #4
  %13 = or i32 %1, 1048576
  %14 = getelementptr inbounds %struct.nvkm_device, ptr %6, i32 0, i32 11
  %15 = load ptr, ptr %14, align 4
  %16 = add i32 %9, 6397964
  %17 = getelementptr i8, ptr %15, i32 %16
  tail call void asm sideeffect "dsb st", "~{memory}"() #4, !srcloc !8
  tail call void @arm_heavy_mb() #4
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %17, i32 %13) #4, !srcloc !9
  ...
  tail call void %27(i32 noundef 107374000) #4
  ...
  %34 = getelementptr inbounds %struct.nvkm_ior_func, ptr %33, i32 0, i32 2
  %35 = load ptr, ptr %34, align 4
  tail call void %35(ptr noundef %0, i1 noundef zeroext false, i1 noundef zeroext false, i1 noundef zeroext false, i1 noundef zeroext false, i1 noundef zeroext false) #4
  %36 = icmp sgt i32 %30, -1
  %37 = lshr i32 %30, 27
  %38 = and i32 %37, 7
  %39 = select i1 %36, i32 -110, i32 %38
  ret i32 %39
}
...
; Function Attrs: nounwind null_pointer_is_valid sspstrong uwtable(sync)
define dso_local void @nv50_dac_power(ptr nocapture noundef readonly %0, i1 noundef zeroext %1, i1 noundef zeroext %2, i1 noundef zeroext %3, i1 noundef zeroext %4, i1 noundef zeroext %5) #0 {
  ...
  %15 = select i1 %2, i32 0, i32 64
  %16 = select i1 %3, i32 0, i32 16
  %17 = or i32 %16, %15
  %18 = select i1 %4, i32 0, i32 4
  %19 = or i32 %17, %18
  %20 = xor i1 %5, true
  ...
  %25 = shl nuw nsw i32 85, %14
  tail call fastcc void @nv50_dac_power_wait(ptr noundef %10, i32 noundef %13)
  %26 = add i32 %13, 6397956
  %27 = getelementptr inbounds %struct.nvkm_device, ptr %10, i32 0, i32 11
  %28 = load ptr, ptr %27, align 4
  %29 = getelementptr i8, ptr %28, i32 %26
  %30 = tail call i32 asm sideeffect "ldr $0, $1", "=r,*Qo"(ptr elementtype(i32) %29) #4, !srcloc !10
  tail call void asm sideeffect "dsb ", "~{memory}"() #4, !srcloc !11
  %31 = xor i32 %25, 1073741823
  %32 = and i32 %30, %31
  %33 = or i32 %32, %24
...
; Function Attrs: nounwind null_pointer_is_valid sspstrong uwtable(sync)
define internal fastcc void @nv50_dac_power_wait(ptr noundef %0, i32 noundef %1) unnamed_addr #0 {
...
31:                                               ; preds = %29, %14
  ...
  call void (ptr, i32, i32, ptr, ...) @warn_slowpath_fmt(ptr noundef nonnull @.str, i32 noundef 62, i32 noundef 9, ptr noundef nonnull @.str.1, ptr noundef %20, ptr noundef %32) #4
  br label %33
...
; Function Attrs: nounwind null_pointer_is_valid sspstrong uwtable(sync)
define dso_local i32 @nv50_dac_new(ptr noundef %0, i32 noundef %1) local_unnamed_addr #0 {
  %3 = tail call i32 @nvkm_ior_new_(ptr noundef nonnull @nv50_dac, ptr noundef %0, i32 noundef 0, i32 noundef %1) #4
  ret i32 %3
}
...
; Function Attrs: nounwind null_pointer_is_valid sspstrong uwtable(sync)
define dso_local i32 @nv50_dac_cnt(ptr nocapture noundef readonly %0, ptr nocapture noundef writeonly %1) local_unnamed_addr #0 {
...
; Function Attrs: nounwind null_pointer_is_valid sspstrong uwtable(sync)
define internal void @nv50_dac_state(ptr noundef readonly %0, ptr noundef %1) #0 {
  %3 = getelementptr inbounds %struct.nvkm_ior, ptr %0, i32 0, i32 1
  %4 = load ptr, ptr %3, align 4
  %5 = getelementptr inbounds %struct.nvkm_disp, ptr %4, i32 0, i32 1, i32 1, i32 1
  %6 = load ptr, ptr %5, align 4
  ...
  %14 = select i1 %11, i32 6359900, i32 6359896
  %15 = add i32 %14, %9
...
; Function Attrs: nounwind null_pointer_is_valid sspstrong uwtable(sync)
define internal void @nv50_dac_clock(ptr nocapture noundef readonly %0) #0 {
