; ModuleID = '/llk/IR/drivers/gpu/drm/nouveau/nvkm/engine/disp/hdmigm200.c_pt.bc'
source_filename = "../drivers/gpu/drm/nouveau/nvkm/engine/disp/hdmigm200.c"
...
define dso_local void @gm200_hdmi_scdc(ptr nocapture noundef %0, i8 noundef zeroext %1) local_unnamed_addr #0 {
  ...
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %20, i32 %18) #2, !srcloc !11
  %21 = getelementptr inbounds %struct.nvkm_ior, ptr %0, i32 0, i32 10
  %22 = lshr i8 %1, 1
  %23 = and i8 %22, 1
