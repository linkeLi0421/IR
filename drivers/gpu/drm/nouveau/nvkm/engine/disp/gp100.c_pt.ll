; ModuleID = '/llk/IR/drivers/gpu/drm/nouveau/nvkm/engine/disp/gp100.c_pt.bc'
source_filename = "../drivers/gpu/drm/nouveau/nvkm/engine/disp/gp100.c"
...
@gp100_disp = internal constant %struct.nv50_disp_func { ptr @gf119_disp_init, ptr @gf119_disp_fini, ptr @gf119_disp_intr, ptr @gf119_disp_intr_error, ptr @gf119_disp_chan_uevent, ptr @gf119_disp_super, ptr @gp100_disp_root_oclass, %struct.anon.134 zeroinitializer, %struct.anon.134 { ptr @gf119_head_cnt, ptr @gf119_head_new }, %struct.anon.134 zeroinitializer, %struct.anon.134 { ptr @gf119_sor_cnt, ptr @gp100_sor_new }, %struct.anon.134 zeroinitializer, i16 0 }, align 4
@gf119_disp_chan_uevent = external dso_local constant %struct.nvkm_event_func, align 4
@gp100_disp_root_oclass = external dso_local constant %struct.nvkm_disp_oclass, align 4

; Function Attrs: nounwind null_pointer_is_valid sspstrong uwtable(sync)
define dso_local i32 @gp100_disp_new(ptr noundef %0, i32 noundef %1, i32 noundef %2, ptr noundef %3) local_unnamed_addr #0 {
  %5 = tail call i32 @nv50_disp_new_(ptr noundef nonnull @gp100_disp, ptr noundef %0, i32 noundef %1, i32 noundef %2, ptr noundef %3) #2
  ret i32 %5
}
