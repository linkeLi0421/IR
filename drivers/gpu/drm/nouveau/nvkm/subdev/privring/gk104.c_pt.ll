; ModuleID = '/llk/IR/drivers/gpu/drm/nouveau/nvkm/subdev/privring/gk104.c_pt.bc'
...
@.str = private unnamed_addr constant [53 x i8] c"drivers/gpu/drm/nouveau/nvkm/subdev/privring/gk104.c\00", align 1
@.str.1 = private unnamed_addr constant [16 x i8] c"%s %s: timeout\0A\00", align 1
@gk104_privring = internal constant %struct.nvkm_subdev_func { ptr null, ptr @gk104_privring_init, ptr null, ptr null, ptr @gk104_privring_init, ptr null, ptr @gk104_privring_intr }, align 4
...
define dso_local void @gk104_privring_intr(ptr noundef %0) #0 {
...
163:                                              ; preds = %169, %155
  ...
  %165 = getelementptr i8, ptr %164, i32 1179724
...
; Function Attrs: nounwind null_pointer_is_valid sspstrong uwtable(sync)
define dso_local i32 @gk104_privring_new(ptr noundef %0, i32 noundef %1, i32 noundef %2, ptr noundef %3) local_unnamed_addr #0 {
  %5 = tail call i32 @nvkm_subdev_new_(ptr noundef nonnull @gk104_privring, ptr noundef %0, i32 noundef %1, i32 noundef %2, ptr noundef %3) #5
  ret i32 %5
}
