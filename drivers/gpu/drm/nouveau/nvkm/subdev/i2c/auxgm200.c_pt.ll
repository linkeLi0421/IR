; ModuleID = '/llk/IR/drivers/gpu/drm/nouveau/nvkm/subdev/i2c/auxgm200.c_pt.bc'
...
@gm200_i2c_aux_func = internal constant %struct.nvkm_i2c_aux_func { i8 1, ptr @gm200_i2c_aux_xfer, ptr null }, align 4
...
define dso_local i32 @gm200_i2c_aux_new(ptr noundef %0, i32 noundef %1, i8 noundef zeroext %2, ptr nocapture noundef writeonly %3) local_unnamed_addr #0 {
...
8:                                                ; preds = %4
  ...
  %9 = tail call i32 @nvkm_i2c_aux_ctor(ptr noundef nonnull @gm200_i2c_aux_func, ptr noundef %0, i32 noundef %1, ptr noundef nonnull %6) #8
  %10 = zext i8 %2 to i32
  %11 = getelementptr inbounds %struct.gm200_i2c_aux, ptr %6, i32 0, i32 1
...
; Function Attrs: nounwind null_pointer_is_valid sspstrong uwtable(sync)
define internal i32 @gm200_i2c_aux_xfer(ptr nocapture noundef readonly %0, i1 noundef zeroext %1, i8 noundef zeroext %2, i32 noundef %3, ptr nocapture noundef %4, ptr nocapture noundef %5) #0 {
  ...
  %14 = getelementptr inbounds %struct.gm200_i2c_aux, ptr %0, i32 0, i32 1
...
20:                                               ; preds = %6
  ...
  tail call void (ptr, ptr, ...) @_dev_info(ptr noundef %22, ptr noundef nonnull @.str, ptr noundef %23, i32 noundef %25, i32 noundef %26, i32 noundef %3, i32 noundef %28) #9
...
54:                                               ; preds = %47
  ...
  tail call void (ptr, ptr, ...) @_dev_err(ptr noundef %58, ptr noundef nonnull @.str.6, ptr noundef %59, i32 noundef %61, i32 noundef %44) #9
  br label %436

62:                                               ; preds = %37
  %63 = add nsw i32 %38, -1
  %64 = and i32 %44, 117506048
  %65 = icmp eq i32 %64, 0
...
94:                                               ; preds = %87
  ...
  tail call void (ptr, ptr, ...) @_dev_err(ptr noundef %98, ptr noundef nonnull @.str.7, ptr noundef %99, i32 noundef %101, i32 noundef %84) #9
...
138:                                              ; preds = %131
  ...
  tail call void (ptr, ptr, ...) @_dev_info(ptr noundef %142, ptr noundef nonnull @.str.1, ptr noundef %143, i32 noundef %145) #9
  br label %436
...
170:                                              ; preds = %157
  ...
  tail call void (ptr, ptr, ...) @_dev_info(ptr noundef %174, ptr noundef nonnull @.str.2, ptr noundef %175, i32 noundef %176, i32 noundef %177) #9
  br label %178
...
191:                                              ; preds = %178
  ...
  tail call void (ptr, ptr, ...) @_dev_info(ptr noundef %195, ptr noundef nonnull @.str.2, ptr noundef %196, i32 noundef %197, i32 noundef %199) #9
  br label %200

200:                                              ; preds = %191, %188
  %201 = phi i32 [ %190, %188 ], [ %199, %191 ]
  %202 = load ptr, ptr %124, align 4
  %203 = add i32 %16, 55604
...
214:                                              ; preds = %200
  ...
  tail call void (ptr, ptr, ...) @_dev_info(ptr noundef %218, ptr noundef nonnull @.str.2, ptr noundef %219, i32 noundef %220, i32 noundef %222) #9
  br label %223

223:                                              ; preds = %214, %211
  %224 = phi i32 [ %213, %211 ], [ %222, %214 ]
  %225 = load ptr, ptr %124, align 4
  %226 = add i32 %16, 55608
...
237:                                              ; preds = %223
  ...
  tail call void (ptr, ptr, ...) @_dev_info(ptr noundef %241, ptr noundef nonnull @.str.2, ptr noundef %242, i32 noundef %243, i32 noundef %245) #9
  br label %246

246:                                              ; preds = %237, %234
  %247 = phi i32 [ %236, %234 ], [ %245, %237 ]
  %248 = load ptr, ptr %124, align 4
  %249 = add i32 %16, 55612
...
299:                                              ; preds = %292
  ...
  tail call void (ptr, ptr, ...) @_dev_err(ptr noundef %303, ptr noundef nonnull @.str.3, ptr noundef %304, i32 noundef %305, i32 noundef %289) #9
  br label %427
...
333:                                              ; preds = %310
  ...
  tail call void (ptr, ptr, ...) @_dev_info(ptr noundef %337, ptr noundef nonnull @.str.4, ptr noundef %338, i32 noundef %339, i32 noundef %272, i32 noundef %289, i32 noundef %313) #9
  br label %340
...
358:                                              ; preds = %347
  ...
  tail call void (ptr, ptr, ...) @_dev_info(ptr noundef %362, ptr noundef nonnull @.str.5, ptr noundef %363, i32 noundef %364, i32 noundef %351) #9
  br label %365

365:                                              ; preds = %358, %347
  %366 = load ptr, ptr %124, align 4
  %367 = add i32 %16, 55620
...
377:                                              ; preds = %365
  ...
  tail call void (ptr, ptr, ...) @_dev_info(ptr noundef %381, ptr noundef nonnull @.str.5, ptr noundef %382, i32 noundef %383, i32 noundef %369) #9
  br label %384

384:                                              ; preds = %377, %365
  %385 = load ptr, ptr %124, align 4
  %386 = add i32 %16, 55624
...
396:                                              ; preds = %384
  ...
  tail call void (ptr, ptr, ...) @_dev_info(ptr noundef %400, ptr noundef nonnull @.str.5, ptr noundef %401, i32 noundef %402, i32 noundef %388) #9
  br label %403

403:                                              ; preds = %396, %384
  %404 = load ptr, ptr %124, align 4
  %405 = add i32 %16, 55628
...
415:                                              ; preds = %403
  ...
  tail call void (ptr, ptr, ...) @_dev_info(ptr noundef %419, ptr noundef nonnull @.str.5, ptr noundef %420, i32 noundef %421, i32 noundef %407) #9
  br label %422
