; ModuleID = '/llk/IR/drivers/gpu/drm/nouveau/nvkm/subdev/i2c/busgf119.c_pt.bc'
source_filename = "../drivers/gpu/drm/nouveau/nvkm/subdev/i2c/busgf119.c"
...
%struct.gf119_i2c_bus = type { %struct.nvkm_i2c_bus, i32 }
...
@gf119_i2c_bus_func = internal constant %struct.nvkm_i2c_bus_func { ptr @gf119_i2c_bus_init, ptr @gf119_i2c_bus_drive_scl, ptr @gf119_i2c_bus_drive_sda, ptr @gf119_i2c_bus_sense_scl, ptr @gf119_i2c_bus_sense_sda, ptr @nvkm_i2c_bit_xfer }, align 4
@kmalloc_caches = external dso_local local_unnamed_addr global [3 x [14 x ptr]], align 4

; Function Attrs: nounwind null_pointer_is_valid sspstrong uwtable(sync)
define dso_local i32 @gf119_i2c_bus_new(ptr noundef %0, i32 noundef %1, i8 noundef zeroext %2, ptr nocapture noundef writeonly %3) local_unnamed_addr #0 {
...
8:                                                ; preds = %4
  ...
  %9 = tail call i32 @nvkm_i2c_bus_ctor(ptr noundef nonnull @gf119_i2c_bus_func, ptr noundef %0, i32 noundef %1, ptr noundef nonnull %6) #4
  %10 = zext i8 %2 to i32
  %11 = shl nuw nsw i32 %10, 5
  %12 = add nuw nsw i32 %11, 53268
  %13 = getelementptr inbounds %struct.gf119_i2c_bus, ptr %6, i32 0, i32 1
...
; Function Attrs: nounwind null_pointer_is_valid sspstrong uwtable(sync)
define internal void @gf119_i2c_bus_init(ptr nocapture noundef readonly %0) #0 {
  ...
  %10 = getelementptr inbounds %struct.gf119_i2c_bus, ptr %0, i32 0, i32 1
...
; Function Attrs: nounwind null_pointer_is_valid sspstrong uwtable(sync)
define internal void @gf119_i2c_bus_drive_scl(ptr nocapture noundef readonly %0, i32 noundef %1) #0 {
  ...
  %9 = getelementptr inbounds %struct.gf119_i2c_bus, ptr %0, i32 0, i32 1
...
; Function Attrs: nounwind null_pointer_is_valid sspstrong uwtable(sync)
define internal void @gf119_i2c_bus_drive_sda(ptr nocapture noundef readonly %0, i32 noundef %1) #0 {
  %3 = getelementptr inbounds %struct.nvkm_i2c_bus, ptr %0, i32 0, i32 1
  %4 = load ptr, ptr %3, align 4
  %5 = getelementptr inbounds %struct.nvkm_i2c_pad, ptr %4, i32 0, i32 1
  %6 = load ptr, ptr %5, align 4
...
; Function Attrs: nounwind null_pointer_is_valid sspstrong uwtable(sync)
define internal i32 @gf119_i2c_bus_sense_scl(ptr nocapture noundef readonly %0) #0 {
  %2 = getelementptr inbounds %struct.nvkm_i2c_bus, ptr %0, i32 0, i32 1
  %3 = load ptr, ptr %2, align 4
  %4 = getelementptr inbounds %struct.nvkm_i2c_pad, ptr %3, i32 0, i32 1
  %5 = load ptr, ptr %4, align 4
...
; Function Attrs: nounwind null_pointer_is_valid sspstrong uwtable(sync)
define internal i32 @gf119_i2c_bus_sense_sda(ptr nocapture noundef readonly %0) #0 {
  %2 = getelementptr inbounds %struct.nvkm_i2c_bus, ptr %0, i32 0, i32 1
  %3 = load ptr, ptr %2, align 4
  %4 = getelementptr inbounds %struct.nvkm_i2c_pad, ptr %3, i32 0, i32 1
  %5 = load ptr, ptr %4, align 4
