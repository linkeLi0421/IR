; ModuleID = '/llk/IR/drivers/gpu/drm/nouveau/nvkm/subdev/i2c/gk104.c_pt.bc'
...
@gk104_i2c = internal constant %struct.nvkm_i2c_func { ptr @gf119_i2c_pad_x_new, ptr @gf119_i2c_pad_s_new, i32 4, ptr @gk104_aux_stat, ptr @gk104_aux_mask, ptr null }, align 4

; Function Attrs: nounwind null_pointer_is_valid sspstrong uwtable(sync)
define dso_local void @gk104_aux_stat(ptr nocapture noundef readonly %0, ptr nocapture noundef %1, ptr nocapture noundef %2, ptr nocapture noundef %3, ptr nocapture noundef %4) #0 {
  ...
  %10 = getelementptr i8, ptr %9, i32 56416
  ...
  %13 = getelementptr i8, ptr %12, i32 56424
...
53:                                               ; preds = %50
  ...
  %55 = getelementptr i8, ptr %54, i32 56416
...
; Function Attrs: nounwind null_pointer_is_valid sspstrong uwtable(sync)
define dso_local void @gk104_aux_mask(ptr nocapture noundef readonly %0, i32 noundef %1, i32 noundef %2, i32 noundef %3) #0 {
  ...
  %9 = getelementptr i8, ptr %8, i32 56424
...
112:                                              ; preds = %109, %107, %99
  ...
  %115 = getelementptr i8, ptr %114, i32 56424
  tail call void asm sideeffect "dsb st", "~{memory}"() #2, !srcloc !10
  tail call void @arm_heavy_mb() #2
...
; Function Attrs: nounwind null_pointer_is_valid sspstrong uwtable(sync)
define dso_local i32 @gk104_i2c_new(ptr noundef %0, i32 noundef %1, i32 noundef %2, ptr noundef %3) local_unnamed_addr #0 {
  %5 = tail call i32 @nvkm_i2c_new_(ptr noundef nonnull @gk104_i2c, ptr noundef %0, i32 noundef %1, i32 noundef %2, ptr noundef %3) #2
  ret i32 %5
}
