; ModuleID = '/llk/IR/drivers/gpu/drm/nouveau/nvkm/subdev/pci/nv40.c_pt.bc'
source_filename = "../drivers/gpu/drm/nouveau/nvkm/subdev/pci/nv40.c"
...
@nv40_pci_func = internal constant %struct.nvkm_pci_func { ptr null, ptr @nv40_pci_rd32, ptr @nv40_pci_wr08, ptr @nv40_pci_wr32, ptr @nv40_pci_msi_rearm, %struct.anon zeroinitializer }, align 4

; Function Attrs: nounwind null_pointer_is_valid sspstrong uwtable(sync)
define dso_local i32 @nv40_pci_rd32(ptr nocapture noundef readonly %0, i16 noundef zeroext %1) #0 {
...
; Function Attrs: nounwind null_pointer_is_valid sspstrong uwtable(sync)
define dso_local void @nv40_pci_wr08(ptr nocapture noundef readonly %0, i16 noundef zeroext %1, i8 noundef zeroext %2) #0 {
...
; Function Attrs: nounwind null_pointer_is_valid sspstrong uwtable(sync)
define dso_local void @nv40_pci_wr32(ptr nocapture noundef readonly %0, i16 noundef zeroext %1, i32 noundef %2) #0 {
  %4 = getelementptr inbounds %struct.nvkm_pci, ptr %0, i32 0, i32 1, i32 1
  %5 = load ptr, ptr %4, align 4
  %6 = getelementptr inbounds %struct.nvkm_device, ptr %5, i32 0, i32 11
  %7 = load ptr, ptr %6, align 4
  ...
  tail call void @arm_heavy_mb() #2
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %10, i32 %2) #2, !srcloc !13
  ret void
}

; Function Attrs: nounwind null_pointer_is_valid sspstrong uwtable(sync)
define dso_local void @nv40_pci_msi_rearm(ptr noundef %0) #0 {
  tail call void @nvkm_pci_wr08(ptr noundef %0, i16 noundef zeroext 104, i8 noundef zeroext -1) #2
  ret void
}
...
; Function Attrs: nounwind null_pointer_is_valid sspstrong uwtable(sync)
define dso_local i32 @nv40_pci_new(ptr noundef %0, i32 noundef %1, i32 noundef %2, ptr noundef %3) local_unnamed_addr #0 {
  %5 = tail call i32 @nvkm_pci_new_(ptr noundef nonnull @nv40_pci_func, ptr noundef %0, i32 noundef %1, i32 noundef %2, ptr noundef %3) #2
  ret i32 %5
}
