; ModuleID = '/llk/IR/drivers/gpu/drm/nouveau/nvkm/subdev/pci/gf106.c_pt.bc'
source_filename = "../drivers/gpu/drm/nouveau/nvkm/subdev/pci/gf106.c"
...
@gf106_pci_func = internal constant %struct.nvkm_pci_func { ptr @g84_pci_init, ptr @nv40_pci_rd32, ptr @nv40_pci_wr08, ptr @nv40_pci_wr32, ptr @nv40_pci_msi_rearm, %struct.anon.120 { ptr @gf100_pcie_init, ptr @gf100_pcie_set_link, ptr @g84_pcie_max_speed, ptr @g84_pcie_cur_speed, ptr @gf100_pcie_set_version, ptr @gf100_pcie_version, ptr @g92_pcie_version_supported } }, align 4

; Function Attrs: nounwind null_pointer_is_valid sspstrong uwtable(sync)
define dso_local i32 @gf106_pci_new(ptr noundef %0, i32 noundef %1, i32 noundef %2, ptr noundef %3) local_unnamed_addr #0 {
  %5 = tail call i32 @nvkm_pci_new_(ptr noundef nonnull @gf106_pci_func, ptr noundef %0, i32 noundef %1, i32 noundef %2, ptr noundef %3) #2
  ret i32 %5
}
...
; Function Attrs: null_pointer_is_valid
declare dso_local i32 @gf100_pcie_init(ptr noundef) #1

; Function Attrs: null_pointer_is_valid
declare dso_local i32 @gf100_pcie_set_link(ptr noundef, i32 noundef, i8 noundef zeroext) #1
