; ModuleID = '/llk/IR/drivers/gpu/drm/nouveau/nvkm/subdev/mmu/g84.c_pt.bc'
...
@g84_mmu = internal constant %struct.nvkm_mmu_func { ptr null, i8 40, %struct.anon.120 { %struct.nvkm_sclass { i32 -1, i32 -1, i32 -2147463159, ptr null, ptr null } }, %struct.anon.121 { %struct.nvkm_sclass { i32 -1, i32 0, i32 -2147463157, ptr null, ptr null }, ptr @nv50_mem_new, ptr @nv50_mem_map }, %struct.anon.123 { %struct.nvkm_sclass { i32 -1, i32 -1, i32 -2147463155, ptr null, ptr null }, ptr @nv50_vmm_new, i8 0, i32 512 }, ptr @nv50_mmu_kind, i8 1 }, align 4

; Function Attrs: nounwind null_pointer_is_valid sspstrong uwtable(sync)
define dso_local i32 @g84_mmu_new(ptr noundef %0, i32 noundef %1, i32 noundef %2, ptr noundef %3) local_unnamed_addr #0 {
  %5 = tail call i32 @nvkm_mmu_new_(ptr noundef nonnull @g84_mmu, ptr noundef %0, i32 noundef %1, i32 noundef %2, ptr noundef %3) #2
  ret i32 %5
}
