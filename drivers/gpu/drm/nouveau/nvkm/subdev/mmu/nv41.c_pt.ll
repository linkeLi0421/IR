; ModuleID = '/llk/IR/drivers/gpu/drm/nouveau/nvkm/subdev/mmu/nv41.c_pt.bc'
...
@nv41_mmu = internal constant %struct.nvkm_mmu_func { ptr @nv41_mmu_init, i8 39, %struct.anon.120 { %struct.nvkm_sclass { i32 -1, i32 -1, i32 -2147483639, ptr null, ptr null } }, %struct.anon.121 { %struct.nvkm_sclass { i32 -1, i32 -1, i32 -2147483637, ptr null, ptr null }, ptr @nv04_mem_new, ptr @nv04_mem_map }, %struct.anon.123 { %struct.nvkm_sclass { i32 -1, i32 -1, i32 -2147483635, ptr null, ptr null }, ptr @nv41_vmm_new, i8 1, i32 0 }, ptr null, i8 0 }, align 4

; Function Attrs: nounwind null_pointer_is_valid sspstrong uwtable(sync)
define dso_local i32 @nv41_mmu_new(ptr noundef %0, i32 noundef %1, i32 noundef %2, ptr noundef %3) local_unnamed_addr #0 {
...
14:                                               ; preds = %8
  %15 = tail call i32 @nvkm_mmu_new_(ptr noundef nonnull @nv41_mmu, ptr noundef %0, i32 noundef %1, i32 noundef %2, ptr noundef %3) #2
  br label %16
...
; Function Attrs: nounwind null_pointer_is_valid sspstrong uwtable(sync)
define internal void @nv41_mmu_init(ptr nocapture noundef readonly %0) #0 {
  ...
  %9 = getelementptr inbounds %struct.nvkm_mmu_pt, ptr %8, i32 0, i32 4
  %10 = load i64, ptr %9, align 8
  %11 = trunc i64 %10 to i32
  %12 = or i32 %11, 2
  %13 = getelementptr inbounds %struct.nvkm_device, ptr %3, i32 0, i32 11
  %14 = load ptr, ptr %13, align 4
  %15 = getelementptr i8, ptr %14, i32 1050624
  ...
  %17 = getelementptr i8, ptr %16, i32 1048716
  ...
  %21 = getelementptr i8, ptr %20, i32 1048716
  tail call void asm sideeffect "dsb st", "~{memory}"() #2, !srcloc !8
  tail call void @arm_heavy_mb() #2
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %21, i32 %19) #2, !srcloc !9
  %22 = load ptr, ptr %13, align 4
  %23 = getelementptr i8, ptr %22, i32 1050656
  tail call void asm sideeffect "dsb st", "~{memory}"() #2, !srcloc !8
  tail call void @arm_heavy_mb() #2
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %23, i32 0) #2, !srcloc !9
  ret void
}
