; ModuleID = '/llk/IR/drivers/gpu/drm/nouveau/nvkm/subdev/gpio/gk104.c_pt.bc'
source_filename = "../drivers/gpu/drm/nouveau/nvkm/subdev/gpio/gk104.c"
...
@gk104_gpio = internal constant %struct.nvkm_gpio_func { i32 32, ptr @gk104_gpio_intr_stat, ptr @gk104_gpio_intr_mask, ptr @gf119_gpio_drive, ptr @gf119_gpio_sense, ptr @gf119_gpio_reset }, align 4

; Function Attrs: nounwind null_pointer_is_valid sspstrong uwtable(sync)
define dso_local i32 @gk104_gpio_new(ptr noundef %0, i32 noundef %1, i32 noundef %2, ptr noundef %3) local_unnamed_addr #0 {
  %5 = tail call i32 @nvkm_gpio_new_(ptr noundef nonnull @gk104_gpio, ptr noundef %0, i32 noundef %1, i32 noundef %2, ptr noundef %3) #2
  ret i32 %5
}
...
; Function Attrs: nounwind null_pointer_is_valid sspstrong uwtable(sync)
define internal void @gk104_gpio_intr_stat(ptr nocapture noundef readonly %0, ptr nocapture noundef writeonly %1, ptr nocapture noundef writeonly %2) #0 {
  ...
  %8 = getelementptr i8, ptr %7, i32 56320
  ...
  %28 = getelementptr i8, ptr %27, i32 56320
  ...
  %30 = getelementptr i8, ptr %29, i32 56448
  tail call void asm sideeffect "dsb st", "~{memory}"() #2, !srcloc !10
  tail call void @arm_heavy_mb() #2
...
; Function Attrs: nounwind null_pointer_is_valid sspstrong uwtable(sync)
define internal void @gk104_gpio_intr_mask(ptr nocapture noundef readonly %0, i32 noundef %1, i32 noundef %2, i32 noundef %3) #0 {
...
; Function Attrs: null_pointer_is_valid
declare dso_local i32 @gf119_gpio_drive(ptr noundef, i32 noundef, i32 noundef, i32 noundef) #1

; Function Attrs: null_pointer_is_valid
declare dso_local i32 @gf119_gpio_sense(ptr noundef, i32 noundef) #1

; Function Attrs: null_pointer_is_valid
declare dso_local void @gf119_gpio_reset(ptr noundef, i8 noundef zeroext) #1
