; ModuleID = '/llk/IR/drivers/gpu/drm/nouveau/nvkm/subdev/fb/ramnv10.c_pt.bc'
source_filename = "../drivers/gpu/drm/nouveau/nvkm/subdev/fb/ramnv10.c"
...
define dso_local i32 @nv10_ram_new(ptr noundef %0, ptr noundef %1) local_unnamed_addr #0 {
  ...
  %10 = getelementptr i8, ptr %9, i32 1049088
  %11 = tail call i32 asm sideeffect "ldr $0, $1", "=r,*Qo"(ptr elementtype(i32) %10) #2, !srcloc !8
  tail call void asm sideeffect "dsb ", "~{memory}"() #2, !srcloc !9
  %12 = and i32 %11, 1
  %13 = icmp eq i32 %12, 0
  %14 = select i1 %13, i32 3, i32 4
  %15 = and i32 %8, -16777216
  %16 = zext i32 %15 to i64
  %17 = tail call i32 @nvkm_ram_new_(ptr noundef nonnull @nv04_ram_func, ptr noundef %0, i32 noundef %14, i64 noundef %16, ptr noundef %1) #2
  ret i32 %17
}
