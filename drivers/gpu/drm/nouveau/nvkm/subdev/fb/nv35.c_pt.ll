; ModuleID = '/llk/IR/drivers/gpu/drm/nouveau/nvkm/subdev/fb/nv35.c_pt.bc'
source_filename = "../drivers/gpu/drm/nouveau/nvkm/subdev/fb/nv35.c"
...
@nv35_fb = internal constant %struct.nvkm_fb_func { ptr null, ptr @nv20_fb_tags, ptr null, ptr @nv30_fb_init, ptr null, ptr null, ptr null, ptr null, %struct.anon.123 zeroinitializer, %struct.anon.124 { i32 8, ptr @nv30_fb_tile_init, ptr @nv35_fb_tile_comp, ptr @nv20_fb_tile_fini, ptr @nv20_fb_tile_prog }, ptr @nv20_ram_new, i8 0, ptr null }, align 4

; Function Attrs: nounwind null_pointer_is_valid sspstrong uwtable(sync)
define dso_local i32 @nv35_fb_new(ptr noundef %0, i32 noundef %1, i32 noundef %2, ptr noundef %3) local_unnamed_addr #0 {
  %5 = tail call i32 @nvkm_fb_new_(ptr noundef nonnull @nv35_fb, ptr noundef %0, i32 noundef %1, i32 noundef %2, ptr noundef %3) #2
  ret i32 %5
}
...
; Function Attrs: nounwind null_pointer_is_valid sspstrong uwtable(sync)
define internal void @nv35_fb_tile_comp(ptr noundef %0, i32 noundef %1, i32 noundef %2, i32 noundef %3, ptr noundef %4) #0 {
  %6 = add i32 %2, 63
  %7 = lshr i32 %6, 6
...
19:                                               ; preds = %5
  ...
  %24 = select i1 %21, i32 134217728, i32 67108864
  %25 = or i32 %23, %24
