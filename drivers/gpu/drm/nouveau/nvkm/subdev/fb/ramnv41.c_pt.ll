; ModuleID = '/llk/IR/drivers/gpu/drm/nouveau/nvkm/subdev/fb/ramnv41.c_pt.bc'
...
define dso_local i32 @nv41_ram_new(ptr noundef %0, ptr noundef %1) local_unnamed_addr #0 {
  ...
  %11 = getelementptr i8, ptr %10, i32 1049716
  ...
  %15 = and i32 %12, 2
  %16 = icmp eq i32 %15, 0
  %17 = select i1 %16, i32 %14, i32 5
  %18 = and i32 %12, 1
  %19 = icmp eq i32 %18, 0
  %20 = select i1 %19, i32 %17, i32 4
  %21 = zext i32 %9 to i64
  %22 = tail call i32 @nv40_ram_new_(ptr noundef %0, i32 noundef %20, i64 noundef %21, ptr noundef %1) #2
  %23 = icmp eq i32 %22, 0
...
24:                                               ; preds = %2
  ...
  %27 = tail call i32 asm sideeffect "ldr $0, $1", "=r,*Qo"(ptr elementtype(i32) %26) #2, !srcloc !8
  tail call void asm sideeffect "dsb ", "~{memory}"() #2, !srcloc !9
  %28 = and i32 %27, 3
