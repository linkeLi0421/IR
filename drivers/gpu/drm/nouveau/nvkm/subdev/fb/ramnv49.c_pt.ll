; ModuleID = '/llk/IR/drivers/gpu/drm/nouveau/nvkm/subdev/fb/ramnv49.c_pt.bc'
source_filename = "../drivers/gpu/drm/nouveau/nvkm/subdev/fb/ramnv49.c"
...
@switch.table.nv49_ram_new = private unnamed_addr constant [3 x i32] [i32 4, i32 5, i32 8], align 4

; Function Attrs: nounwind null_pointer_is_valid sspstrong uwtable(sync)
define dso_local i32 @nv49_ram_new(ptr noundef %0, ptr noundef %1) local_unnamed_addr #0 {
  ...
  %7 = getelementptr i8, ptr %6, i32 1049100
  ...
  %11 = getelementptr i8, ptr %10, i32 1050900
...
15:                                               ; preds = %2
  %16 = getelementptr inbounds [3 x i32], ptr @switch.table.nv49_ram_new, i32 0, i32 %13
...
18:                                               ; preds = %15, %2
  ...
  %21 = tail call i32 @nv40_ram_new_(ptr noundef %0, i32 noundef %19, i64 noundef %20, ptr noundef %1) #2
  %22 = icmp eq i32 %21, 0
  br i1 %22, label %23, label %31

23:                                               ; preds = %18
  %24 = load ptr, ptr %5, align 4
  %25 = getelementptr i8, ptr %24, i32 1049088
  %26 = tail call i32 asm sideeffect "ldr $0, $1", "=r,*Qo"(ptr elementtype(i32) %25) #2, !srcloc !8
  tail call void asm sideeffect "dsb ", "~{memory}"() #2, !srcloc !9
  %27 = and i32 %26, 3
  %28 = add nuw nsw i32 %27, 1
  %29 = load ptr, ptr %1, align 4
  %30 = getelementptr inbounds %struct.nvkm_ram, ptr %29, i32 0, i32 8
