; ModuleID = '/llk/IR/drivers/gpu/drm/nouveau/nvkm/subdev/fb/gk110.c_pt.bc'
...
@gk110_fb = internal constant %struct.nvkm_fb_func { ptr @gf100_fb_dtor, ptr null, ptr @gf100_fb_oneinit, ptr @gf100_fb_init, ptr null, ptr @gf100_fb_init_page, ptr null, ptr @gf100_fb_intr, %struct.anon.123 zeroinitializer, %struct.anon.124 zeroinitializer, ptr @gk104_ram_new, i8 17, ptr @gk110_fb_clkgate_pack }, align 4
@gk110_fb_clkgate_pack = internal constant [5 x %struct.nvkm_therm_clkgate_pack] [%struct.nvkm_therm_clkgate_pack { ptr @gk110_fb_clkgate_blcg_init_unk_0 }, %struct.nvkm_therm_clkgate_pack { ptr @gk104_fb_clkgate_blcg_init_vm_0 }, %struct.nvkm_therm_clkgate_pack { ptr @gk104_fb_clkgate_blcg_init_main_0 }, %struct.nvkm_therm_clkgate_pack { ptr @gk104_fb_clkgate_blcg_init_bcast_0 }, %struct.nvkm_therm_clkgate_pack zeroinitializer], align 4
@gk110_fb_clkgate_blcg_init_unk_0 = internal constant [6 x %struct.nvkm_therm_clkgate_init] [%struct.nvkm_therm_clkgate_init { i32 1051920, i8 1, i32 49730 }, %struct.nvkm_therm_clkgate_init { i32 1051952, i8 1, i32 49730 }, %struct.nvkm_therm_clkgate_init { i32 1051964, i8 1, i32 578 }, %struct.nvkm_therm_clkgate_init { i32 1051976, i8 1, i32 49730 }, %struct.nvkm_therm_clkgate_init { i32 1051932, i8 1, i32 66 }, %struct.nvkm_therm_clkgate_init zeroinitializer], align 4
...
define dso_local i32 @gk110_fb_new(ptr noundef %0, i32 noundef %1, i32 noundef %2, ptr noundef %3) local_unnamed_addr #0 {
  %5 = tail call i32 @gf100_fb_new_(ptr noundef nonnull @gk110_fb, ptr noundef %0, i32 noundef %1, i32 noundef %2, ptr noundef %3) #2
  ret i32 %5
}
