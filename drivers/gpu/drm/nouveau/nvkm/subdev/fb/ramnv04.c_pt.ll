; ModuleID = '/llk/IR/drivers/gpu/drm/nouveau/nvkm/subdev/fb/ramnv04.c_pt.bc'
...
@nv04_ram_func = dso_local constant %struct.nvkm_ram_func zeroinitializer, align 8

; Function Attrs: nounwind null_pointer_is_valid sspstrong uwtable(sync)
define dso_local i32 @nv04_ram_new(ptr noundef %0, ptr noundef %1) local_unnamed_addr #0 {
  ...
  %7 = getelementptr i8, ptr %6, i32 1048576
...
11:                                               ; preds = %2
  %12 = shl i32 %8, 9
  %13 = and i32 %12, 31457280
  %14 = add nuw nsw i32 %13, 2097152
...
22:                                               ; preds = %20, %19, %18, %16, %11
  %23 = phi i64 [ %15, %11 ], [ 4194304, %20 ], [ 8388608, %19 ], [ 16777216, %18 ], [ 33554432, %16 ]
  %24 = and i32 %8, 56
  %25 = icmp ult i32 %24, 17
  %26 = select i1 %25, i32 2, i32 3
  %27 = tail call i32 @nvkm_ram_new_(ptr noundef nonnull @nv04_ram_func, ptr noundef %0, i32 noundef %26, i64 noundef %23, ptr noundef %1) #2
  ret i32 %27
}
