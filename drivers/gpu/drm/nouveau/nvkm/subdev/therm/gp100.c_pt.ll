; ModuleID = '/llk/IR/drivers/gpu/drm/nouveau/nvkm/subdev/therm/gp100.c_pt.bc'
source_filename = "../drivers/gpu/drm/nouveau/nvkm/subdev/therm/gp100.c"
...
@gp100_therm = internal constant %struct.nvkm_therm_func { ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr @gp100_temp_get, ptr null, ptr @nvkm_therm_program_alarms_polling, ptr null, ptr null, ptr null }, align 4
@.str = private unnamed_addr constant [46 x i8] c"%s: reading temperature from SHADOWed sensor\0A\00", align 1

; Function Attrs: nounwind null_pointer_is_valid sspstrong uwtable(sync)
define dso_local i32 @gp100_therm_new(ptr noundef %0, i32 noundef %1, i32 noundef %2, ptr noundef %3) local_unnamed_addr #0 {
  %5 = tail call i32 @nvkm_therm_new_(ptr noundef nonnull @gp100_therm, ptr noundef %0, i32 noundef %1, i32 noundef %2, ptr noundef %3) #3
  ret i32 %5
}
...
10:                                               ; preds = %1
  %11 = getelementptr inbounds %struct.nvkm_therm, ptr %0, i32 0, i32 1, i32 5
...
14:                                               ; preds = %10
  ...
  %18 = getelementptr inbounds %struct.nvkm_therm, ptr %0, i32 0, i32 1, i32 4
  tail call void (ptr, ptr, ...) @_dev_info(ptr noundef %17, ptr noundef nonnull @.str, ptr noundef %18) #4
  br label %19

19:                                               ; preds = %14, %10, %1
  %20 = and i32 %7, 536870912
  %21 = icmp eq i32 %20, 0
  %22 = lshr i32 %7, 8
  %23 = and i32 %22, 511
