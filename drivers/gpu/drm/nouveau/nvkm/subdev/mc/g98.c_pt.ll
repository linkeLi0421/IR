; ModuleID = '/llk/IR/drivers/gpu/drm/nouveau/nvkm/subdev/mc/g98.c_pt.bc'
source_filename = "../drivers/gpu/drm/nouveau/nvkm/subdev/mc/g98.c"
...
@g98_mc = internal constant %struct.nvkm_mc_func { ptr @nv50_mc_init, ptr @g98_mc_intr, ptr @nv04_mc_intr_unarm, ptr @nv04_mc_intr_rearm, ptr null, ptr @nv04_mc_intr_stat, ptr @g98_mc_reset, ptr null }, align 4
@g98_mc_intr = internal constant [13 x %struct.nvkm_mc_map] [%struct.nvkm_mc_map { i32 67108864, i32 30, i32 0, i8 0 }, %struct.nvkm_mc_map { i32 131072, i32 38, i32 0, i8 0 }, %struct.nvkm_mc_map { i32 32768, i32 40, i32 0, i8 0 }, %struct.nvkm_mc_map { i32 16384, i32 46, i32 0, i8 0 }, %struct.nvkm_mc_map { i32 4096, i32 33, i32 0, i8 0 }, %struct.nvkm_mc_map { i32 256, i32 32, i32 0, i8 0 }, %struct.nvkm_mc_map { i32 1, i32 39, i32 0, i8 0 }, %struct.nvkm_mc_map { i32 184577, i32 13, i32 0, i8 0 }, %struct.nvkm_mc_map { i32 268435456, i32 10, i32 0, i8 0 }, %struct.nvkm_mc_map { i32 2097152, i32 5, i32 0, i8 0 }, %struct.nvkm_mc_map { i32 2097152, i32 6, i32 0, i8 0 }, %struct.nvkm_mc_map { i32 1048576, i32 11, i32 0, i8 0 }, %struct.nvkm_mc_map zeroinitializer], align 4
@g98_mc_reset = internal constant [7 x %struct.nvkm_mc_map] [%struct.nvkm_mc_map { i32 67141632, i32 40, i32 0, i8 0 }, %struct.nvkm_mc_map { i32 33570816, i32 46, i32 0, i8 0 }, %struct.nvkm_mc_map { i32 16908288, i32 38, i32 0, i8 0 }, %struct.nvkm_mc_map { i32 4194306, i32 39, i32 0, i8 0 }, %struct.nvkm_mc_map { i32 2101248, i32 33, i32 0, i8 0 }, %struct.nvkm_mc_map { i32 256, i32 32, i32 0, i8 0 }, %struct.nvkm_mc_map zeroinitializer], align 4

; Function Attrs: nounwind null_pointer_is_valid sspstrong uwtable(sync)
define dso_local i32 @g98_mc_new(ptr noundef %0, i32 noundef %1, i32 noundef %2, ptr noundef %3) local_unnamed_addr #0 {
  %5 = tail call i32 @nvkm_mc_new_(ptr noundef nonnull @g98_mc, ptr noundef %0, i32 noundef %1, i32 noundef %2, ptr noundef %3) #2
  ret i32 %5
}
