; ModuleID = '/llk/IR/drivers/gpu/drm/nouveau/nvkm/subdev/devinit/g84.c_pt.bc'
source_filename = "../drivers/gpu/drm/nouveau/nvkm/subdev/devinit/g84.c"
...
@g84_devinit = internal constant %struct.nvkm_devinit_func { ptr null, ptr @nv50_devinit_preinit, ptr @nv50_devinit_init, ptr @nv04_devinit_post, ptr null, ptr null, ptr @nv50_devinit_pll_set, ptr @g84_devinit_disable }, align 4

; Function Attrs: nounwind null_pointer_is_valid sspstrong uwtable(sync)
define dso_local i32 @g84_devinit_new(ptr noundef %0, i32 noundef %1, i32 noundef %2, ptr noundef %3) local_unnamed_addr #0 {
  %5 = tail call i32 @nv50_devinit_new_(ptr noundef nonnull @g84_devinit, ptr noundef %0, i32 noundef %1, i32 noundef %2, ptr noundef %3) #2
  ret i32 %5
}
...
; Function Attrs: null_pointer_is_valid
declare dso_local i32 @nv50_devinit_pll_set(ptr noundef, i32 noundef, i32 noundef) #1

; Function Attrs: nounwind null_pointer_is_valid sspstrong uwtable(sync)
define internal i64 @g84_devinit_disable(ptr nocapture noundef readonly %0) #0 {
...
13:                                               ; preds = %1
  tail call void @nvkm_subdev_disable(ptr noundef %3, i32 noundef 36, i32 noundef 0) #2
  tail call void @nvkm_subdev_disable(ptr noundef %3, i32 noundef 50, i32 noundef 0) #2
  tail call void @nvkm_subdev_disable(ptr noundef %3, i32 noundef 27, i32 noundef 0) #2
  tail call void @nvkm_subdev_disable(ptr noundef %3, i32 noundef 29, i32 noundef 0) #2
  br label %14
