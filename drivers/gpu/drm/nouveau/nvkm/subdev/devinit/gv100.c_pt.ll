; ModuleID = '/llk/IR/drivers/gpu/drm/nouveau/nvkm/subdev/devinit/gv100.c_pt.bc'
...
@gv100_devinit = internal constant %struct.nvkm_devinit_func { ptr null, ptr @gf100_devinit_preinit, ptr @nv50_devinit_init, ptr @gm200_devinit_post, ptr null, ptr null, ptr @gv100_devinit_pll_set, ptr @gm107_devinit_disable }, align 4
@.str = private unnamed_addr constant [30 x i8] c"%s: %08x/%dKhz unimplemented\0A\00", align 1

; Function Attrs: nounwind null_pointer_is_valid sspstrong uwtable(sync)
define dso_local i32 @gv100_devinit_new(ptr noundef %0, i32 noundef %1, i32 noundef %2, ptr noundef %3) local_unnamed_addr #0 {
  %5 = tail call i32 @nv50_devinit_new_(ptr noundef nonnull @gv100_devinit, ptr noundef %0, i32 noundef %1, i32 noundef %2, ptr noundef %3) #5
  ret i32 %5
}
...
; Function Attrs: nounwind null_pointer_is_valid sspstrong uwtable(sync)
define internal i32 @gv100_devinit_pll_set(ptr noundef %0, i32 noundef %1, i32 noundef %2) #0 {
...
41:                                               ; preds = %19
  %42 = getelementptr inbounds %struct.nvkm_devinit, ptr %0, i32 0, i32 1, i32 5
...
45:                                               ; preds = %41
  ...
  %49 = getelementptr inbounds %struct.nvkm_devinit, ptr %0, i32 0, i32 1, i32 4
  call void (ptr, ptr, ...) @_dev_notice(ptr noundef %48, ptr noundef nonnull @.str, ptr noundef %49, i32 noundef %1, i32 noundef %2) #6
  br label %50

50:                                               ; preds = %45, %41, %23, %15, %3
  %51 = phi i32 [ %13, %3 ], [ %17, %15 ], [ %17, %23 ], [ -22, %45 ], [ -22, %41 ]
