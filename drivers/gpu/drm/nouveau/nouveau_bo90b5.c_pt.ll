; ModuleID = '/llk/IR/drivers/gpu/drm/nouveau/nouveau_bo90b5.c_pt.bc'
...
define dso_local i32 @nvc0_bo_move_copy(ptr nocapture noundef readonly %0, ptr nocapture noundef readnone %1, ptr nocapture noundef readonly %2, ptr nocapture noundef readonly %3) local_unnamed_addr #0 {
...
17:                                               ; preds = %31, %10
  %18 = phi i64 [ %14, %10 ], [ %62, %31 ]
  %19 = phi i64 [ %12, %10 ], [ %63, %31 ]
  %20 = phi i32 [ %8, %10 ], [ %59, %31 ]
...
25:                                               ; preds = %17
  ...
  %27 = tail call i32 %26(ptr noundef %6, i32 noundef 10) #2
  %28 = icmp eq i32 %27, 0
...
31:                                               ; preds = %29, %17
  ...
  store i32 537428163, ptr %32, align 4
  %35 = lshr i64 %18, 32
  ...
  store i32 -2129624896, ptr %57, align 4
  %59 = sub i32 %20, %33
  %60 = shl nuw nsw i32 %33, 12
