; ModuleID = '/llk/IR/drivers/gpu/drm/nouveau/dispnv50/curs.c_pt.bc'
source_filename = "../drivers/gpu/drm/nouveau/dispnv50/curs.c"
...
@__const.nv50_curs_new.curses = private unnamed_addr constant [9 x %struct.anon.128] [%struct.anon.128 { i32 50810, i32 0, ptr @cursc37a_new }, %struct.anon.128 { i32 50554, i32 0, ptr @cursc37a_new }, %struct.anon.128 { i32 50042, i32 0, ptr @cursc37a_new }, %struct.anon.128 { i32 37242, i32 0, ptr @curs907a_new }, %struct.anon.128 { i32 36986, i32 0, ptr @curs907a_new }, %struct.anon.128 { i32 34170, i32 0, ptr @curs507a_new }, %struct.anon.128 { i32 33402, i32 0, ptr @curs507a_new }, %struct.anon.128 { i32 20602, i32 0, ptr @curs507a_new }, %struct.anon.128 zeroinitializer], align 4
@.str = private unnamed_addr constant [41 x i8] c"%s: No supported cursor immediate class\0A\00", align 1

; Function Attrs: nounwind null_pointer_is_valid sspstrong uwtable(sync)
define dso_local i32 @nv50_curs_new(ptr noundef %0, i32 noundef %1, ptr noundef %2) local_unnamed_addr #0 {
...
19:                                               ; preds = %42, %15
  %20 = phi i32 [ 50810, %15 ], [ %45, %42 ]
  %21 = phi i32 [ 0, %15 ], [ %43, %42 ]
  br i1 %16, label %42, label %22

22:                                               ; preds = %19
  %23 = getelementptr %struct.anon.128, ptr @__const.nv50_curs_new.curses, i32 %21, i32 1
  br label %25
...
42:                                               ; preds = %39, %19
  ...
  %44 = getelementptr %struct.anon.128, ptr @__const.nv50_curs_new.curses, i32 %43
...
55:                                               ; preds = %35
  call void @nvif_object_sclass_put(ptr noundef nonnull %4) #4
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %4) #4
  %56 = getelementptr [9 x %struct.anon.128], ptr @__const.nv50_curs_new.curses, i32 0, i32 %21
  %57 = getelementptr [9 x %struct.anon.128], ptr @__const.nv50_curs_new.curses, i32 0, i32 %21, i32 2
...
declare dso_local i32 @cursc37a_new(ptr noundef, i32 noundef, i32 noundef, ptr noundef) #2

; Function Attrs: null_pointer_is_valid
declare dso_local i32 @curs907a_new(ptr noundef, i32 noundef, i32 noundef, ptr noundef) #2

; Function Attrs: null_pointer_is_valid
declare dso_local i32 @curs507a_new(ptr noundef, i32 noundef, i32 noundef, ptr noundef) #2
