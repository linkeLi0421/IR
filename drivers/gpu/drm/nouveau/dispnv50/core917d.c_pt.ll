; ModuleID = '/llk/IR/drivers/gpu/drm/nouveau/dispnv50/core917d.c_pt.bc'
source_filename = "../drivers/gpu/drm/nouveau/dispnv50/core917d.c"
...
@core917d = internal constant %struct.nv50_core_func { ptr @core507d_init, ptr @core507d_ntfy_init, ptr @core907d_caps_init, ptr @core507d_ntfy_wait_done, ptr @core507d_update, %struct.anon.102 zeroinitializer, ptr @head917d, ptr @crc907d, ptr @dac907d, ptr null, ptr @sor907d }, align 4
@head917d = external dso_local constant %struct.nv50_head_func, align 4
...
define dso_local i32 @core917d_new(ptr noundef %0, i32 noundef %1, ptr noundef %2) local_unnamed_addr #0 {
  %4 = tail call i32 @core507d_new_(ptr noundef nonnull @core917d, ptr noundef %0, i32 noundef %1, ptr noundef %2) #2
  ret i32 %4
}
...
; Function Attrs: null_pointer_is_valid
declare dso_local i32 @core907d_caps_init(ptr noundef, ptr noundef) #1
