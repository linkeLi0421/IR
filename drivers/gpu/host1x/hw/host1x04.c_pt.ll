; ModuleID = '/llk/IR/drivers/gpu/host1x/hw/host1x04.c_pt.bc'
source_filename = "../drivers/gpu/host1x/hw/host1x04.c"
...
define dso_local i32 @host1x04_init(ptr nocapture noundef writeonly %0) local_unnamed_addr #0 {
...
52:                                               ; preds = %48
  tail call void @host1x_ch_writel(ptr noundef %3, i32 noundef 4, i32 noundef 152) #11
...
110:                                              ; preds = %103
  ...
  %121 = shl i32 %120, 6
  tail call void @host1x_cdma_push_wide(ptr noundef %97, i32 noundef 5111877, i32 noundef %117, i32 noundef %118, i32 noundef %121) #11
  br label %182

122:                                              ; preds = %103
  %123 = getelementptr inbounds %struct.host1x_job_gather, ptr %109, i32 0, i32 1
  %124 = load i32, ptr %123, align 4
  %125 = getelementptr inbounds %struct.host1x_job_gather, ptr %109, i32 0, i32 3
  %126 = load i32, ptr %125, align 4
  %127 = getelementptr inbounds %struct.host1x_job_gather, ptr %109, i32 0, i32 2
  %128 = load ptr, ptr %127, align 4
  %129 = load i32, ptr %109, align 4
  %130 = load ptr, ptr %102, align 4
  %131 = load i32, ptr @host1x_debug_trace_cmdbuf, align 4
  %132 = icmp eq i32 %131, 0
  br i1 %132, label %178, label %133

133:                                              ; preds = %122
  %134 = load ptr, ptr %128, align 4
  %135 = getelementptr inbounds %struct.host1x_bo_ops, ptr %134, i32 0, i32 4
  %136 = load ptr, ptr %135, align 4
  %137 = tail call ptr %136(ptr noundef %128) #11
...
141:                                              ; preds = %139
  %142 = getelementptr inbounds %struct.device, ptr %130, i32 0, i32 3
  br label %143

143:                                              ; preds = %171, %141
  %144 = phi i32 [ %126, %141 ], [ %149, %171 ]
  %145 = phi i32 [ 0, %141 ], [ %172, %171 ]
  %146 = sub i32 %129, %145
  %147 = tail call i32 @llvm.umin.i32(i32 %146, i32 128) #11
  %148 = shl i32 %145, 2
  %149 = add i32 %148, %144
...
154:                                              ; preds = %152, %143
  %155 = phi ptr [ %153, %152 ], [ %150, %143 ]
  %156 = load volatile i32, ptr getelementptr inbounds (%struct.tracepoint, ptr @__tracepoint_host1x_cdma_push_gather, i32 0, i32 1), align 4
  %157 = icmp sgt i32 %156, 0
  br i1 %157, label %158, label %171

158:                                              ; preds = %154
  %159 = tail call ptr @llvm.thread.pointer() #11
...
169:                                              ; preds = %158
  ...
  %170 = tail call i32 @__traceiter_host1x_cdma_push_gather(ptr noundef null, ptr noundef %155, ptr noundef %128, i32 noundef %147, i32 noundef %149, ptr noundef nonnull %137) #11
  tail call void asm sideeffect "", "~{memory}"() #11, !srcloc !12
  br label %171

171:                                              ; preds = %169, %158, %154
  %172 = add i32 %145, 128
  %173 = icmp ult i32 %172, %129
  br i1 %173, label %143, label %174

174:                                              ; preds = %171, %139
  %175 = load ptr, ptr %128, align 4
  %176 = getelementptr inbounds %struct.host1x_bo_ops, ptr %175, i32 0, i32 5
  %177 = load ptr, ptr %176, align 4
  tail call void %177(ptr noundef %128, ptr noundef nonnull %137) #11
  br label %178

178:                                              ; preds = %174, %133, %122
  %179 = add i32 %126, %124
  %180 = load i32, ptr %109, align 4
  %181 = or i32 %180, 1610612736
  tail call void @host1x_cdma_push(ptr noundef %97, i32 noundef %181, i32 noundef %179) #11
  br label %182
...
182:                                              ; preds = %178, %110
  ...
  br i1 %185, label %103, label %186

186:                                              ; preds = %182, %94
  tail call void @host1x_cdma_end(ptr noundef %53, ptr noundef %0) #11
  %187 = load ptr, ptr %8, align 4
  %188 = getelementptr inbounds %struct.device, ptr %187, i32 0, i32 3
...
193:                                              ; preds = %191, %186
  %194 = phi ptr [ %192, %191 ], [ %189, %186 ]
  %195 = load volatile i32, ptr getelementptr inbounds (%struct.tracepoint, ptr @__tracepoint_host1x_channel_submitted, i32 0, i32 1), align 4
...
208:                                              ; preds = %197
  ...
  %209 = tail call i32 @__traceiter_host1x_channel_submitted(ptr noundef null, ptr noundef %194, i32 noundef %43, i32 noundef %84) #11
  tail call void asm sideeffect "", "~{memory}"() #11, !srcloc !14
  br label %210

210:                                              ; preds = %208, %197, %193
  %211 = getelementptr inbounds %struct.host1x_job, ptr %0, i32 0, i32 16
  %212 = tail call i32 @host1x_intr_add_action(ptr noundef %13, ptr noundef %5, i32 noundef %84, i32 noundef 0, ptr noundef %3, ptr noundef nonnull %50, ptr noundef %211) #11
...
216:                                              ; preds = %52, %48
  %217 = phi i32 [ -12, %48 ], [ %54, %52 ]
  %218 = phi ptr [ null, %48 ], [ %50, %52 ]
  tail call void @mutex_unlock(ptr noundef %45) #11
  br label %219

219:                                              ; preds = %216, %42
  %220 = phi i32 [ %46, %42 ], [ %217, %216 ]
  %221 = phi ptr [ null, %42 ], [ %218, %216 ]
...
!16 = !{i64 2147981152}
!17 = !{i64 365567, i64 2147855538, i64 2147855564, i64 2147855611, i64 2147855633, i64 2147855661, i64 2147855681}
!18 = !{i64 351630, i64 351654, i64 351675, i64 351692, i64 351709}
!19 = !{i64 2147981352}
!20 = !{i64 2153091916}
!21 = !{i64 2153510195}
!22 = !{!"auto-init"}
