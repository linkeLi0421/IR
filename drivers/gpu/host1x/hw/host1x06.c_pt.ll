; ModuleID = '/llk/IR/drivers/gpu/host1x/hw/host1x06.c_pt.bc'
source_filename = "../drivers/gpu/host1x/hw/host1x06.c"
...
@.str.50 = private unnamed_addr constant [14 x i8] c"%03x 0x%08x: \00", align 1
@.str.51 = private unnamed_addr constant [9 x i8] c", ...])\0A\00", align 1

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind null_pointer_is_valid sspstrong willreturn writeonly uwtable(sync)
define dso_local i32 @host1x06_init(ptr nocapture noundef writeonly %0) local_unnamed_addr #0 {
...
define internal void @host1x_debug_show_channel_fifo(ptr noundef %0, ptr noundef %1, ptr noundef %2) #2 {
  ...
  %5 = getelementptr inbounds %struct.host1x_channel, ptr %1, i32 0, i32 1
  %6 = load i32, ptr %5, align 4
  tail call void (ptr, ptr, ...) @host1x_debug_output(ptr noundef %2, ptr noundef nonnull @.str.46, i32 noundef %6) #11
  %7 = tail call i32 @host1x_ch_readl(ptr noundef %1, i32 noundef 36) #11
  tail call void (ptr, ptr, ...) @host1x_debug_output(ptr noundef %2, ptr noundef nonnull @.str.47, i32 noundef %7) #11
  %8 = and i32 %7, 8192
  %9 = icmp eq i32 %8, 0
...
11:                                               ; preds = %3
  %12 = tail call i32 @host1x_ch_readl(ptr noundef %1, i32 noundef 40) #11
  tail call void (ptr, ptr, ...) @host1x_debug_output(ptr noundef %2, ptr noundef nonnull @.str.49, i32 noundef %12) #11
  tail call void @host1x_hypervisor_writel(ptr noundef %0, i32 noundef 1, i32 noundef 10920) #11
  %13 = load i32, ptr %5, align 4
  %14 = shl i32 %13, 16
  %15 = or i32 %14, -2147483648
  tail call void @host1x_hypervisor_writel(ptr noundef %0, i32 noundef %15, i32 noundef 9020) #11
  %16 = tail call i32 @host1x_hypervisor_readl(ptr noundef %0, i32 noundef 9028) #11
  %17 = and i32 %16, 4095
  %18 = lshr i32 %16, 16
  %19 = and i32 %18, 4095
  ...
  %21 = shl i32 %20, 2
  %22 = add i32 %21, 9608
  %23 = tail call i32 @host1x_hypervisor_readl(ptr noundef %0, i32 noundef %22) #11
  %24 = and i32 %23, 4095
  %25 = lshr i32 %23, 16
  %26 = and i32 %25, 4095
  br label %27
...
27:                                               ; preds = %43, %11
  %28 = phi i32 [ %17, %11 ], [ %47, %43 ]
  %29 = phi i32 [ 0, %11 ], [ %44, %43 ]
  %30 = load i32, ptr %5, align 4
  %31 = shl i32 %30, 16
  %32 = or i32 %28, %31
  %33 = or i32 %32, -2147483648
  tail call void @host1x_hypervisor_writel(ptr noundef %0, i32 noundef %33, i32 noundef 9020) #11
  %34 = tail call i32 @host1x_hypervisor_readl(ptr noundef %0, i32 noundef 9024) #11
  %35 = icmp eq i32 %29, 0
  br i1 %35, label %36, label %39

36:                                               ; preds = %27
  %37 = sub i32 %28, %24
  tail call void (ptr, ptr, ...) @host1x_debug_output(ptr noundef %2, ptr noundef nonnull @.str.50, i32 noundef %37, i32 noundef %34) #11
  %38 = call fastcc i32 @show_channel_command(ptr noundef %2, i32 noundef %34, ptr noundef nonnull %4)
  br label %43

39:                                               ; preds = %27
  %40 = icmp eq i32 %29, 1
  %41 = select i1 %40, ptr @.str.23, ptr @.str.22
  tail call void (ptr, ptr, ...) @host1x_debug_cont(ptr noundef %2, ptr noundef nonnull @.str.21, i32 noundef %34, ptr noundef nonnull %41) #11
  %42 = add i32 %29, -1
  br label %43

43:                                               ; preds = %39, %36
  %44 = phi i32 [ %42, %39 ], [ %38, %36 ]
  %45 = icmp eq i32 %28, %26
  %46 = add i32 %28, 1
...
51:                                               ; preds = %49
  tail call void (ptr, ptr, ...) @host1x_debug_cont(ptr noundef %2, ptr noundef nonnull @.str.51) #11
  br label %52

52:                                               ; preds = %51, %49
  tail call void (ptr, ptr, ...) @host1x_debug_output(ptr noundef %2, ptr noundef nonnull @.str.15) #11
  tail call void @host1x_hypervisor_writel(ptr noundef %0, i32 noundef 0, i32 noundef 9020) #11
  tail call void @host1x_hypervisor_writel(ptr noundef %0, i32 noundef 0, i32 noundef 10920) #11
  br label %53
...
12:                                               ; preds = %10
  %13 = lshr i32 %8, 2
  %14 = getelementptr i32, ptr %4, i32 %13
  br label %16
...
16:                                               ; preds = %30, %12
  ...
  %21 = getelementptr i32, ptr %14, i32 %17
  %22 = load i32, ptr %21, align 4
  %23 = icmp eq i32 %18, 0
  br i1 %23, label %24, label %26

24:                                               ; preds = %16
  call void (ptr, ptr, ...) @host1x_debug_output(ptr noundef %0, ptr noundef nonnull @.str.20, ptr noundef nonnull %7, i32 noundef %22) #11
  %25 = call fastcc i32 @show_channel_command(ptr noundef %0, i32 noundef %22, ptr noundef nonnull %6)
  br label %30

26:                                               ; preds = %16
  %27 = icmp eq i32 %18, 1
  %28 = select i1 %27, ptr @.str.23, ptr @.str.22
  call void (ptr, ptr, ...) @host1x_debug_cont(ptr noundef %0, ptr noundef nonnull @.str.21, i32 noundef %22, ptr noundef nonnull %28) #11
  %29 = add i32 %18, -1
  br label %30
...
; Function Attrs: nounwind null_pointer_is_valid sspstrong uwtable(sync)
define internal fastcc i32 @show_channel_command(ptr noundef %0, i32 noundef %1, ptr nocapture noundef %2) unnamed_addr #2 {
  %4 = lshr i32 %1, 28
...
10:                                               ; preds = %5
  %11 = lshr i32 %1, 16
  %12 = and i32 %11, 4095
  tail call void (ptr, ptr, ...) @host1x_debug_cont(ptr noundef %0, ptr noundef nonnull @.str.24, i32 noundef %9, i32 noundef %12, i32 noundef %6) #11
  %13 = tail call i32 @__sw_hweight8(i32 noundef %6) #11
  br label %75

14:                                               ; preds = %5
  tail call void (ptr, ptr, ...) @host1x_debug_cont(ptr noundef %0, ptr noundef nonnull @.str.25, i32 noundef %9) #11
  br label %75
...
15:                                               ; preds = %3
  ...
  %17 = lshr i32 %1, 16
  %18 = and i32 %17, 4095
  tail call void (ptr, ptr, ...) @host1x_debug_cont(ptr noundef %0, ptr noundef nonnull @.str.26, i32 noundef %18) #11
  %19 = icmp eq i32 %16, 0
  br i1 %19, label %20, label %75

20:                                               ; preds = %15
  tail call void (ptr, ptr, ...) @host1x_debug_cont(ptr noundef %0, ptr noundef nonnull @.str.23) #11
  br label %75
...
21:                                               ; preds = %3
  ...
  %23 = lshr i32 %1, 16
  %24 = and i32 %23, 4095
  tail call void (ptr, ptr, ...) @host1x_debug_cont(ptr noundef %0, ptr noundef nonnull @.str.27, i32 noundef %24) #11
  %25 = icmp eq i32 %22, 0
...
27:                                               ; preds = %3
  ...
  %29 = lshr i32 %1, 16
  %30 = and i32 %29, 4095
  tail call void (ptr, ptr, ...) @host1x_debug_cont(ptr noundef %0, ptr noundef nonnull @.str.28, i32 noundef %30, i32 noundef %28) #11
  %31 = icmp eq i32 %28, 0
...
33:                                               ; preds = %32, %27
  %34 = tail call i32 @__sw_hweight16(i32 noundef %28) #11
  br label %75
...
35:                                               ; preds = %3
  ...
  %37 = and i32 %36, 4095
  %38 = and i32 %1, 65535
  tail call void (ptr, ptr, ...) @host1x_debug_cont(ptr noundef %0, ptr noundef nonnull @.str.29, i32 noundef %37, i32 noundef %38) #11
  br label %75

39:                                               ; preds = %3
  %40 = shl i32 %1, 4
  tail call void (ptr, ptr, ...) @host1x_debug_cont(ptr noundef %0, ptr noundef nonnull @.str.30, i32 noundef %40) #11
  br label %75
...
41:                                               ; preds = %3
  ...
  %47 = and i32 %46, 1
  %48 = and i32 %1, 16383
  tail call void (ptr, ptr, ...) @host1x_debug_cont(ptr noundef %0, ptr noundef nonnull @.str.31, i32 noundef %43, i32 noundef %45, i32 noundef %47, i32 noundef %48) #11
  br label %75

49:                                               ; preds = %3
  %50 = and i32 %1, 4194303
  tail call void (ptr, ptr, ...) @host1x_debug_cont(ptr noundef %0, ptr noundef nonnull @.str.32, i32 noundef %50) #11
  br label %75

51:                                               ; preds = %3
  %52 = and i32 %1, 255
  tail call void (ptr, ptr, ...) @host1x_debug_cont(ptr noundef %0, ptr noundef nonnull @.str.33, i32 noundef %52) #11
  br label %75

53:                                               ; preds = %3
  %54 = and i32 %1, 65535
  store i32 %54, ptr %2, align 4
  tail call void (ptr, ptr, ...) @host1x_debug_cont(ptr noundef %0, ptr noundef nonnull @.str.34, i32 noundef %54) #11
  br label %75

55:                                               ; preds = %3, %3
  %56 = icmp eq i32 %4, 10
  %57 = select i1 %56, ptr @.str.36, ptr @.str.37
  %58 = and i32 %1, 4194303
  tail call void (ptr, ptr, ...) @host1x_debug_cont(ptr noundef %0, ptr noundef nonnull @.str.35, ptr noundef nonnull %57, i32 noundef %58) #11
...
60:                                               ; preds = %55
  tail call void (ptr, ptr, ...) @host1x_debug_cont(ptr noundef %0, ptr noundef nonnull @.str.38) #11
  br label %75

61:                                               ; preds = %55
  tail call void (ptr, ptr, ...) @host1x_debug_cont(ptr noundef %0, ptr noundef nonnull @.str.39) #11
  br label %75

62:                                               ; preds = %55
  tail call void (ptr, ptr, ...) @host1x_debug_cont(ptr noundef %0, ptr noundef nonnull @.str.40) #11
  %63 = load i32, ptr %2, align 4
  br label %75

64:                                               ; preds = %3
  %65 = and i32 %1, 16383
  tail call void (ptr, ptr, ...) @host1x_debug_cont(ptr noundef %0, ptr noundef nonnull @.str.41, i32 noundef %65) #11
  br label %75
...
69:                                               ; preds = %66
  %70 = and i32 %1, 255
  tail call void (ptr, ptr, ...) @host1x_debug_cont(ptr noundef %0, ptr noundef nonnull @.str.42, i32 noundef %70) #11
  br label %75

71:                                               ; preds = %66
  %72 = and i32 %1, 255
  tail call void (ptr, ptr, ...) @host1x_debug_cont(ptr noundef %0, ptr noundef nonnull @.str.43, i32 noundef %72) #11
  br label %75

73:                                               ; preds = %66
  tail call void (ptr, ptr, ...) @host1x_debug_cont(ptr noundef %0, ptr noundef nonnull @.str.44, i32 noundef %1) #11
  br label %75

74:                                               ; preds = %3
  tail call void (ptr, ptr, ...) @host1x_debug_cont(ptr noundef %0, ptr noundef nonnull @.str.45) #11
  br label %75

75:                                               ; preds = %74, %73, %71, %69, %64, %62, %61, %60, %53, %51, %49, %41, %39, %35, %33, %26, %21, %20, %15, %14, %10
  %76 = phi i32 [ 0, %74 ], [ 2, %64 ], [ 0, %60 ], [ 0, %61 ], [ %63, %62 ], [ 0, %53 ], [ 0, %51 ], [ 0, %49 ], [ 1, %41 ], [ 0, %39 ], [ 0, %35 ], [ 0, %14 ], [ %13, %10 ], [ 0, %20 ], [ %16, %15 ], [ 0, %26 ], [ %22, %21 ], [ %34, %33 ], [ 0, %71 ], [ 0, %73 ], [ 0, %69 ]
  ret i32 %76
}
