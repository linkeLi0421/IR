; ModuleID = '/llk/IR/drivers/mfd/qcom-spmi-pmic.c_pt.bc'
...
define internal i32 @pmic_spmi_probe(ptr noundef %0) #2 {
  %2 = alloca i32, align 4
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
  %6 = alloca i32, align 4
  %7 = tail call ptr @__devm_regmap_init_spmi_ext(ptr noundef %0, ptr noundef nonnull @spmi_regmap_config, ptr noundef null, ptr noundef null) #4
...
11:                                               ; preds = %1
  %12 = getelementptr inbounds %struct.spmi_device, ptr %0, i32 0, i32 2
...
16:                                               ; preds = %11
  ...
  %17 = call i32 @regmap_read(ptr noundef %7, i32 noundef 260, ptr noundef nonnull %5) #4
...
22:                                               ; preds = %16
  %23 = call i32 @regmap_read(ptr noundef %7, i32 noundef 261, ptr noundef nonnull %6) #4
  %24 = icmp slt i32 %23, 0
  br i1 %24, label %48, label %25

25:                                               ; preds = %22
  %26 = call i32 @regmap_read(ptr noundef %7, i32 noundef 257, ptr noundef nonnull %2) #4
  %27 = icmp slt i32 %26, 0
  br i1 %27, label %48, label %28

28:                                               ; preds = %25
  %29 = call i32 @regmap_read(ptr noundef %7, i32 noundef 258, ptr noundef nonnull %3) #4
  %30 = icmp slt i32 %29, 0
  br i1 %30, label %48, label %31

31:                                               ; preds = %28
  %32 = call i32 @regmap_read(ptr noundef %7, i32 noundef 259, ptr noundef nonnull %4) #4
...
48:                                               ; preds = %46, %44, %42, %31, %28, %25, %22, %16
...
49:                                               ; preds = %48, %11
  %50 = call i32 @devm_of_platform_populate(ptr noundef %0) #4
  br label %51

51:                                               ; preds = %49, %9
  %52 = phi i32 [ %10, %9 ], [ %50, %49 ]
  ret i32 %52
}
