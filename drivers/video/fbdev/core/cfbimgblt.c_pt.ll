; ModuleID = '/llk/IR/drivers/video/fbdev/core/cfbimgblt.c_pt.bc'
...
@__UNIQUE_ID_author259 = internal constant [55 x i8] c"cfbimgblt.author=James Simmons <jsimmons@users.sf.net>\00", section ".modinfo", align 1
@__UNIQUE_ID_description260 = internal constant [67 x i8] c"cfbimgblt.description=Generic software accelerated imaging drawing\00", section ".modinfo", align 1
@__UNIQUE_ID_file261 = internal constant [50 x i8] c"cfbimgblt.file=drivers/video/fbdev/core/cfbimgblt\00", section ".modinfo", align 1
@__UNIQUE_ID_license262 = internal constant [22 x i8] c"cfbimgblt.license=GPL\00", section ".modinfo", align 1
...
@llvm.compiler.used = appending global [5 x ptr] [ptr @__UNIQUE_ID_author259, ptr @__UNIQUE_ID_description260, ptr @__UNIQUE_ID_file261, ptr @__UNIQUE_ID_license262, ptr @__ksymtab_cfb_imageblit], section "llvm.metadata"

; Function Attrs: nounwind null_pointer_is_valid sspstrong uwtable(sync)
define dso_local void @cfb_imageblit(ptr noundef %0, ptr nocapture noundef readonly %1) #0 {
...
117:                                              ; preds = %117, %112
  ...
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %119, i32 %131) #1, !srcloc !8
...
166:                                              ; preds = %157
  ...
  %168 = xor i32 %167, -1
  %169 = tail call i32 asm sideeffect "ldr $0, $1", "=r,*Qo"(ptr elementtype(i32) %160) #1, !srcloc !9
  %170 = and i32 %169, %168
  br label %171
...
192:                                              ; preds = %174
  ...
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %179, i32 %190) #1, !srcloc !8
...
213:                                              ; preds = %208
  ...
  %215 = tail call i32 asm sideeffect "ldr $0, $1", "=r,*Qo"(ptr elementtype(i32) %210) #1, !srcloc !9
  %216 = and i32 %215, %214
  %217 = or i32 %216, %211
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %210, i32 %217) #1, !srcloc !8
  br label %218
...
255:                                              ; preds = %246
  ...
  %257 = xor i32 %256, -1
  %258 = tail call i32 asm sideeffect "ldr $0, $1", "=r,*Qo"(ptr elementtype(i32) %248) #1, !srcloc !9
  %259 = and i32 %258, %257
  br label %260
...
284:                                              ; preds = %279
  ...
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %268, i32 %282) #1, !srcloc !8
...
303:                                              ; preds = %297
  ...
  %305 = tail call i32 asm sideeffect "ldr $0, $1", "=r,*Qo"(ptr elementtype(i32) %298) #1, !srcloc !9
  %306 = and i32 %305, %304
  %307 = or i32 %306, %299
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %298, i32 %307) #1, !srcloc !8
  br label %308
